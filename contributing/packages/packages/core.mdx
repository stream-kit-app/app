---
title: "@stream-kit/core"
description: "Platform-neutral runtime utilities shared by the app, first-party plugins, and external plugins. This package has **no** Svelte, Tauri, or UI dependencies (opti"
---
...
Import types and the full plugin contract from `@stream-kit/plugin` instead. See [Plugin authoring API](/docs/plugins/api).
