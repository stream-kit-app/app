...
description: "Starter project for external Stream Kit plugins. Demonstrates handlers, settings, menu pages with every supported block type, and packaging for distribution."
---
