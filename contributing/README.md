...
Internal documentation for the Stream Kit monorepo. This content is **not** published on [docs.stream-kit.app](https://docs.stream-kit.app).

User-facing app documentation lives in [`/docs`](../docs/).
...
| [Plugin development](./plugins/) | Monorepo plugin dev workflow, remote update manifests |
