---
title: "CorePluginApi"
description: "The Core plugin exposes a typed API via the plugin `api` field. Other plugins or app routes can access it with `app.plugins.tryGet<CorePluginApi>('core')`."
---
