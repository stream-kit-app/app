import type { ConditionGroupNode, ConditionLeafNode } from '$lib/core/action/trigger/condition';

import { isFieldValueEmpty } from '$lib/core/action/validate-form';
...
export function validateModRuleForm(input: {
	name: string;
