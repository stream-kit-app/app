import { $n as e, Hr as t, On as n, Qn as r, Qr as i, Qt as a, Vr as o, Wn as s, Z as c, Zn as l, Zr as u, a as d, cn as f, dt as p, jt as m, ln as h, ni as g, o as _, on as v, pr as y, pt as b, un as x } from "../../chunks/client-xxWnFgeR.js";
import "../../chunks/disclose-version-YhYaTdgb.js";
import { t as S } from "../../chunks/utils-DJt177zd.js";
import { t as C } from "../../chunks/dist-DLhOqhSg.js";
...
//#endregion
//#region ../ui/src/lib/components/blueprint/panel.svelte
var U = new Set([
	"$$slots",
	"$$events",
	"$$legacy",
	...
	"class",
	"children"
]), W = x("<!> <!> <!> <!>", 1), G = x("<div class=\"border-b border-rule px-5 py-3\"><!></div>"), K = x("<div><!> <!> <!></div>");
function q(n, s) {
	t(s, !0);
	let u = d(s, "crosshairs", 3, !1), p = _(s, U);
	var h = K();
	c(h, (e) => ({
		class: e,
		...p
	}), [() => S("relative rounded-none border border-rule bg-dark-900/40", s.class)]);
	var v = l(h), y = (t) => {
		var n = W(), i = r(n);
		F(i, {
			position: "top-left",
	...
	m(b, (e) => {
		s.header && e(x);
	}), a(e(b, 2), () => s.children ?? g), i(h), f(n, h), o();
}
//#endregion
...
function Z(n, a) {
	t(a, !0);
	let s = d(a, "crosshairs", 3, !0), u = _(a, J);
	var p = X();
	c(p, (e) => ({
		"aria-hidden": "true",
		class: e,
...
//#endregion
export { D as Cell, j as CellGrid, F as Crosshair, z as Eyebrow, H as GridFrame, q as Panel, Z as SectionRule, O as cellGridVariants, M as crosshairVariants };
