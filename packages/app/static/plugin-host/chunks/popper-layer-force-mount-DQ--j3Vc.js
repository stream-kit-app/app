import { $n as e, Gn as t, Gt as n, Hr as r, Mt as i, On as a, Qn as o, Vr as s, _n as c, an as l, cr as u, f as d, in as f, m as p, ni as m, nr as h, o as g, on as _, or as v, p as y, pr as b, zn as x } from "./index-client-BIJQxc2l.js";
import "./disclose-version-YhYaTdgb.js";
import { i as S } from "./index-client-b6iB98U7.js";
import { A as C, C as w, D as T, E, M as D, O, T as ee, _ as k, b as A, d as j, f as te, g as M, h as ne, j as N, k as re, l as ie, m as ae, n as oe, o as se, r as ce, u as le, w as ue, x as P } from "./animations-complete-mSylzqL5.js";
import { a as de, c as fe, i as pe, o as me, r as he, s as ge, t as _e } from "./use-id-D_eLoXvH.js";
import { a as F, c as ve, i as ye, o as be, r as xe, s as Se, t as Ce } from "./presence-manager.svelte-DXU099Vb.js";
...
function En(e, t) {
	r(t, !0);
	let n = d(t, "interactOutsideBehavior", 3, "close"), a = d(t, "onInteractOutside", 3, L), c = d(t, "onFocusOutside", 3, L), u = d(t, "isValidEvent", 3, () => !1), p = xn.create({
		id: T(() => t.id),
	...
	var h = l();
	i(o(h), () => t.children ?? m, () => ({ props: p.props })), f(e, h), s();
}
//#endregion
...
function kn(e, t) {
	r(t, !0);
	let n = d(t, "escapeKeydownBehavior", 3, "close"), a = d(t, "onEscapeKeydown", 3, L);
	Dn.create({
...
function Mn(e, t) {
	r(t, !0);
	let n = d(t, "enabled", 3, !1), a = d(t, "trapFocus", 3, !1), c = d(t, "loop", 3, !1), u = d(t, "onCloseAutoFocus", 3, L), p = d(t, "onOpenAutoFocus", 3, L), h = jn.use({
		enabled: T(() => n()),
		trap: T(() => a()),
		loop: c(),
		onCloseAutoFocus: T(() => u()),
		onOpenAutoFocus: T(() => p()),
		ref: t.ref
	});
	var g = l();
	i(o(g), () => t.focusScope ?? m, () => ({ props: h.props })), f(e, g), s();
}
//#endregion
...
function zn(e, t) {
	r(t, !0);
	let n = d(t, "preventOverflowTextSelection", 3, !0), a = d(t, "onPointerDown", 3, L), c = d(t, "onPointerUp", 3, L);
	Pn.create({
		id: T(() => t.id),
		onPointerDown: T(() => a()),
		onPointerUp: T(() => c()),
...
}, Vn = new S(), Hn = u(null), Un = null, Wn = null, Gn = !1, Kn = T(() => {
...
function Zn(e, t) {
	r(t, !0);
	let n = d(t, "preventScroll", 3, !0), i = d(t, "restoreScrollDelay", 3, null);
	n() && new Yn(n(), () => i()), s();
}
//#endregion
...
function Bi(e) {
	let n = e.whileElementsMounted, r = b(() => Ii(e.open) ?? !0), i = b(() => Ii(e.middleware)), o = b(() => Ii(e.transform) ?? !0), s = b(() => Ii(e.placement) ?? "bottom"), c = b(() => Ii(e.strategy) ?? "absolute"), l = b(() => Ii(e.sideOffset) ?? 0), d = b(() => Ii(e.alignOffset) ?? 0), f = e.reference, p = u(0), m = u(0), g = N(null), _ = u(h(a(c))), y = u(h(a(s))), x = u(h({})), S = u(!1), C = !1, w = 0, T = b(() => {
	...
	function D() {
		...
		Fi(e, t, {
			...
			if (n === w && !(f.current !== e || g.current !== t)) {
				...
				if (!a(r) && a(p) !== 0 && a(m) !== 0) {
					let e = Math.max(Math.abs(a(l)), Math.abs(a(d)), 15);
...
function $i(e, t) {
	r(t, !0);
	let n = d(t, "tooltip", 3, !1);
	Ki.create(n());
	var a = l();
	i(o(a), () => t.children ?? m), f(e, a), s();
}
//#endregion
...
function ea(e, t) {
	r(t, !0);
	let n = d(t, "side", 3, "bottom"), c = d(t, "sideOffset", 3, 0), u = d(t, "align", 3, "center"), p = d(t, "alignOffset", 3, 0), h = d(t, "arrowPadding", 3, 0), g = d(t, "avoidCollisions", 3, !0), _ = d(t, "collisionBoundary", 19, () => []), v = d(t, "collisionPadding", 3, 0), y = d(t, "hideWhenDetached", 3, !1), x = d(t, "onPlaced", 3, () => {}), S = d(t, "sticky", 3, "partial"), C = d(t, "updatePositionStrategy", 3, "optimized"), w = d(t, "strategy", 3, "fixed"), E = d(t, "dir", 3, "ltr"), D = d(t, "style", 19, () => ({})), O = d(t, "wrapperId", 19, _e), ee = d(t, "customAnchor", 3, null), k = d(t, "tooltip", 3, !1), A = qi.create({
		side: T(() => n()),
		sideOffset: T(() => c()),
		align: T(() => u()),
		alignOffset: T(() => p()),
...
function ra(e, t) {
	let r = d(t, "isStatic", 3, !1), i = y(t, na);
	var a = l(), s = o(a), c = (e) => {
		ta(e, {
			get content() {
				return t.content;
...
function oa(t, c) {
	r(c, !0);
	let u = d(c, "interactOutsideBehavior", 3, "close"), p = d(c, "trapFocus", 3, !0), h = d(c, "isValidEvent", 3, () => !1), g = d(c, "customAnchor", 3, null), _ = d(c, "isStatic", 3, !1), v = d(c, "tooltip", 3, !1), x = d(c, "contentPointerEvents", 3, "auto"), S = y(c, ia), C = b(() => c.preventScroll ?? !0), w = b(() => c.strategy ?? (a(C) ? "fixed" : "absolute"));
	ra(t, {
		get isStatic() {
			return _();
		},
		...
		content: (t, r) => {
			let s = () => r?.().props, d = () => r?.().wrapperProps;
			var g = aa(), _ = o(g), v = (e) => {
...
function ca(e, t) {
	let r = d(t, "interactOutsideBehavior", 3, "close"), i = d(t, "trapFocus", 3, !0), a = d(t, "isValidEvent", 3, () => !1), s = d(t, "customAnchor", 3, null), c = d(t, "isStatic", 3, !1), u = y(t, sa);
	var m = l(), h = o(m), g = (e) => {
		oa(e, p({
			get popper() {
				return t.popper;
...
function ua(e, t) {
	let n = d(t, "interactOutsideBehavior", 3, "close"), r = d(t, "trapFocus", 3, !0), i = d(t, "isValidEvent", 3, () => !1), a = d(t, "customAnchor", 3, null), o = d(t, "isStatic", 3, !1), s = y(t, la);
	oa(e, p({
		get popper() {
			return t.popper;
		},
