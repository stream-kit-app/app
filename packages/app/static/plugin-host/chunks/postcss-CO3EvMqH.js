...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), s = (e, n) => {
	...
	var i = class {
		...
		atrule(e, t) {
			...
			if (typeof e.raws.afterName < "u" ? n += e.raws.afterName : r && (n += " "), e.nodes) this.block(e, n + r);
			else {
		...
		raw(e, t, i) {
			let a;
			if (i ||= t, t && (a = e.raws[t], typeof a < "u")) return a;
			let o = e.parent;
			if (i === "before" && (!o || o.type === "root" && o.first === e || o && o.type === "document")) return "";
			if (!o) return n[i];
			let s = e.root();
			if (s.rawCache ||= {}, typeof s.rawCache[i] < "u") return s.rawCache[i];
			if (i === "before" || i === "after") return this.beforeAfter(e, i);
			{
				let n = "raw" + r(i);
				this[n] ? a = this[n](s, e) : s.walk((e) => {
					if (a = e.raws[t], typeof a < "u") return !1;
				});
			}
			return typeof a > "u" && (a = n[i]), s.rawCache[i] = a, a;
		}
		rawBeforeClose(e) {
			let t;
			return e.walk((e) => {
	...
	t.exports = function(e, t = {}) {
		let o = e.css.valueOf(), s = t.ignoreErrors, c, l, u, d, f, p, m, h, g, _, v = o.length, y = 0, b = [], x = [];
		function S() {
			return y;
		}
		function C(t) {
		...
		function T(e) {
			...
			switch (c = o.charCodeAt(y), c) {
				...
				case 40:
					...
					} else d = o.indexOf(")", y + 1), l = o.slice(y, d + 1), d === -1 || i.test(l) ? p = [
						"(",
						"(",
						y
					] : (p = [
				...
				case 92:
					...
					break;
				default:
					c === 47 && o.charCodeAt(y + 1) === 42 ? (d = o.indexOf("*/", y + 2) + 1, d === 0 && (s || t ? d = o.length : C("comment")), p = [
						"comment",
						o.slice(y, d + 1),
						y,
						d
	...
	var n = _(), r = k(), { isInlineComment: i } = ee(), { interpolation: a } = j(), { isMixinToken: o } = te(), s = ne(), c = re(), l = /(!\s*important)$/i;
	...
	var n = y(), r = se(), i = N(), a = A(), o = ce(), s = T(), c = m(), { isClean: l, my: u } = h();
	le();
	var d = {
		atrule: "AtRule",
		comment: "Comment",
	...
	var n = se(), r = ue(), i = de(), a = T(), o = class {
		constructor(e = []) {
	...
	var n = w(), r = _(), i = y(), a = f(), o = v(), s = se(), c = M(), l = C(), u = ue(), d = E(), p = g(), h = A(), b = fe(), x = ce(), S = T(), O = D(), k = m(), ee = P();
	function j(...e) {
	...
	j.plugin = function(e, t) {
		...
		return Object.defineProperty(r, "postcss", { get() {
			...
			return j([r(n)]).process(e, t);
		}, r;
	}, j.stringify = k, j.parse = h, j.fromJSON = c, j.list = d, j.comment = (e) => new r(e), j.atRule = (e) => new n(e), j.decl = (e) => new o(e), j.rule = (e) => new O(e), j.root = (e) => new S(e), j.document = (e) => new s(e), j.CssSyntaxError = a, j.Declaration = o, j.Container = i, j.Processor = b, j.Document = s, j.Comment = r, j.Warning = ee, j.AtRule = n, j.Result = x, j.Input = l, j.Rule = O, j.Root = S, j.Node = p, u.registerPostcss(j), t.exports = j, j.default = j;
}), me = o((e, t) => {
	var { Container: n } = pe();
	t.exports = class extends n {
		constructor(e) {
	...
	var { Comment: n } = pe(), r = k(), i = me(), a = he();
	t.exports = class extends r {
		atrule(e) {
			let t = e[1], n = e;
			for (; !this.tokenizer.endOfFile();) {
	...
	function D(e) {
		for (var t = [], D = e.css.valueOf(), O = void 0, k = void 0, A = void 0, ee = void 0, j = void 0, te = void 0, ne = void 0, re = void 0, ie = void 0, ae = void 0, oe = void 0, se = D.length, M = -1, N = 1, P = 0, ce = function(t, n) {
			if (e.safe) D += n, k = D.length - 1;
			else throw e.error("Unclosed " + t, N, P - M, P);
		}; P < se;) {
			switch (O = D.charCodeAt(P), O === o && (M = P, N += 1), O) {
				case o:
				case s:
				case l:
				case u:
				case c:
					k = P;
					do
						k += 1, O = D.charCodeAt(k), O === o && (M = k, N += 1);
				...
				case r:
					A = O === n ? "'" : "\"", k = P;
					do
						for (ae = !1, k = D.indexOf(A, k + 1), k === -1 && ce("quote", A), oe = k; D.charCodeAt(oe - 1) === i;) --oe, ae = !ae;
					while (ae);
					t.push([
						"string",
						D.slice(P, k + 1),
					...
					break;
				case w:
					T.lastIndex = P + 1, T.test(D), k = T.lastIndex === 0 ? D.length - 1 : T.lastIndex - 2, t.push([
						"at-word",
						D.slice(P, k + 1),
						N,
						P - M,
					...
					break;
				case i:
					for (k = P, ne = !0; D.charCodeAt(k + 1) === i;) k += 1, ne = !ne;
					O = D.charCodeAt(k + 1), ne && O !== a && O !== s && O !== o && O !== l && O !== u && O !== c && (k += 1), t.push([
						"word",
						D.slice(P, k + 1),
						N,
						P - M,
					...
					break;
				default:
					O === a && D.charCodeAt(P + 1) === x ? (k = D.indexOf("*/", P + 2) + 1, k === 0 && ce("comment", "*/"), te = D.slice(P, k + 1), ee = te.split("\n"), j = ee.length - 1, j > 0 ? (re = N + j, ie = k - ee[j].length) : (re = N, ie = M), t.push([
						"comment",
						te,
						N,
						P - M,
						...
						k - ie,
						P
					]), M = ie, N = re, P = k) : (E.lastIndex = P + 1, E.test(D), k = E.lastIndex === 0 ? D.length - 1 : E.lastIndex - 2, t.push([
						"word",
						D.slice(P, k + 1),
						N,
						P - M,
	...
	})(), r = S(Se()), i = S(Ce()), a = S(we()), o = S(De()), s = S(Oe()), c = S(Ae()), l = S(je()), u = S(Me()), d = S(Ne()), f = S(Pe()), p = S(Fe()), m = S(Ie()), h = S(Le()), g = S(Re()), _ = S(ze()), v = S(Be()), y = S(Ve()), b = x(F());
	function x(e) {
		if (e && e.__esModule) return e;
		var t = {};
		if (e != null) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
	...
	var n = /[ \n\t\r\{\(\)'"\\;,/]/g, r = /[ \n\t\r\(\)\{\}\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g, i = /[ \n\t\r\(\)\{\}\*:;@!&'"\-\+\|~>,\[\]\\]|\//g, a = /^[a-z0-9]/i, o = /^[a-f0-9?\-]/i, s = rt();
	t.exports = function(e, t) {
		t ||= {};
	...
	var n = We(), r = Ge(), i = Ke(), a = qe(), o = Je(), s = Ye(), c = Xe(), l = Ze(), u = Qe(), d = $e(), f = et(), p = tt(), m = nt(), h = it(), g = Se(), _ = Ce(), v = we(), y = at();
	function b(e) {
...
var ct = (e, t) => (n, r, ...i) => n | 1 && r == null ? void 0 : (t.call(r) ?? r[e]).apply(r, i), lt = String.prototype.replaceAll ?? function(e, t) {
	return e.global ? this.replace(e, t) : this.split(e).join(t);
}, R = ct("replaceAll", function() {
	if (typeof this == "string") return lt;
});
function ut(e) {
	return this[e < 0 ? this.length + e : e];
}
var z = ct("at", function() {
	if (Array.isArray(this) || typeof this == "string") return ut;
}), dt = () => {}, ft = "string", pt = "array", mt = "cursor", ht = "indent", gt = "align", _t = "trim", vt = "group", yt = "fill", bt = "if-break", xt = "indent-if-break", St = "line-suffix", Ct = "line-suffix-boundary", wt = "line", Tt = "label", Et = "break-parent", Dt = new Set([
	mt,
	ht,
	gt,
	_t,
...
function Ot(e) {
	if (typeof e == "string") return ft;
	if (Array.isArray(e)) return pt;
	if (!e) return;
	let { type: t } = e;
	if (Dt.has(t)) return t;
}
var kt = Ot, At = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
function jt(e) {
	let t = e === null ? "null" : typeof e;
	if (t !== "string" && t !== "object") return `Unexpected doc '${t}', 
Expected it to be 'string' or 'object'.`;
	if (kt(e)) throw Error("doc is valid.");
...
function Nt(e, t) {
	...
	function i(e) {
		switch (kt(e)) {
			...
			case wt:
			case Et: return t(e);
			default: throw new Mt(e);
		}
	}
}
function Pt(e) {
	return e.type === wt && !e.hard ? e.soft ? "" : " " : e.type === bt ? e.flatContents : e;
}
function Ft(e) {
	return Nt(e, Pt);
}
var B = dt, It = dt, Lt = dt, Rt = dt;
function V(e) {
	return B(e), {
		type: ht,
		contents: e
...
function H(e, t = {}) {
	return B(e), It(t.expandedStates, !0), {
		type: vt,
		id: t.id,
		contents: e,
		break: !!t.shouldBreak,
...
function Zt(e, t) {
	let { preferred: n, alternate: r } = t === !0 || t === "'" ? Yt : Xt, { length: i } = e, a = 0, o = 0;
	for (let t = 0; t < i; t++) {
...
function en(e, t) {
	let n = t === "\"" ? "'" : "\"";
	return t + R(0, e, $t, (e, r, i) => r ? r === n ? n : e : i === t ? "\\" + i : i) + t;
}
var tn = en;
function nn(e, t) {
	/^(?<quote>["']).*\k<quote>$/su.test(e);
	let n = e.slice(1, -1), r = t.parser === "json" || t.parser === "jsonc" || t.parser === "json5" && t.quoteProps === "preserve" && !t.singleQuote ? "\"" : t.__isInHtmlAttribute ? "'" : Qt(n, t.singleQuote);
	return e.charAt(0) === r ? e : tn(n, r);
}
var rn = nn, an = class extends Error {
...
function un(e) {
	...
	let n = e.indexOf("\n", ln);
	if (n === -1) return;
	let r = e.slice(ln, n).trim(), i = e.indexOf(`
${t}`, n), a = r;
	if (a ||= t === "+++" ? "toml" : "yaml", i === -1 && t === "---" && a === "yaml" && (i = e.indexOf("\n...", n)), i === -1) return;
	let o = i + 1 + ln, s = e.charAt(o + 1);
...
function mn(e, t, n) {
	if (e.type === "css-comment" && n.type === "css-root" && n.nodes.length > 0 && ((n.nodes[0] === e || cn(n.nodes[0]) && n.nodes[1] === e) && (delete t.text, /^\*\s*@(?:format|prettier)\s*$/u.test(e.text)) || n.type === "css-root" && z(0, n.nodes, -1) === e)) return null;
	if (e.type === "value-root" && delete t.text, (e.type === "media-query" || e.type === "media-query-list" || e.type === "media-feature-expression") && delete t.value, e.type === "css-rule" && delete t.params, (e.type === "media-feature" || e.type === "media-keyword" || e.type === "media-type" || e.type === "media-unknown" || e.type === "media-url" || e.type === "media-value" || e.type === "selector-attribute" || e.type === "selector-string" || e.type === "selector-class" || e.type === "selector-combinator" || e.type === "value-string") && e.value && (t.value = hn(e.value)), e.type === "selector-combinator" && (t.value = R(0, t.value, /\s+/gu, " ")), e.type === "media-feature" && (t.value = R(0, t.value, " ", "")), (e.type === "value-word" && (e.isColor && e.isHex || [
		"initial",
		"inherit",
		"unset",
		"revert"
	].includes(e.value.toLowerCase())) || e.type === "media-feature" || e.type === "selector-root-invalid" || e.type === "selector-pseudo") && (t.value = t.value.toLowerCase()), e.type === "css-decl" && (t.prop = e.prop.toLowerCase()), (e.type === "css-atrule" || e.type === "css-import") && (t.name = e.name.toLowerCase()), e.type === "value-number" && (t.unit = e.unit.toLowerCase()), e.type === "value-unknown" && (t.value = R(0, t.value, /;$/gu, "")), e.type === "selector-attribute" && (t.attribute = e.attribute.trim(), e.namespace && typeof e.namespace == "string" && (t.namespace = e.namespace.trim() || !0), e.value)) {
		let { value: e } = t;
		/\s[a-zA-Z]$/u.test(e) && (t.__prettier_attribute_selector_flag = z(0, e, -1), e = e.slice(0, -1)), e = e.trim(), e = e.replace(/^(?<quote>["'])(?<value>.*?)\k<quote>$/u, "$<value>"), t.value = e, delete t.quoted;
	}
	if ((e.type === "media-value" || e.type === "media-type" || e.type === "value-number" || e.type === "selector-root-invalid" || e.type === "selector-class" || e.type === "selector-combinator" || e.type === "selector-tag") && e.value && (t.value = R(0, t.value, /([\d+.e-]+)([a-z]*)/giu, (e, t, n) => {
		let r = Number(t);
...
mn.ignoredProperties = pn;
function hn(e) {
	return R(0, R(0, e, "'", "\""), /\\([^\da-f])/giu, "$1");
}
var gn = mn;
function _n() {}
_n.getVisitorKeys = (e) => e.type === "css-root" ? ["frontMatter"] : [];
var vn = _n, yn = null;
function bn(e) {
	if (yn !== null && typeof yn.property) {
		let e = yn;
		return yn = bn.prototype = null, e;
	}
	return yn = bn.prototype = e ?? Object.create(null), new bn();
}
var xn = 10;
for (let e = 0; e <= xn; e++) bn();
function Sn(e) {
	return bn(e);
}
function Cn(e, t = "type") {
	Sn(e);
	function n(n) {
		let r = n[t], i = e[r];
...
var wn = Cn, q = [
	...
	"media-query-list": q[1],
	"media-query": q[1],
	"media-type": q[0],
	"media-feature-expression": q[1],
	"media-feature": q[0],
	"media-colon": q[0],
	"media-value": q[0],
	"media-keyword": q[0],
	...
	"media-unknown": q[0],
	"selector-root": q[1],
	"selector-selector": q[1],
	"selector-comment": q[0],
	"selector-string": q[0],
	"selector-tag": q[0],
	"selector-id": q[0],
	"selector-class": q[0],
	"selector-attribute": q[0],
	"selector-combinator": q[1],
	"selector-universal": q[0],
	"selector-pseudo": q[1],
	"selector-nesting": q[0],
	"selector-unknown": q[0],
	"value-value": q[2],
	"value-root": q[2],
	"value-comment": q[0],
...
function Nn(e, t) {
	...
	if (typeof e.sourceIndex == "number") return e.type === "value-word" ? Mn(e, e.sourceIndex) : e.sourceIndex;
	if (e.source?.start) return Dn(e.source.start, t);
	throw Object.assign(/* @__PURE__ */ Error("Can not locate node."), { node: e });
}
function Pn(e, t) {
	if (e.type === "css-comment" && e.inline) return jn(t, e.source.startOffset);
	if (typeof e.source?.end?.offset == "number") return e.source.end.offset;
	if (e.source) {
		if (e.source.end) {
			let n = Dn(e.source.end, t);
			return e.type === "value-word" ? Mn(e, n) : n;
		}
		if (Kt(e.nodes)) return Pn(z(0, e.nodes, -1), t);
	}
	return null;
}
function Fn(e, t) {
	e.source && (e.source.startOffset = Nn(e, t), e.source.endOffset = Pn(e, t));
	for (let n in e) {
		let r = e[n];
		n === "source" || !r || typeof r != "object" || (r.type === "value-root" || r.type === "value-unknown" ? In(r, Ln(e), r.text || r.value) : Fn(r, t));
	}
}
function In(e, t, n) {
	e.source && (e.source.startOffset = Nn(e, n) + t, e.source.endOffset = Pn(e, n) + t);
	for (let r in e) {
		let i = e[r];
		r === "source" || !i || typeof i != "object" || In(i, t, n);
	}
}
function Ln(e) {
	let t = e.source.startOffset;
	return typeof e.prop == "string" && (t += e.prop.length), e.type === "css-atrule" && typeof e.name == "string" && (t += 1 + e.name.length + e.raws.afterName.match(/^\s*:?\s*/u)[0].length), e.type !== "css-atrule" && typeof e.raws?.between == "string" && (t += e.raws.between.length), t;
}
function Rn(e) {
	...
	for (let [t, n] of a) e = e.slice(0, t) + R(0, e.slice(t, n), /["'*]/gu, " ") + e.slice(n);
	return e;
}
var J = (e) => e.source?.startOffset, Y = (e) => e.source?.endOffset, zn = /\*\/$/, Bn = /^\/\*\*?/, Vn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, Hn = /(^|\s+)\/\/([^\n\r]*)/g, Un = /^(\r?\n)+/, Wn = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, Gn = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, Kn = /(\r?\n|^) *\* ?/g, qn = [];
function Jn(e) {
	let t = e.match(Vn);
...
function Xn(e) {
	e = R(0, e.replace(Bn, "").replace(zn, ""), Kn, "$1");
	let t = "";
	for (; t !== e;) t = e, e = R(0, e, Wn, "\n$1 $2\n");
	e = e.replace(Un, "").trimEnd();
	let n = Object.create(null), r = R(0, e, Gn, "").replace(Un, "").trimEnd(), i;
	for (; i = Gn.exec(e);) {
		let e = R(0, i[2], Hn, "");
...
function Zn({ comments: e = "", pragmas: t = {} }) {
	let n = Object.keys(t), r = n.flatMap((e) => Qn(e, t[e])).map((e) => ` * ${e}
`).join("");
	if (!e) {
...
function Qn(e, t) {
	return [...qn, ...Array.isArray(t) ? t : [t]].map((t) => `@${e} ${t}`.trim());
}
var $n = ["noformat", "noprettier"], er = ["format", "prettier"], tr = "format";
function nr(e) {
...
function ir(e) {
	...
	let { pragmas: n, comments: r } = Xn(Jn(e));
	return {
		shebang: t,
		text: e,
		pragmas: n,
...
function ar(e) {
	let { pragmas: t } = ir(e);
	return er.some((e) => Object.prototype.hasOwnProperty.call(t, e));
}
function or(e) {
	let { pragmas: t } = ir(e);
	return $n.some((e) => Object.prototype.hasOwnProperty.call(t, e));
}
function sr(e) {
	let { shebang: t, text: n, pragmas: r, comments: i } = ir(e), a = Yn(n), o = Zn({
		pragmas: {
			[tr]: "",
			...r
		},
...
var cr = (e) => ar(fn(e).content), lr = (e) => or(fn(e).content), ur = (e) => {
	let { frontMatter: t, content: n } = fn(e);
	return (t ? t.raw + "\n\n" : "") + sr(n);
}, dr = new Set([
	"red",
	"green",
...
function Cr(e) {
	let { selector: t } = e;
	return t ? typeof t == "string" && /^@.+:.*$/u.test(t) || t.value && /^@.+:.*$/u.test(t.value) : !1;
}
function wr(e) {
...
function jr(e) {
	return Dr(e) || Or(e) || X(e) || kr(e) || Ar(e);
}
function Mr(e) {
...
function Hr(e) {
	return e.type === "value-paren_group" && e.groups?.[0] && Vr(e.groups[0]);
}
function Ur(e, t) {
	...
	let i = e.grandparent;
	return !Hr(n) && !(i && Hr(i)) ? !1 : !!(e.findAncestor((e) => e.type === "css-decl")?.prop?.startsWith("$") || Hr(i) || i.type === "value-func");
}
function Wr(e) {
...
function Qr(e) {
	return e.type === "value-func" ? dr.has(e.value.toLowerCase()) : !1;
}
function $r(e) {
...
function ri(e, t, n) {
	let { node: r } = e, i = e.parent, a = e.grandparent, o = fr(e), s = o && i.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), c = e.findAncestor((e) => e.type === "css-atrule"), l = c && Pr(c, t), u = r.groups.some((e) => Wr(e)), d = e.map(n, "groups"), f = [""], p = _r(e, "url"), m = !1, h = !1;
	for (let n = 0; n < r.groups.length; ++n) {
		let u = r.groups[n - 1], g = r.groups[n], _ = r.groups[n + 1], v = r.groups[n + 2];
		if (Wr(g) && !_) {
			f.push([f.pop(), Wt([" ", d[n]])]);
			continue;
		}
		...
		if (yr(e, "forward") && g.type === "value-word" && g.value && u !== void 0 && u.type === "value-word" && u.value === "as" && _.type === "value-operator" && _.value === "*" || yr(e, "utility") && g.type === "value-word" && _ && _.type === "value-operator" && _.value === "*" || !_ || g.type === "value-word" && ei(_) && Y(g) === J(_)) continue;
		if (g.type === "value-string" && g.quoted) {
			let e = g.value.lastIndexOf("#{"), t = g.value.lastIndexOf("}");
			e !== -1 && t !== -1 ? m = e > t : e === -1 ? t !== -1 && (m = !1) : m = !0;
		}
		if (m || Yr(g) || Yr(_) || g.type === "value-atword" && (g.value === "" || g.value.endsWith("[")) || _.type === "value-word" && _.value.startsWith("]") || g.value === "~" || t.parser === "less" && (_?.type === "value-word" && _.value === "[" || g.type === "value-word" && g.value === "[" && (_?.type === "value-atword" || _?.type === "value-word") || g.type === "value-word" && g.value === "][" && _?.type === "value-word") || g.type !== "value-string" && g.value && g.value.includes("\\") && _ && _.type !== "value-comment" || u?.value && u.value.indexOf("\\") === u.value.length - 1 && g.type === "value-operator" && g.value === "/" || g.value === "\\" || Rr(g, _) || Gr(g) || Kr(g) || qr(_) || Kr(_) && Z(_) || qr(g) && Z(_) || g.value === "--" && Gr(_)) continue;
		let y = jr(g), b = jr(_);
		if ((y && Gr(_) || b && qr(g)) && Z(_) || !u && Or(g) || _r(e, "calc") && (X(g) || X(_) || kr(g) || kr(_)) && Z(_)) continue;
		let x = (X(g) || kr(g)) && n === 0 && (_.type === "value-number" || _.isHex) && a && Qr(a) && !Z(_);
		if (t.parser === "scss" && y && g.value === "-" && _.type === "value-func" && Y(g) !== J(_)) {
			f.push([f.pop(), " "]);
			continue;
		}
		let S = v?.type === "value-func" || v && Jr(v) || g.type === "value-func" || Jr(g), C = _.type === "value-func" || Jr(_) || u?.type === "value-func" || u && Jr(u);
		if (!(!(Dr(_) || Dr(g)) && !_r(e, "calc") && !x && (Or(_) && !S || Or(g) && !C || X(_) && !S || X(g) && !C || kr(_) || kr(g)) && (Z(_) || y && (!u || u && jr(u)))) && !((t.parser === "scss" || t.parser === "less") && y && g.value === "-" && ni(_) && Y(g) === J(_.open) && _.open.value === "(")) {
			if (Wr(g)) {
			...
			if (!(o && (o === "font" || o.startsWith("--")) && (Or(_) && Z(_) && ii(g) || Or(g) && Z(g) && ii(u)))) {
				if (b) {
					f.push([f.pop(), " "]);
					continue;
				}
				if (_?.value !== "..." && !(ei(g) && ei(_) && Y(g) === J(_))) {
					if (ei(g) && ni(_) && Y(g) === J(_.open)) {
						f.push(G, "");
						continue;
					}
					if (g.value === "with" && ni(_)) {
						f = [[Ht(f), " "]];
						continue;
					}
					if (!(g.value?.endsWith("#") && _.value === "{" && ni(_.group)) && !(Wr(_) && !v)) {
	...
	return u && f.push([f.pop(), Vt]), h && f.unshift("", K), l ? H(V(f)) : br(e) ? H(Ht(f)) : H(V(Ht(f)));
}
function ii(e) {
...
function li(e) {
	let t = e.toLowerCase();
	return ci.has(t) ? ci.get(t) : e;
}
var ui = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu, di = RegExp(ui.source + `|(${/[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu.source})?(${/(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu.source})(${/[a-z]+/giu.source})?`, "giu");
function Q(e, t) {
	return R(0, e, ui, (e) => rn(e, t));
}
function fi(e, t) {
	let n = t.singleQuote ? "'" : "\"", r = "", i = e.match(/^(?<value>.+?)\s+(?<flag>[a-zA-Z])$/u);
	return i && ({value: e, flag: r} = i.groups), (e.includes("\"") || e.includes("'") ? e : n + e + n) + (r ? ` ${r}` : "");
}
function pi(e) {
	return R(0, e, di, (e, t, n, r, i) => !n && r && (i ??= "", i = i.toLowerCase(), !i || i === "n" || ci.has(i)) ? mi(r) + (i ? li(i) : "") : e);
}
function mi(e) {
	return si(e).replace(/\.0(?=$|e)/u, "");
}
function hi(e) {
...
var vi = _i;
function yi(e, t, n = {}) {
	let r = kn(e, n.backwards ? t - 1 : t, n);
	return r !== vi(e, r, n);
}
var bi = yi;
function xi(e, t) {
...
var Si = xi;
function Ci(e, t) {
	return t === !1 ? !1 : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? jn(e, t) : t;
}
var wi = Ci;
function Ti(e, t) {
	let n = null, r = t;
	for (; r !== n;) n = r, r = An(e, r), r = Si(e, r), r = kn(e, r);
	return r = wi(e, r), r = vi(e, r), r !== !1 && bi(e, r);
}
var Ei = Ti;
function Di({ node: e, parent: t }, n) {
	return !!(e.source && n.originalText.slice(J(e), J(t.close)).trimEnd().endsWith(","));
}
function Oi(e, t) {
	return Sr(e.grandparent) && Di(e, t) ? "," : e.node.type !== "value-comment" && !(e.node.type === "value-comma_group" && e.node.groups.every((e) => e.type === "value-comment")) && hi(t) && e.callParent(() => Ur(e, t)) ? Ut(",") : "";
}
function ki(e, t, n) {
	let { node: r, parent: i } = e, a = e.map(({ node: e }) => typeof e == "string" ? e : n(), "groups");
	if (i && xr(i) && (r.groups.length === 1 || r.groups.length > 0 && r.groups[0].type === "value-comma_group" && r.groups[0].groups.length > 0 && r.groups[0].groups[0].type === "value-word" && r.groups[0].groups[0].value.startsWith("data:"))) return [
		r.open ? n("open") : "",
		U(",", a),
		r.close ? n("close") : ""
	];
	if (!r.open) {
		let t = Ai(e);
		It(a);
		let n = Mi(U(",", a), 2), r = U(t ? K : W, n);
		return V(t ? [K, r] : H([ji(e) ? G : "", Ht(r)]));
	}
	let o = e.map(({ node: n, isLast: r, index: i }) => {
		let o = a[i];
		Vr(n) && n.type === "value-comma_group" && n.groups && n.groups[0].type !== "value-paren_group" && n.groups[2]?.type === "value-paren_group" && kt(o) === vt && kt(o.contents) === ht && kt(o.contents.contents) === yt && (o = H(Bt(o)));
		let s = [o, r ? Oi(e, t) : ","];
		if (!r && n.type === "value-comma_group" && Kt(n.groups)) {
			let e = z(0, n.groups, -1);
			!e.source && e.close && (e = e.close), e.source && Ei(t.originalText, Y(e)) && s.push(K);
		}
		return s;
	}, "groups"), s = Xr(r, i), c = ti(r, i), l = Ur(e, t), u = c || l && !s, d = c || s, f = H([
		r.open ? n("open") : "",
		V([G, U(W, o)]),
		G,
		r.close ? n("close") : ""
...
function Ni(e, t, n) {
	...
	return e.each(() => {
		...
		let { next: o } = e;
		o.type === "css-comment" && !bi(t.originalText, J(o), { backwards: !0 }) && !cn(i) || o.type === "css-atrule" && o.name === "else" && i.type !== "css-comment" ? r.push(" ") : (r.push(t.__isHTMLStyleAttribute ? W : K), Ei(t.originalText, Y(i)) && !cn(i) && r.push(K));
	}, "nodes"), r;
}
var Pi = Ni;
function Fi(e, t, n) {
	...
	switch (r.type) {
		case "css-root": {
			let i = Pi(e, t, n), a = r.raws.after.trim();
		...
		case "css-rule": return [
			...
			r.nodes ? [
				r.selector?.type === "selector-unknown" && $r(r.selector.value) ? W : r.selector ? " " : "",
				"{",
				r.nodes.length > 0 ? V([K, Pi(e, t, n)]) : "",
				K,
				"}",
				Cr(r) ? ";" : ""
			] : ";"
		...
		case "css-decl": {
			let i = e.parent, { between: a } = r.raws, o = a.trim(), s = o === ":", c = typeof r.value == "string" && /^ *$/u.test(r.value), l = typeof r.value == "string" ? r.value : n("value");
			return l = zr(r) ? Ft(l) : l, !s && $r(o) && !e.call(() => Ai(e), "value", "group", "group") && (l = V([K, Bt(l)])), [
				R(0, r.raws.before, /[\s;]/gu, ""),
				i.type === "css-atrule" && i.variable || vr(e) ? r.prop : gr(r.prop),
				o.startsWith("//") ? " " : "",
				o,
				r.extend || c ? "" : " ",
				t.parser === "less" && r.extend && r.selector ? [
					"extend(",
					n("selector"),
					")"
				] : "",
				...
				r.nodes ? [
					...
					G,
					"}"
				] : Lr(r) && !i.raws.semicolon && t.originalText[Y(r) - 1] !== ";" ? "" : t.__isHTMLStyleAttribute && e.isLast ? Ut(";") : ";"
			];
		}
		case "css-atrule": {
			let i = e.parent, a = Ir(r) && !i.raws.semicolon && t.originalText[Y(r) - 1] !== ";";
			if (t.parser === "less") {
				if (r.mixin) return [
					n("selector"),
					r.important ? " !important" : "",
			...
			return [
				"@",
				Fr(r) || r.name.endsWith(":") || Ir(r) ? r.name : gr(r.name),
				r.params ? [Fr(r) ? "" : Ir(r) ? r.raws.afterName === "" ? "" : r.name.endsWith(":") ? " " : /^\s*\n\s*\n/u.test(r.raws.afterName) ? [K, K] : /^\s*\n/u.test(r.raws.afterName) ? K : " " : " ", typeof r.params == "string" ? r.params : n("params")] : "",
				...
				r.nodes ? [
					Pr(r, t) ? "" : r.selector && !r.selector.nodes && typeof r.selector.value == "string" && $r(r.selector.value) || !r.selector && typeof r.params == "string" && $r(r.params) ? W : " ",
					"{",
					V([r.nodes.length > 0 ? G : "", Pi(e, t, n)]),
					G,
					"}"
		...
		case "media-type": return pi(Q(r.value, t));
		case "media-feature-expression": return r.nodes ? [
			"(",
			...e.map(n, "nodes"),
			")"
		] : r.value;
		case "media-feature": return gr(Q(R(0, r.value, / +/gu, " "), t));
		case "media-colon": return [r.value, " "];
		case "media-value": return pi(Q(r.value, t));
		case "media-keyword": return Q(r.value, t);
		case "media-url": return Q(R(0, R(0, r.value, /^url\(\s+/giu, "url("), /\s+\)$/gu, ")"), t);
		case "media-unknown": return r.value;
		case "selector-root": return H([yr(e, "custom-selector") ? [e.findAncestor((e) => e.type === "css-atrule").customSelector, W] : "", U([",", yr(e, [
			"extend",
			"custom-selector",
			"nest"
		]) ? W : K], e.map(n, "nodes"))]);
		...
		case "selector-tag": return [r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "", e.previous?.type === "selector-nesting" ? r.value : pi(hr(e, r.value) ? r.value.toLowerCase() : r.value)];
		case "selector-id": return ["#", r.value];
		case "selector-class": return [".", pi(Q(r.value, t))];
		case "selector-attribute": return [
			"[",
			r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "",
			r.attribute.trim(),
			r.operator ?? "",
			r.value ? fi(Q(r.value.trim(), t), t) : "",
			r.insensitive ? " i" : "",
			"]"
		];
		case "selector-combinator":
			...
			return [r.value.trim().startsWith("(") ? W : "", pi(Q(r.value.trim(), t)) || W];
		case "selector-universal": return [r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "", r.value];
		case "selector-pseudo": return [gr(r.value), Kt(r.nodes) ? H([
			"(",
		...
		case "selector-unknown": {
			if (e.findAncestor((e) => e.type === "css-rule")?.isSCSSNesterProperty) return pi(Q(gr(r.value), t));
			let n = e.parent;
			if (n.raws?.selector) {
		...
		case "value-comment": return t.originalText.slice(J(r), Y(r));
		case "value-comma_group": return ai(e, t, n);
		case "value-paren_group": return ki(e, t, n);
		...
		case "value-number": return [mi(r.value), li(r.unit)];
		case "value-operator": return r.value;
		case "value-word": return r.isColor && r.isHex || mr(r.value) ? r.value.toLowerCase() : r.value;
		case "value-colon": {
			let { previous: t } = e;
			return H([r.value, typeof t?.value == "string" && t.value.endsWith("\\") || _r(e, "url") ? "" : W]);
		}
		case "value-string": return rn(r.raws.quote + r.value + r.raws.quote, t);
...
var Bi = l(A(), 1), Vi = l(oe(), 1), Hi = l(_e(), 1);
function Ui(e, t) {
...
function Ji(e, t, n) {
	if (Ki(e)) {
		delete e.parent;
		for (let r in e) Ji(e[r], t, n), r === "type" && typeof e[r] == "string" && !e[r].startsWith(t) && (!n || !n.test(e[r])) && (e[r] = t + e[r]);
	}
	return e;
}
function Yi(e) {
	if (Ki(e)) {
		delete e.parent;
		for (let t in e) Yi(e[t]);
		!Array.isArray(e) && e.value && !e.type && (e.type = "unknown");
	}
	return e;
}
var Xi = qi.default.default;
function Zi(e) {
	let t;
	try {
		t = Xi(e);
	...
	return Ji(Yi(t), "media-");
}
var Qi = Zi, $i = l(Ue(), 1);
function ea(e) {
	if (/\/[/*]/u.test(R(0, e, /"[^"]+"|'[^']+'/gu, ""))) return {
		type: "selector-unknown",
		value: e.trim()
	};
	let t;
	...
	return Ji(t, "selector-");
}
var $ = ea, ta = l(ot(), 1), na = (e) => {
	for (; e.parent;) e = e.parent;
	return e;
};
function ra(e) {
	return na(e).text.slice(e.group.open.sourceIndex + 1, e.group.close.sourceIndex).trim();
}
var ia = ra;
function aa(e) {
	if (Kt(e)) {
...
var ua = la, da = (e) => e.type === "paren" && e.value === ")";
function fa(e, t) {
	let { nodes: n } = e, r = {
		open: null,
		close: null,
	...
	for (let a = 0; a < n.length; ++a) {
		let c = n[a];
		if (t.parser === "scss" && c.type === "number" && c.unit === ".." && c.value.endsWith(".") && (c.value = c.value.slice(0, -1), c.unit = "..."), c.type === "func" && c.value === "selector" && (c.group.groups = [$(na(e).text.slice(c.group.open.sourceIndex + 1, c.group.close.sourceIndex))]), c.type === "func" && c.value === "url") {
			let e = c.group?.groups ?? [], n = [];
			for (let t = 0; t < e.length; t++) {
				let r = e[t];
				r.type === "comma_group" ? n = [...n, ...r.groups] : n.push(r);
			}
			(oa(n) || !ca(n) && !ua(n[0], t)) && (c.group.groups = [ia(c)]);
		}
		if (c.type === "paren" && c.value === "(") r = {
			...
			s.pop(), o = z(0, s, -1), o.groups.push(r), i.pop(), r = z(0, i, -1);
...
function pa(e) {
	return e.type === "paren_group" && !e.open && !e.close && e.groups.length === 1 || e.type === "comma_group" && e.groups.length === 1 ? pa(e.groups[0]) : e.type === "paren_group" || e.type === "comma_group" ? {
		...e,
		groups: e.groups.map(pa)
	} : e;
}
function ma(e, t) {
	if (Ki(e)) for (let n in e) n !== "parent" && (ma(e[n], t), n === "nodes" && (e.group = pa(fa(e, t)), delete e[n]));
	return e;
}
function ha(e, t) {
	...
	let n = null;
	try {
		n = new ta.default(e, { loose: !0 }).parse();
	} catch {
		return {
			type: "value-unknown",
			value: e
	...
	return n.text = e, Ji(ma(n, t), "value-", /^selector-/u);
}
var ga = ha, _a = new Set([
	"import",
	"use",
	"forward"
]);
...
var ya = va;
function ba(e, t) {
	return t.parser !== "scss" || !e.selector ? !1 : e.selector.replace(/\/\*.*?\*\//u, "").replace(/\/\/.*\n/u, "").trim().endsWith(":");
}
var xa = ba, Sa = /(\s*)(!default).*$/u, Ca = /(\s*)(!global).*$/u;
function wa(e, t) {
	if (Ki(e)) {
		delete e.parent;
		for (let n in e) wa(e[n], t);
		if (!e.type) return e;
		if (e.raws ??= {}, e.type === "css-decl" && typeof e.prop == "string" && e.prop.startsWith("--") && typeof e.value == "string" && e.value.startsWith("{")) {
			...
			if (e.value.trimEnd().endsWith("}")) {
				let r = t.originalText.slice(0, e.source.start.offset), i = "a".repeat(e.prop.length) + t.originalText.slice(e.source.start.offset + e.prop.length, e.source.end.offset), a = R(0, r, /[^\n]/gu, " ") + i, o;
				o = t.parser === "scss" ? Oa : t.parser === "less" ? Da : Ea;
				let s;
				try {
					s = o(a, { ...t });
				} catch {}
		...
		let i = "";
		if (typeof e.params == "string" && (i = e.raws.params ? e.raws.params.scss ?? e.raws.params.raw : e.params, e.raws.afterName && e.raws.afterName.trim().length > 0 && (i = e.raws.afterName + i), e.raws.between && e.raws.between.trim().length > 0 && (i += e.raws.between), i = i.trim(), e.raws.params = i), n.trim().length > 0) return n.startsWith("@") && n.endsWith(":") ? e : e.mixin ? (e.selector = ga(n, t), e) : (xa(e, t) && (e.isSCSSNesterProperty = !0), e.selector = $(n), e);
		if (r.trim().length > 0) {
			let n = r.match(Sa);
		...
		if (t.parser === "less" && e.type === "css-decl" && r.startsWith("extend(") && (e.extend ||= e.raws.between === ":", e.extend && !e.selector && (delete e.value, e.selector = $(r.slice(7, -1)))), e.type === "css-atrule") {
			if (t.parser === "less") {
			...
			if (t.parser === "less") {
				if (e.name.includes(":")) {
					...
					e.params && (r += e.params), e.value = ga(r, t);
				}
				if (![
					"page",
					"nest",
					...
					n && (e.value = ga(n, t)), e.raws.afterName += ":";
				}
				if (e.variable) return delete e.params, e.value || delete e.value, e;
			}
		}
		if (e.type === "css-atrule" && i.length > 0) {
			let { name: n } = e, r = e.name.toLowerCase();
			return n === "warn" || n === "error" ? (e.params = {
				type: "media-unknown",
				value: i
			}, e) : n === "extend" || n === "nest" ? (e.selector = $(i), delete e.params, e) : n === "at-root" ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(i) ? e.params = ga(i, t) : (e.selector = $(i), delete e.params), e) : ya(r) ? (e.import = !0, delete e.filename, e.params = ga(i, t), e) : [
				"namespace",
				"supports",
				"if",
				"else",
				...
				"define-mixin",
				"add-mixin"
			].includes(n) ? (i = i.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2"), i = i.replace(/^(?!if)([^"'\s(]+)(\s+)\(/u, "$1($2"), e.value = ga(i, t), delete e.params, e) : ["media", "custom-media"].includes(r) ? i.includes("#{") ? {
				type: "media-unknown",
				value: i
			} : (e.params = Qi(i), e) : (e.params = i, e);
		}
	}
	return e;
}
function Ta(e, t, n) {
	let { frontMatter: r, content: i } = fn(t), a;
	try {
		a = e(i, { map: !1 });
	} catch (e) {
		let { name: t, reason: n, line: r, column: i } = e;
		throw typeof r == "number" ? Wi(`${t}: ${n}`, {
			loc: { start: {
				line: r,
				column: i
			} },
	...
	return n.originalText = t, a = wa(Ji(a, "css-"), n), Fn(a, t), r && (a.frontMatter = {
		...r,
		type: "front-matter",
		source: {
...
function Ea(e, t = {}) {
	return Ta(Bi.default.default, e, t);
}
function Da(e, t = {}) {
	return Ta((e) => Vi.default.parse(Rn(e)), e, t);
}
function Oa(e, t = {}) {
	return Ta(Hi.default, e, t);
}
var ka = {
	astFormat: "postcss",
	hasPragma: cr,
...
//#endregion
export { st as default, Li as languages, Ri as options, zi as parsers, Na as printers };
