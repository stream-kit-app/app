import { Gn as e, Hr as t, Mt as n, On as r, Qn as i, Vr as a, _n as o, an as s, cr as c, f as l, in as u, ni as d, nr as f, or as p, pr as m, zn as h } from "./index-client-BIJQxc2l.js";
import "./disclose-version-YhYaTdgb.js";
import { i as g } from "./index-client-b6iB98U7.js";
import { A as ee, C as _, D as v, E as te, M as ne, O as re, T as ie, _ as y, d as b, f as ae, g as x, j as oe, k as se, l as ce, m as S, n as le, o as ue, r as C, u as de, w as fe, x as w } from "./animations-complete-mSylzqL5.js";
import { c as pe, i as me, o as T, r as he, t as ge } from "./use-id-D_eLoXvH.js";
import { a as E, d as _e, g as ve, h as ye, i as D, n as be, o as O, p as k, r as A, s as j, v as xe } from "./dom-DDAYniBq.js";
import { a as M, c as Se, i as Ce, o as we, r as N, t as Te } from "./presence-manager.svelte-DXU099Vb.js";
...
var L = c(!1), We = class t {
	...
	constructor() {
		e(() => (t._refs === 0 && (t._cleanup = h(() => {
			...
			return e.push(o(document, "pointerdown", t, { capture: !0 }), o(document, "pointermove", t, { capture: !0 }), o(document, "keydown", (e) => {
				p(L, !0);
			}, { capture: !0 })), T(...e);
		})), t._refs++, () => {
			t._refs--, t._refs === 0 && (p(L, !1), t._cleanup?.());
		}));
	}
	get current() {
		return r(L);
...
function wt(t, n) {
	...
	return e(() => () => {
		...
		p(l, e, !0), a?.(e), s && o().clearTimeout(s), s = u();
	});
}
//#endregion
...
var Tt = class {
	#e;
	#t;
	#n = m(() => this.#e.onMatch ? this.#e.onMatch : (e) => e.focus());
	#r = m(() => this.#e.getCurrentItem ? this.#e.getCurrentItem : this.#e.getActiveElement);
	constructor(e) {
		this.#e = e, this.#t = wt("", {
			afterMs: 1e3,
	...
	handleTypeaheadSearch(e, t) {
		...
		let n = r(this.#r)(), i = t.find((e) => e === n)?.textContent?.trim() ?? "", a = q(t.map((e) => e.textContent?.trim() ?? ""), this.#t.current, i), o = t.find((e) => e.textContent?.trim() === a);
		return o && r(this.#n)(o), o;
	}
	resetTypeahead() {
		this.#t.current = "";
	}
...
var Bt = class e {
	...
	#c = m(() => ({ open: this.parentMenu.opts.open.current }));
	get snippetProps() {
		return r(this.#c);
	}
	set snippetProps(e) {
	...
	onfocus(e) {
		x(() => {
			e.defaultPrevented || this.opts.disabled.current || p(this.#e, !0);
		});
	}
	onblur(e) {
		x(() => {
			e.defaultPrevented || p(this.#e, !1);
		});
	}
	#t = m(() => ({
		id: this.opts.id.current,
		...
		"data-highlighted": r(this.#e) ? "" : void 0,
...
var Jt = class t {
	...
	#l() {
		return T(o(this.#a, "pointerdown", T(this.#f, this.#m), { capture: !0 }), o(this.#a, "pointerdown", T(this.#p, this.#d)), o(this.#a, "focusin", this.#c));
	}
	#u = (e) => {
		let t = e;
	...
	#d = Pe((e) => {
		...
		e.pointerType === "touch" ? (this.#s(), this.#s = o(this.#a, "click", this.#u, { once: !0 })) : this.#e.current(n);
	}, 10);
	#f = (e) => {
		this.#n[e.type] = !0;
	};
...
function $t(e, r) {
	t(r, !0);
	let o = l(r, "interactOutsideBehavior", 3, "close"), c = l(r, "onInteractOutside", 3, A), f = l(r, "onFocusOutside", 3, A), p = l(r, "isValidEvent", 3, () => !1), m = Jt.create({
		id: v(() => r.id),
		interactOutsideBehavior: v(() => o()),
		onInteractOutside: v(() => c()),
		enabled: v(() => r.enabled),
		onFocusOutside: v(() => f()),
		isValidEvent: v(() => p()),
		ref: r.ref
	...
	var h = s();
	n(i(h), () => r.children ?? d, () => ({ props: m.props })), u(e, h), a();
}
//#endregion
...
var en = class e {
	...
	#e = () => o(this.domContext.getDocument(), "keydown", this.#t, { passive: !1 });
	#t = (e) => {
...
function nn(e, r) {
	t(r, !0);
	let o = l(r, "escapeKeydownBehavior", 3, "close"), c = l(r, "onEscapeKeydown", 3, A);
	en.create({
		escapeKeydownBehavior: v(() => o()),
		onEscapeKeydown: v(() => c()),
		enabled: v(() => r.enabled),
		ref: r.ref
	});
	var f = s();
	n(i(f), () => r.children ?? d), u(e, f), a();
}
//#endregion
...
function on(e, r) {
	t(r, !0);
	let o = l(r, "enabled", 3, !1), c = l(r, "trapFocus", 3, !1), f = l(r, "loop", 3, !1), p = l(r, "onCloseAutoFocus", 3, A), m = l(r, "onOpenAutoFocus", 3, A), h = an.use({
		enabled: v(() => o()),
		trap: v(() => c()),
		loop: f(),
	...
	var g = s();
	n(i(g), () => r.focusScope ?? d, () => ({ props: h.props })), u(e, g), a();
}
//#endregion
...
var cn = class e {
	...
	#i() {
		return T(o(this.domContext.getDocument(), "pointerdown", this.#o), o(this.domContext.getDocument(), "pointerup", pe(this.#s, this.#a)));
	}
	#a = (e) => {
		this.#r(e);
	};
...
function fn(e, r) {
	t(r, !0);
	let o = l(r, "preventOverflowTextSelection", 3, !0), c = l(r, "onPointerDown", 3, A), f = l(r, "onPointerUp", 3, A);
	cn.create({
		id: v(() => r.id),
		onPointerDown: v(() => c()),
		onPointerUp: v(() => f()),
		enabled: v(() => r.enabled && o()),
		ref: r.ref
	});
	var p = s();
	n(i(p), () => r.children ?? d), u(e, p), a();
}
//#endregion
...
var pn = class {
	...
	#i() {
		--this.#t, this.#r && this.#t <= 0 && (this.#r(), p(this.#n, void 0), this.#r = void 0);
	}
	get(...t) {
		return this.#t += 1, r(this.#n) === void 0 && (this.#r = h(() => {
			p(this.#n, this.#e(...t), !0);
		})), e(() => () => {
			this.#i();
		}), r(this.#n);
	...
	function e() {
		document.body.setAttribute("style", r(Z) ?? ""), document.body.style.removeProperty("--scrollbar-width"), we && mn?.(), p(Z, null);
	}
	function t() {
	...
	function i() {
		r(Z) === null && X.size === 0 && !$ && p(Z, document.body.getAttribute("style"), !0);
	}
	return w(() => hn.current, () => {
		...
		r > 0 && !n && (document.body.style.paddingRight = `${a.padding}px`, document.body.style.marginRight = `${a.margin}px`, document.body.style.setProperty("--scrollbar-width", `${r}px`)), document.body.style.overflow = "hidden", we && (mn = o(document, "touchmove", (e) => {
...
function bn(e, n) {
	t(n, !0);
	let r = l(n, "preventScroll", 3, !0), i = l(n, "restoreScrollDelay", 3, null);
	r() && new vn(r(), () => i()), a();
}
//#endregion
