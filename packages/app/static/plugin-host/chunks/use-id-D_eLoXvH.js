import { On as e, or as t, pr as n, xt as r } from "./index-client-BIJQxc2l.js";
import { D as i, N as a, m as o, p as s } from "./animations-complete-mSylzqL5.js";
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/compose-handlers.js
function c(...e) {
	return function(t) {
		for (let n of e) if (n) {
...
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/strings.js
var E = /\d/, D = [
	"-",
	"_",
	"/",
...
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/css-to-style-obj.js
function P(e) {
	if (!e) return {};
	let t = {};
	function n(e, n) {
...
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/execute-callbacks.js
function F(...e) {
	return (...t) => {
...
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/style-to-css.js
function I(e, t) {
	let n = RegExp(e, "g");
	return (e) => {
...
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/style.js
function z(e = {}) {
	return R(e).replace("\n", " ");
}
...
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/merge-props.js
function V(e) {
	return B.has(e);
}
function H(...e) {
	...
	for (let n = 1; n < e.length; n++) {
		...
		if (i) {
			for (let e of Object.keys(i)) {
				let n = t[e], o = i[e], s = typeof n == "function", l = typeof o == "function";
				if (s && typeof l && V(e)) t[e] = c(n, o);
				else if (s && l) t[e] = F(n, o);
				else if (e === "class") {
					let i = a(n), s = a(o);
					i && s ? t[e] = r(n, o) : i ? t[e] = r(n) : s && (t[e] = r(o));
				} else if (e === "style") {
					let r = typeof n == "object", i = typeof o == "object", a = typeof n == "string", s = typeof o == "string";
					if (r && i) t[e] = {
						...n,
						...o
					};
					...
					} else r ? t[e] = n : i ? t[e] = o : a ? t[e] = n : s && (t[e] = o);
				} else t[e] = o === void 0 ? n : o;
			}
	...
	return typeof t.style == "object" && (t.style = z(t.style).replaceAll("\n", " ")), t.hidden === !1 && (t.hidden = void 0, delete t.hidden), t.disabled === !1 && (t.disabled = void 0, delete t.disabled), t;
}
//#endregion
//#region ../../node_modules/.pnpm/svelte-toolbelt@0.10.6_@sve_eda23719c06f49b3fd4471540fb738b4/node_modules/svelte-toolbelt/dist/utils/dom-context.svelte.js
var U = class {
	element;
	#e = n(() => this.element.current ? this.element.current.getRootNode() ?? document : document);
	get root() {
		return e(this.#e);
	}
	set root(e) {
...
//#endregion
//#region ../../node_modules/.pnpm/bits-ui@2.18.1_@internation_e1345006c2dfebfc7c052af32e201d76/node_modules/bits-ui/dist/internal/create-id.js
function W(e, t) {
	return t === void 0 ? `bits-${e}` : `bits-${e}-${t}`;
}
//#endregion
//#region ../../node_modules/.pnpm/bits-ui@2.18.1_@internation_e1345006c2dfebfc7c052af32e201d76/node_modules/bits-ui/dist/internal/use-id.js
