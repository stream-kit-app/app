import { On as e, _n as t, cr as n, nr as r, or as i, pr as a } from "./index-client-BIJQxc2l.js";
import "./index-client-b6iB98U7.js";
import { C as o, D as s, _ as c, d as l, j as u, n as d, o as f, u as p, x as m } from "./animations-complete-mSylzqL5.js";
import { t as h } from "./on-mount-effect.svelte-CsZRRjbJ.js";
import { r as g, t as _ } from "./presence-manager.svelte-DXU099Vb.js";
import { t as v } from "./safe-polygon.svelte-Nktx6gsB.js";
...
var D = class r {
	...
	#n = n(null);
	constructor(n) {
		this.opts = n, this.#t = new y(() => {
			this.isOpenDelayed = !0;
		}, this.opts.skipDelayDuration.current), h(() => t(window, "scroll", (t) => {
			let n = e(this.#n);
			if (!n) return;
			let r = n.triggerNode;
			if (!r) return;
	...
	static create(e) {
		return S.set(new t(e, x.get()));
	}
	opts;
	provider;
	#e = a(() => this.opts.delayDuration.current ?? this.provider.opts.delayDuration.current);
	get delayDuration() {
		return e(this.#e);
	}
	set delayDuration(e) {
	...
	#t = a(() => this.opts.disableHoverableContent.current ?? this.provider.opts.disableHoverableContent.current);
	...
	#n = a(() => this.opts.disableCloseOnTriggerClick.current ?? this.provider.opts.disableCloseOnTriggerClick.current);
	...
	#r = a(() => this.opts.disabled.current ?? this.provider.opts.disabled.current);
	get disabled() {
		return e(this.#r);
	}
	set disabled(e) {
	...
	#i = a(() => this.opts.ignoreNonKeyboardFocus.current ?? this.provider.opts.ignoreNonKeyboardFocus.current);
	...
	#o = n(!1);
	#s;
	#c = a(() => this.opts.open.current ? e(this.#o) ? "delayed-open" : "instant-open" : "closed");
	get stateAttr() {
		return e(this.#c);
	}
	set stateAttr(e) {
	...
	#e = a(() => ({ open: this.root.opts.open.current }));
	get snippetProps() {
		return e(this.#e);
	}
	set snippetProps(e) {
