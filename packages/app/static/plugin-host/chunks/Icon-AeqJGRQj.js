import { Et as e, Hr as t, On as n, Qn as r, Qr as i, Vr as a, Yt as o, Z as s, cn as c, cr as l, fn as u, jt as d, ln as f, lr as p, o as m, pr as h, un as g } from "./client-xxWnFgeR.js";
...
function pe(e, t) {
	...
	o === null ? (d = s === null ? "1em" : s === "auto" ? l : s, u = L(d, c / l)) : (u = o === "auto" ? c : o, d = s === null ? L(u, l / c) : s === "auto" ? l : s);
	let f = {}, p = (e, t) => {
		fe(t) || (f[e] = t.toString());
	};
...
var me = /\sid="(\S+)"/g, R = /* @__PURE__ */ new Map();
function he(e) {
	e = e.replace(/[0-9]+$/, "") || "a";
	let t = R.get(e) || 0;
	return R.set(e, t + 1), t ? `${e}${t}` : e;
}
function ge(e) {
	let t = [], n;
	...
	e.pendingCallbacksFlag || (e.pendingCallbacksFlag = !0, setTimeout(() => {
		...
		t.forEach((t) => {
			...
			a.pending = a.pending.filter((t) => {
				...
				return !1;
			}), a.pending.length !== o && (n || q([e], t.id), t.callback(a.loaded.slice(0), a.missing.slice(0), a.pending.slice(0), t.abort));
		});
	}));
}
var Te = 0;
function Ee(e, t, n) {
	let r = Te++, i = q.bind(null, n, r);
...
function Me(e, t, n) {
	...
	return !r || !i ? (n(void 0, 424), Y) : r.query(t, i, n)().abort;
}
function Z() {}
function Ne(e) {
	e.iconsLoaderFlag || (e.iconsLoaderFlag = !0, setTimeout(() => {
		e.iconsLoaderFlag = !1, we(e);
	}));
}
function Pe(e) {
	let t = [], n = [];
...
function Ie(e, t) {
	e.iconsToLoad ? e.iconsToLoad = e.iconsToLoad.concat(t).sort() : e.iconsToLoad = t, e.iconsQueueFlag || (e.iconsQueueFlag = !0, setTimeout(() => {
		...
		let { valid: a, invalid: o } = Pe(r);
		if (o.length && Q(e, o, null), !a.length) return;
		let s = n.match(_) ? B(t) : null;
		if (!s) {
			Q(e, a, null);
			return;
		}
...
var Le = (e, t) => {
	...
	if (!n.pending.length) {
		let e = !0;
		return t && setTimeout(() => {
			e && t(n.loaded, n.missing, n.pending, Z);
		}), () => {
			e = !1;
		};
	}
...
function We(e) {
	return "data:image/svg+xml," + Ue(e);
}
function Ge(e) {
	return "url(\"" + We(e) + "\")";
}
var Ke = {
	...
	"aria-hidden": !0,
	role: "img"
}, Je = { display: "inline-block" }, $ = { "background-color": "currentColor" }, Ye = { "background-color": "transparent" }, Xe = {
	image: "var(--svg)",
	repeat: "no-repeat",
	size: "100% 100%"
}, Ze = {
...
function $e(e, t) {
	let n = Re(Ke, t), r = t.mode || "svg", i = r === "svg" ? { ...qe } : {};
	...
	for (let e in t) {
		...
		if (r !== void 0) switch (e) {
			...
			case "vFlip":
				...
				break;
			case "flip":
				typeof r == "string" && Be(n, r);
				break;
			case "color":
				a = a + (a.length > 0 && a.trim().slice(-1) !== ";" ? ";" : "") + "color: " + r + "; ";
				break;
			case "rotate":
				typeof r == "string" ? n[e] = Ve(r) : typeof r == "number" && (n[e] = r);
				break;
			case "ariaHidden":
			case "aria-hidden":
	...
	let o = pe(e, n), s = o.attributes;
	if (n.inline && (a = "vertical-align: -0.125em; " + a), r === "svg") return Object.assign(i, s), a !== "" && (i.style = a), {
		svg: !0,
		attributes: i,
		body: ge(o.body)
	};
	let { body: c, width: l, height: u } = e, d = r === "mask" || (r === "bg" ? !1 : c.indexOf("currentColor") !== -1), f = { "--svg": Ge(He(c, {
		...s,
		width: l + "",
		height: u + ""
	})) }, p = (e) => {
	...
	p("width"), p("height"), Object.assign(f, Je, d ? $ : Ye);
	let m = "";
...
if (P(!0), _e("", Ce), typeof document < "u" && typeof window < "u") {
	let e = window;
...
function ot(u, g) {
	...
	let _ = {
		...
		loading: null,
		destroyed: !1
	}, v = m(g, rt), y = l(0), b = h(() => (n(y), tt(g.icon, _, S, g.onload))), x = h(() => {
		let e = n(b) ? nt(n(b).data, v) : null;
		return e && n(b).classes && v.class === void 0 && (e.attributes.class = (typeof v.class == "string" ? v.class + " " : "") + n(b).classes.join(" ")), e;
	});
	function S() {
		p(y);
	}
	...
	var C = f(), w = r(C), T = (t) => {
		var a = f(), o = r(a), l = (t) => {
			var r = it();
			s(r, () => ({ ...n(x).attributes })), e(r, () => n(x).body, !0), i(r), c(t, r);
		}, u = (e) => {
			var t = at();
			s(t, () => ({ ...n(x).attributes })), c(e, t);
		};
		d(o, (e) => {
			n(x).svg ? e(l) : e(u, -1);
		}), c(t, a);
