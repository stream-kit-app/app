import { $n as e, At as t, Gn as n, Gt as r, Hr as i, Kn as a, Mt as o, Nn as s, On as c, Qn as l, Qr as u, Vr as d, Zn as f, _n as p, an as m, cr as h, f as g, in as _, it as v, m as y, ni as b, on as x, or as S, p as C, pr as w, un as T, wt as E } from "./index-client-BIJQxc2l.js";
import "./disclose-version-YhYaTdgb.js";
import "./index-client-b6iB98U7.js";
import { C as D, D as O, S as k, _ as A, d as j, h as ee, j as M, o as te, t as ne, x as N, y as P } from "./animations-complete-mSylzqL5.js";
import { i as F, n as I, o as re, r as ie, t as ae } from "./use-id-D_eLoXvH.js";
...
function we(e, t) {
	let n = T();
	i(t, !0);
	let a = g(t, "ref", 15, null), s = g(t, "id", 19, () => I(n)), p = g(t, "type", 3, "hover"), h = g(t, "dir", 3, "ltr"), y = g(t, "scrollHideDelay", 3, 600), x = C(t, Se), S = le.create({
		type: O(() => p()),
		dir: O(() => h()),
		scrollHideDelay: O(() => y()),
		id: O(() => s()),
	...
	var D = m(), k = l(D), A = (e) => {
		var n = m();
		o(l(n), () => t.child, () => ({ props: c(E) })), _(e, n);
	}, j = (e) => {
		var n = Ce();
		v(n, () => ({ ...c(E) })), o(f(n), () => t.children ?? b), u(n), _(e, n);
	};
	r(k, (e) => {
		t.child ? e(A) : e(j, -1);
	}), _(e, D), d();
...
function Oe(e, t) {
	let n = T();
	i(t, !0), E(e, De);
	let r = g(t, "ref", 15, null), a = g(t, "id", 19, () => I(n)), s = C(t, Te), l = ue.create({
		id: O(() => a()),
		ref: O(() => r(), (e) => r(e))
	}), p = w(() => F(s, l.props)), m = w(() => F({}, l.contentProps));
	var h = Ee();
	v(h, () => ({ ...c(p) }));
	var y = f(h);
	v(y, () => ({ ...c(m) })), o(f(y), () => t.children ?? b), u(y), u(h), _(e, h), d();
}
//#endregion
...
function Q(e, t) {
	...
	var p = m(), h = l(p), g = (e) => {
		var n = m();
		o(l(n), () => t.child, () => ({ props: c(s) })), _(e, n);
	}, y = (e) => {
		var n = Ae();
		v(n, () => ({ ...c(s) })), o(f(n), () => t.children ?? b), u(n), _(e, n);
	};
	r(h, (e) => {
		t.child ? e(g) : e(y, -1);
	}), _(e, p), d();
...
function Le(e, t) {
	i(t, !0);
	let n = g(t, "forceMount", 3, !1), r = C(t, Ie), a = G.create(), o = w(() => F(r, a.props));
	{
		let t = (e) => {
			$(e, y(() => c(o)));
		}, r = w(() => n() || a.isVisible);
...
function ze(e, t) {
	i(t, !0);
	let n = g(t, "forceMount", 3, !1), r = C(t, Re), a = pe.create(), o = w(() => F(r, a.props));
	{
		let t = (e) => {
			$(e, y(() => c(o)));
		}, r = w(() => n() || !a.isHidden);
...
function Ve(e, t) {
	i(t, !0);
	let n = g(t, "forceMount", 3, !1), r = C(t, Be), a = fe.create(), o = G.create(), s = w(() => F(r, a.props, o.props, { "data-state": a.isVisible ? "visible" : "hidden" })), l = w(() => n() || a.isVisible && o.isVisible);
	R(e, {
		get open() {
			return c(l);
		},
...
function Ue(e, t) {
	let n = T();
	i(t, !0);
	let a = g(t, "ref", 15, null), o = g(t, "id", 19, () => I(n)), s = C(t, He), u = de.create({
	...
	r(h, (e) => {
		c(f) === "hover" ? e(v) : c(f) === "scroll" ? e(b, 1) : c(f) === "auto" ? e(x, 2) : c(f) === "always" && e(S, 3);
	}), _(e, p), d();
}
//#endregion
...
function Ke(e, t) {
	i(t, !0);
	let n = g(t, "ref", 15, null), a = C(t, We), s = new P(), p = ve.create({
		id: O(() => t.id),
		ref: O(() => n(), (e) => n(e)),
		mounted: O(() => s.current)
	}), h = w(() => F(a, p.props, { style: { hidden: !t.present } }));
	var y = m(), x = l(y), S = (e) => {
		var n = m();
		o(l(n), () => t.child, () => ({ props: c(h) })), _(e, n);
	}, T = (e) => {
		var n = Ge();
		v(n, () => ({ ...c(h) })), o(f(n), () => t.children ?? b), u(n), _(e, n);
	};
	r(x, (e) => {
		t.child ? e(S) : e(T, -1);
	}), _(e, y), d();
...
function Je(e, t) {
	let n = T();
	i(t, !0);
	let r = g(t, "id", 19, () => I(n)), a = g(t, "ref", 15, null), o = g(t, "forceMount", 3, !1), s = C(t, qe), l = H.get();
	{
		let t = (e, t) => {
			let n = () => t?.().present;
			Ke(e, y(() => s, {
...
function Ze(e, t) {
	i(t, !0);
	let n = g(t, "ref", 15, null), a = C(t, Ye), s = ye.create({
		id: O(() => t.id),
		ref: O(() => n(), (e) => n(e))
	}), p = w(() => F(a, s.props));
	var h = m(), y = l(h), x = (e) => {
		var n = m();
		o(l(n), () => t.child, () => ({ props: c(p) })), _(e, n);
	}, S = (e) => {
		var n = Xe();
		v(n, () => ({ ...c(p) })), o(f(n), () => t.children ?? b), u(n), _(e, n);
	};
	r(y, (e) => {
		t.child ? e(x) : e(S, -1);
	}), _(e, h), d();
...
function $e(e, t) {
	let n = T();
	i(t, !0);
	let a = g(t, "ref", 15, null), o = g(t, "id", 19, () => I(n)), s = C(t, Qe), u = B.get(), f = w(() => !!(u.scrollbarXNode && u.scrollbarYNode)), p = w(() => u.opts.type.current !== "scroll" && c(f));
	var h = m(), v = l(h), b = (e) => {
		Ze(e, y(() => s, {
			get id() {
				return o();
...
function rt(n, a) {
	i(a, !0);
	let s = g(a, "ref", 15, null), c = g(a, "orientation", 3, "vertical"), u = C(a, tt);
	var f = m();
	t(l(f), () => we, (n, i) => {
		i(n, y(() => u, {
			get ref() {
