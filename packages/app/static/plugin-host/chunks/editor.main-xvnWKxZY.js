...
import { a as t, c as n, d as r, f as i, h as a, i as o, l as s, m as c, n as l, o as u, p as d, r as ee, s as f, t as te, u as ne } from "./editor.api2-PvII3Pyt.js";
import { t as re } from "./monaco.contribution-JmWG9jcl.js";
import { t as ie } from "./workers-CrbJEVSM.js";
...
function g() {
	return import("./cssMode-CPOzocez.js");
}
a.onLanguage("less", () => {
...
function ye() {
	return import("./htmlMode-BwMUWzCb.js");
}
...
function Ce() {
	return import("./jsonMode-Dpu2K_5E.js");
}
a.register({
	id: "json",
	extensions: [
...
x({
	...
	loader: () => import("./freemarker2-tZFQkTmS.js").then((e) => e.TagAutoInterpolationDollar)
}), x({
	id: "freemarker2.tag-angle.interpolation-dollar",
	aliases: ["FreeMarker2 (Angle/Dollar)", "Apache FreeMarker2 (Angle/Dollar)"],
	loader: () => import("./freemarker2-tZFQkTmS.js").then((e) => e.TagAngleInterpolationDollar)
}), x({
	id: "freemarker2.tag-bracket.interpolation-dollar",
	aliases: ["FreeMarker2 (Bracket/Dollar)", "Apache FreeMarker2 (Bracket/Dollar)"],
	loader: () => import("./freemarker2-tZFQkTmS.js").then((e) => e.TagBracketInterpolationDollar)
}), x({
	id: "freemarker2.tag-angle.interpolation-bracket",
	aliases: ["FreeMarker2 (Angle/Bracket)", "Apache FreeMarker2 (Angle/Bracket)"],
	loader: () => import("./freemarker2-tZFQkTmS.js").then((e) => e.TagAngleInterpolationBracket)
}), x({
	id: "freemarker2.tag-bracket.interpolation-bracket",
	aliases: ["FreeMarker2 (Bracket/Bracket)", "Apache FreeMarker2 (Bracket/Bracket)"],
	loader: () => import("./freemarker2-tZFQkTmS.js").then((e) => e.TagBracketInterpolationBracket)
}), x({
	...
	loader: () => import("./freemarker2-tZFQkTmS.js").then((e) => e.TagAutoInterpolationBracket)
}), x({
	id: "go",
	extensions: [".go"],
	aliases: ["Go"],
	...
	loader: () => import("./handlebars-CyNXiyBe.js")
}), x({
	id: "hcl",
	extensions: [
		".tf",
	...
	loader: () => import("./html-DuYR0Cao.js")
}), x({
	id: "ini",
	extensions: [
		".ini",
	...
	loader: () => import("./javascript-CMqQwcfK.js")
}), x({
	id: "julia",
	extensions: [".jl"],
	aliases: ["julia", "Julia"],
	...
	loader: () => import("./liquid-D4W3cmfN.js")
}), x({
	id: "m3",
	extensions: [
		".m3",
	...
	loader: () => import("./python-CVSh6RZw.js")
}), x({
	id: "qsharp",
	extensions: [".qs"],
	aliases: ["Q#", "qsharp"],
	...
	loader: () => import("./razor-DEixjjGD.js")
}), x({
	id: "redis",
	extensions: [".redis"],
	aliases: ["redis"],
	...
	loader: () => import("./typescript-B4uhNz4P.js")
}), x({
	id: "typespec",
	extensions: [".tsp"],
	aliases: ["TypeSpec"],
	...
	loader: () => import("./yaml-BohifKTK.js")
});
//#endregion
...
var At = /* @__PURE__ */ new Map([
	[R.Error, t.Error],
	[R.Warning, t.Warning],
	[R.Information, t.Info],
	[R.Hint, t.Hint]
]);
function jt(e) {
	return e ? At.get(e) ?? t.Error : t.Error;
}
...
function Z(e) {
	...
	return e.tags && (t.tags = e.tags.map((e) => Nt(e)).filter((e) => e !== void 0)), e.relatedInformation && (t.relatedInformation = e.relatedInformation.map((e) => ({
		resource: i.parse(e.location.uri),
...
function Vt(e, t, r, i, a) {
	...
	e.textEdit && ("range" in e.textEdit ? (o = e.textEdit.newText, s = G(t.translateBackRange(r.textDocument, e.textEdit.range), i).range) : (o = e.textEdit.newText, s = {
		insert: G(t.translateBackRange(r.textDocument, e.textEdit.insert), i).range,
		replace: G(t.translateBackRange(r.textDocument, e.textEdit.replace), i).range
	})), s ||= n.fromPositions(a, a);
	let c = {
		label: e.label,
		kind: pt(e.kind),
		insertText: o,
...
var _n = class extends K {
	...
	async provideCodeActions(e, t, r, i) {
		let a = this._client.bridge.translate(e, t.getStartPosition()), o = await this._client.server.textDocumentCodeAction({
			textDocument: a.textDocument,
			range: this._client.bridge.translateRange(e, t),
			context: {
				diagnostics: r.markers.map((t) => ({
					range: this._client.bridge.translateRange(e, n.lift(t)),
					message: t.message,
...
function Ln(e) {
	return typeof e == "string" ? e : e.map((e) => {
		...
		return e.location && (t.location = {
			uri: i.parse(e.location.uri),
			range: new n(e.location.range.start.line + 1, e.location.range.start.character + 1, e.location.range.end.line + 1, e.location.range.end.character + 1)
		}), t;
	});
}
function Rn(e) {
...
var Qn = class extends K {
	...
	translateBackRange(e, t) {
		...
		return {
			textModel: i,
			range: new n(t.start.line + 1, t.start.character + 1, t.end.line + 1, t.end.character + 1)
		};
	}
	translate(e, t) {
		return {
...
//#endregion
export { te as CancellationTokenSource, l as Emitter, ee as KeyCode, o as KeyMod, t as MarkerSeverity, u as MarkerTag, f as Position, n as Range, s as Selection, ne as SelectionDirection, r as Token, i as Uri, ie as createWebWorker, ae as css, d as editor, le as html, be as json, a as languages, De as lsp, re as typescript };
