...
import { t } from "./workers-CrbJEVSM.js";
import { _ as n, a as r, c as i, d as a, f as o, g as s, h as c, i as l, l as u, m as d, n as f, o as p, p as m, r as h, s as g, t as _, u as v, v as y } from "./lspLanguageFeatures-DMXxMWCp.js";
	...
	_getClient() {
		return this._lastUsedTime = Date.now(), this._client ||= (this._worker = t({
			...
			createWorker: () => new Worker(new URL(
				/* @vite-ignore */
				"/plugin-host/assets/html.worker-DVhl5K-g.js",
				"" + import.meta.url
			), { type: "module" }),
			createData: {
