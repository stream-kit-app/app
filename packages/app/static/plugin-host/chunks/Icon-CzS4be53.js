import { Bt as e, Gt as t, Hr as n, On as r, Qn as i, Qr as a, Vr as o, a as s, an as c, cn as l, cr as u, in as d, it as f, lr as p, on as m, p as h, pr as g } from "./index-client-BHp3UA-q.js";
import "./disclose-version-YhYaTdgb.js";
//#region ../../node_modules/.pnpm/@iconify+svelte@5.2.1_svelt_06b0b565f2d693599d9335e2e9b7f950/node_modules/@iconify/svelte/dist/functions.js
var _ = /^[a-z0-9]+(-[a-z0-9]+)*$/, v = (e, t, n, r = "") => {
	let i = e.split(":");
	if (e.slice(0, 1) === "@") {
	...
	if (n && r === "") {
		...
		return t && !y(e, n) ? null : e;
	}
	return null;
}, y = (e, t) => e ? !!((t && e.prefix === "" || e.prefix) && e.name) : !1;
function b(e, t) {
...
function E(e, t) {
	let n = T(e, t);
	for (let r in w) r in S ? r in e && !(r in n) && (n[r] = S[r]) : r in t ? n[r] = t[r] : r in e && (n[r] = e[r]);
	return n;
}
function ee(e, t, n) {
...
function k(e) {
	...
	let t = e;
	if (typeof t.prefix != "string" || !e.icons || typeof e.icons != "object" || !O(e, te)) return null;
	let n = t.icons;
	for (let e in n) {
		let t = n[e];
		if (!e || typeof t.body != "string" || !O(t, w)) return null;
	}
	let r = t.aliases || Object.create(null);
	for (let e in r) {
		let t = r[e], i = t.parent;
		if (!e || typeof i != "string" || !n[i] && !r[i] || !O(t, w)) return null;
	}
	return t;
}
...
function ae(e) {
	let t = typeof e == "string" ? v(e, !0, N) : e;
	if (t) {
...
var P = Object.freeze({
	...
	...P,
	...S
}), ce = /(-?[0-9.]*[0-9]+[0-9.]*)/g, le = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function I(e, t, n) {
	if (t === 1) return e;
...
function fe(e, t, n) {
	let r = ue(e);
	return de(r.defs, t + r.content + n);
}
var pe = (e) => e === "unset" || e === "undefined" || e === "none";
function me(e, t) {
	let n = {
		...C,
		...e
	...
	o === null ? (d = s === null ? "1em" : s === "auto" ? l : s, u = I(d, c / l)) : (u = o === "auto" ? c : o, d = s === null ? I(u, l / c) : s === "auto" ? l : s);
	let f = {}, p = (e, t) => {
		pe(t) || (f[e] = t.toString());
	};
...
var he = /\sid="(\S+)"/g, L = /* @__PURE__ */ new Map();
function ge(e) {
	e = e.replace(/[0-9]+$/, "") || "a";
	let t = L.get(e) || 0;
	return L.set(e, t + 1), t ? `${e}${t}` : e;
}
function _e(e) {
	let t = [], n;
	for (; n = he.exec(e);) t.push(n[1]);
	...
	e.pendingCallbacksFlag || (e.pendingCallbacksFlag = !0, setTimeout(() => {
		...
		t.forEach((t) => {
			...
			a.pending = a.pending.filter((t) => {
				...
				return !1;
			}), a.pending.length !== o && (n || K([e], t.id), t.callback(a.loaded.slice(0), a.missing.slice(0), a.pending.slice(0), t.abort));
		});
	}));
}
var Ee = 0;
function De(e, t, n) {
	let r = Ee++, i = K.bind(null, n, r);
...
function Ne(e, t, n) {
	...
	return !r || !i ? (n(void 0, 424), J) : r.query(t, i, n)().abort;
}
function X() {}
function Pe(e) {
...
function Le(e, t) {
	e.iconsToLoad ? e.iconsToLoad = e.iconsToLoad.concat(t).sort() : e.iconsToLoad = t, e.iconsQueueFlag || (e.iconsQueueFlag = !0, setTimeout(() => {
		...
		let { valid: a, invalid: o } = Fe(r);
		if (o.length && Z(e, o, null), !a.length) return;
		let s = n.match(_) ? z(t) : null;
		if (!s) {
			Z(e, a, null);
			return;
		}
...
var Re = (e, t) => {
	...
	if (!n.pending.length) {
		let e = !0;
		return t && setTimeout(() => {
			e && t(n.loaded, n.missing, n.pending, X);
		}), () => {
			e = !1;
		};
	}
...
var qe = {
	...
	"aria-hidden": !0,
	role: "img"
}, Ye = { display: "inline-block" }, Q = { "background-color": "currentColor" }, Xe = { "background-color": "transparent" }, Ze = {
	image: "var(--svg)",
	repeat: "no-repeat",
	size: "100% 100%"
}, $ = {
...
for (let e in $) {
	let t = $[e];
	for (let n in Ze) t[e + "-" + n] = Ze[n];
}
function Qe(e) {
	return e + (e.match(/^[-0-9.]+$/) ? "px" : "");
}
function $e(e, t) {
	let n = ze(qe, t), r = t.mode || "svg", i = r === "svg" ? { ...Je } : {};
	e.body.indexOf("xlink:") === -1 && delete i["xmlns:xlink"];
	...
	for (let e in t) {
		...
		if (r !== void 0) switch (e) {
			...
			case "vFlip":
				...
				break;
			case "flip":
				typeof r == "string" && Ve(n, r);
				break;
			case "color":
				a = a + (a.length > 0 && a.trim().slice(-1) !== ";" ? ";" : "") + "color: " + r + "; ";
				break;
			case "rotate":
				typeof r == "string" ? n[e] = He(r) : typeof r == "number" && (n[e] = r);
				break;
			case "ariaHidden":
			case "aria-hidden":
	...
	let o = me(e, n), s = o.attributes;
	if (n.inline && (a = "vertical-align: -0.125em; " + a), r === "svg") return Object.assign(i, s), a !== "" && (i.style = a), {
		svg: !0,
		attributes: i,
		body: _e(o.body)
	};
	let { body: c, width: l, height: u } = e, d = r === "mask" || (r === "bg" ? !1 : c.indexOf("currentColor") !== -1), f = { "--svg": Ke(Ue(c, {
		...s,
		width: l + "",
		height: u + ""
	})) }, p = (e) => {
	...
	p("width"), p("height"), Object.assign(f, Ye, d ? Q : Xe);
	let m = "";
	for (let e in f) m += e + ": " + f[e] + ";";
	return i.style = m + a, {
		svg: !1,
		attributes: i
	};
}
if (ie(!0), ve("", we), typeof document < "u" && typeof window < "u") {
	let e = window;
...
function tt(e, t, n, r) {
	function i() {
		t.loading &&= (t.loading.abort(), null);
	}
	if (typeof e == "object" && e && typeof e.body == "string") return t.name = "", i(), { data: {
		...C,
		...e
	} };
	let a;
	if (typeof e != "string" || (a = v(e, !1, !0)) === null) return i(), null;
	let o = ae(a);
	if (!o) return !et() && (!t.loading || t.loading.name !== e) && (i(), t.name = "", t.loading = {
		name: e,
		abort: Re([a], n)
	}), null;
	i(), t.name !== e && (t.name = e, r && !t.destroyed && setTimeout(() => {
		r(e);
	}));
	let s = ["iconify"];
	return a.prefix !== "" && s.push("iconify--" + a.prefix), a.provider !== "" && s.push("iconify--" + a.provider), {
		data: o,
		classes: s
	};
}
...
//#endregion
//#region ../../node_modules/.pnpm/@iconify+svelte@5.2.1_svelt_06b0b565f2d693599d9335e2e9b7f950/node_modules/@iconify/svelte/dist/Icon.svelte
var rt = new Set([
	"$$slots",
	"$$events",
	"$$legacy"
]), it = l("<svg></svg>"), at = m("<span></span>");
function ot(l, m) {
	n(m, !0);
	let _ = {
		name: "",
		loading: null,
		destroyed: !1
	}, v = h(m, rt), y = u(0), b = g(() => (r(y), tt(m.icon, _, S, m.onload))), x = g(() => {
		let e = r(b) ? nt(r(b).data, v) : null;
		return e && r(b).classes && v.class === void 0 && (e.attributes.class = (typeof v.class == "string" ? v.class + " " : "") + r(b).classes.join(" ")), e;
	});
	function S() {
		p(y);
	}
	s(() => {
		_.destroyed = !0, _.loading &&= (_.loading.abort(), null);
	});
	var C = c(), w = i(C), T = (n) => {
		var o = c(), s = i(o), l = (t) => {
			var n = it();
			f(n, () => ({ ...r(x).attributes })), e(n, () => r(x).body, !0), a(n), d(t, n);
		}, u = (e) => {
			var t = at();
			f(t, () => ({ ...r(x).attributes })), d(e, t);
		};
		t(s, (e) => {
			r(x).svg ? e(l) : e(u, -1);
		}), d(n, o);
