import { $n as e, Gt as t, Hr as n, Mt as r, On as i, Qr as a, Vr as o, Wn as s, Zn as c, ai as l, bt as u, f as d, in as f, it as p, nn as m, on as h, p as g, pr as _, vt as v } from "./index-client-BHp3UA-q.js";
import "./disclose-version-YhYaTdgb.js";
import { t as y } from "./Icon-CzS4be53.js";
import { t as b } from "./utils-CRERhYYg.js";
import { t as x } from "./dist-CzEWvIc2.js";
...
function k(h, x) {
	n(x, !0);
	let k = d(x, "variant", 3, "default"), A = g(x, T), j = _(() => x.icon === !1 ? void 0 : x.icon ?? C[k()]);
	var M = O();
	p(M, (e) => ({
		class: e,
		...A
	...
	var R = e(I, 2), z = (e) => {
		...
		}, [() => u(b("opacity-80", x.title && "mt-1"))]), f(e, t);
	};
	t(R, (e) => {
		x.description && e(z);
	}), r(e(R, 2), () => x.children ?? l), a(F), a(M), f(h, M), o();
}
//#endregion
