import { a as e, i as t, t as n } from "./codemirror-BIAr-JtL.js";
...
import { C as ue, D as $, _ as de, a as fe, c as pe, d as me, g as he, i as ge, l as _e, n as ve, o as ye, r as be, s as xe, u as Se, v as Ce, x as we } from "./animations-complete-BfqHI4B-.js";
import { _ as Te, b as Ee, g as De, h as Oe, m as ke, v as Ae, y as je } from "./scroll-lock-BZF1_Y9Y.js";
import { i as Me, n as Ne, r as Pe, t as Fe } from "./use-id-C9llEPxa.js";
import { a as Ie, c as Le, d as Re, f as ze, h as Be, l as Ve, m as He, o as Ue, p as We, s as Ge, u as Ke } from "./command-wJw-CJ8Z.js";
import { t as qe } from "./on-mount-effect.svelte-BDwcYjCA.js";
import { _ as Je, a as Ye, d as Xe, f as Ze, g as Qe, h as $e, i as et, l as tt, m as nt, o as rt, p as it, r as at, s as ot, u as st, v as ct } from "./dom-B4Rzp8oi.js";
import { a as lt, o as ut, t as dt } from "./presence-manager.svelte-BOTfPcjg.js";
import { a as ft, c as pt, i as mt, n as ht, r as gt, s as _t } from "./dialog-t7Ac13OT.js";
import { t as vt } from "./portal-D-OgjF3O.js";
import "./legacy-CT5GbYa1.js";
import { a as yt, n as bt, r as xt, t as St } from "./popper-layer-force-mount-BxV85AhM.js";
import { t as Ct } from "./floating-layer-anchor-B_R8arju.js";
import { i as wt, n as Tt, r as Et } from "./popover-S-nP6M-I.js";
import { t as Dt } from "./scroll-area-7qg9ezvn.js";
import { t as Ot } from "./button-CgKHPPIe.js";
...
var $r = Y("<span class=\"text-red-400\">*</span>"), ei = Y(" <!>", 1), ti = Y("<span class=\"grid h-full min-w-10 place-items-center rounded-l-xl border border-r-0 border-dark-700 text-dark-50\"><!></span>"), ni = Y("<!> <!>", 1), ri = Y("<!> <!> <!>", 1), ii = Y("<div><button type=\"button\" role=\"combobox\" aria-haspopup=\"dialog\" class=\"flex w-full min-w-0 cursor-pointer items-center outline-none disabled:cursor-not-allowed disabled:opacity-50\"><!> <span><span> </span> <!></span></button></div> <!>", 1), ai = Y("<p class=\"text-sm text-red-400\"> </p>"), oi = Y("<div><!> <!> <!></div>");
function si(e, t) {
	u(t, !0);
	let n = k(t, "searchable", 3, "auto"), s = k(t, "dialogTitle", 3, "Select option"), c = k(t, "dialogDescription", 3, "Search and select an option from the list."), l = k(t, "id", 19, Fe), d = k(t, "required", 3, !1), f = k(t, "type", 3, "single"), m = k(t, "value", 15), g = K(() => t.placeholder ?? "Select an option"), y = K(() => t.loadingPlaceholder ?? "Loading..."), b = K(() => t.searchPlaceholder ?? "Search values"), C = K(() => t.noResultsLabel ?? "No matches found"), w = N(!1), T = N(""), O = Fe(), A = Fe(), j = Jr(() => t.items, () => t.reloadKey?.()), R = K(() => t.disabled ?? !1), z = K(() => f() === "multiple"), B = K(() => n() === !0 ? !0 : n() === !1 ? !1 : j.items.length >= 8), V = K(() => {
		if (j.loading) return h(y);
		if (h(z)) {
			let e = m();
			if (e.length === 0) return h(g);
			let t = e.map((e) => j.items.find((t) => t.value === e)?.label).filter(Boolean);
			return t.length > 0 ? t.join(", ") : h(g);
		}
		let e = m();
		return e ? j.items.find((t) => t.value === e)?.label ?? e : h(g);
	}), H = K(() => h(z) ? m().length > 0 : !!m());
	function U(e) {
		G(w, e, !0), e || G(T, "");
	}
	function Y(e) {
		return h(z) ? m().includes(e) : m() === e;
	}
	function ee(e) {
		if (!e.disabled) {
			if (h(z)) {
				let n = [...m()], r = n.indexOf(e.value);
				r >= 0 ? n.splice(r, 1) : n.push(e.value), m(n), t.onValueChange?.(n);
				return;
			}
			m(e.value), t.onValueChange?.(e.value), G(w, !1);
		}
	}
	function X() {
		h(R) || G(w, !0);
	...
	async function te(e) {
		t.dialogProps?.onOpenAutoFocus?.(e), !(e.defaultPrevented || !h(B)) && (e.preventDefault(), await p(), document.getElementById(A)?.focus());
	}
	function re(e) {
		t.dialogProps?.onCloseAutoFocus?.(e), !e.defaultPrevented && e.preventDefault();
	}
	var ie = oi(), ae = E(ie), oe = (e) => {
		dr(e, {
			get for() {
				return l();
			},
	...
	a(se, () => mt, (e, n) => {
		n(e, {
			...
			children: (e, n) => {
				var u = ii(), d = _(u), f = E(d), p = E(f), m = (e) => {
					var n = ti();
					Z(E(n), {
						get icon() {
				...
				v(x), Z(i(x, 2), {
					...
					n(e, {
						children: (e, n) => {
							...
							var u = i(l, 2);
							{
								let e = K(() => t.dialogProps?.trapFocus ?? !1), n = K(() => t.dialogProps?.preventScroll ?? !1), r = K(() => Q("z-60", t.dialogProps?.class));
								a(u, () => pt, (l, u) => {
									u(l, J(() => t.dialogProps, {
										get trapFocus() {
											return h(e);
										...
										children: (e, n) => {
											...
											var d = i(u, 2);
											{
												let e = K(() => !j.loading), n = K(() => Q(t.commandProps?.class));
												a(d, () => Ue, (r, s) => {
																			...
																			t(e, {
																				children: (e, t) => {
																					var n = L(), r = _(n), s = (e) => {
																						...
																						}), o(i(n, 2), 17, () => j.items, (e) => e.value, (e, t) => {
																							var n = L(), r = _(n);
																							{
					...
					P(d, 1, e), r(f, "id", l()), r(f, "aria-expanded", h(w)), r(f, "aria-controls", h(w) ? O : void 0), f.disabled = h(R), P(g, 1, t), P(x, 1, n), W(k, h(V));
				}, [
					() => q(Q("relative flex w-full min-w-0 items-center rounded-xl", "has-focus:ring-2 has-focus:ring-primary", t.error && "has-focus:ring-red-500")),
					...
					() => q(Q("min-w-0 flex-1 truncate text-left", !h(H) && "text-dark-300"))
				]), ne("click", f, X), M(e, u);
			},
			$$slots: { default: !0 }
		});
...
var pi = Y("<button><!> <span> </span> <!> <!></button>"), mi = Y("<p class=\"mb-3 text-xs font-semibold tracking-wide text-dark-200 uppercase\"> </p> <!>", 1), hi = Y("<!> <!>", 1), gi = Y("<p class=\"text-sm text-red-400\"> </p>"), _i = Y("<div><!> <!> <!></div>");
function vi(e, t) {
	u(t, !0);
...
var yi = new Set([
	...
	"value",
	"tabindex"
]), bi = Y("<span><!></span>"), xi = Y("<button type=\"button\"><!></button>"), Si = Y("<p class=\"text-sm text-red-400\"> </p>"), Ci = Y("<div><!> <div><!> <input/> <!> <!> <!></div> <!></div>");
function wi(e, t) {
	u(t, !0);
	let n = k(t, "id", 19, Fe), a = k(t, "copyable", 3, !1), o = k(t, "copyLabel", 3, "Copy"), s = k(t, "copiedLabel", 3, "Copied"), c = k(t, "size", 3, "md"), l = U(t, yi), d = N(!1), f = N(!1), p, m = K(() => t.type === "password"), g = K(() => !!t.appendIcon || h(m) || a()), _ = K(() => a() ? t.readonly ?? !0 : t.readonly), y = K(() => a() && h(_)), b = We;
	async function C() {
		await navigator.clipboard.writeText(String(t.value ?? "")), p && clearTimeout(p), G(f, !0), p = setTimeout(() => {
			G(f, !1);
		}, 2e3);
	}
	var w = Ci(), O = E(w), A = (e) => {
	...
	var j = i(O, 2), L = E(j), R = (e) => {
		...
		}), v(n), S((e) => P(n, 1, e), [() => q(Q("grid h-full place-items-center rounded-l-xl border border-dark-500 bg-dark-700 text-dark-50", Re[c()]))]), M(e, n);
	};
	I(L, (e) => {
		t.prependIcon && e(R);
	});
	...
	T(z, (e) => ({
		...
		value: t.value,
		readonly: h(_),
		tabindex: h(y) ? -1 : t.tabindex,
		...l,
		type: h(m) ? h(d) ? "text" : "password" : t.type
	}), [() => Q("min-w-0 w-full truncate border bg-dark-700 text-dark-50 outline-none", b[c()], t.error ? "border-red-500" : "border-dark-500", {
		"rounded-l-none rounded-r-xl border-l-0": t.prependIcon && !h(g),
		"rounded-l-none border-l-0": t.prependIcon && h(g),
		"rounded-l-xl rounded-r-none border-r-0": !t.prependIcon && h(g),
		"rounded-xl": !t.prependIcon && !h(g)
	...
	var B = i(z, 2), V = (e) => {
		...
		}), v(n), S((e) => P(n, 1, e), [() => q(Q("grid h-full place-items-center text-dark-50", Re[c()], h(m) || a() ? "border-y border-r-0 border-l border-dark-500" : "rounded-r-xl border border-l-0 border-dark-500"))]), M(e, n);
	};
	I(B, (e) => {
		t.appendIcon && e(V);
	});
	var H = i(B, 2), J = (e) => {
		var t = xi(), n = E(t);
		{
			let e = K(() => h(f) ? "ri:checkbox-circle-fill" : "ri:file-copy-line");
			Z(n, {
				get icon() {
					return h(e);
				},
		...
		v(t), S((e) => {
			P(t, 1, e), r(t, "aria-label", h(f) ? s() : o());
		}, [() => q(Q("grid h-full place-items-center rounded-r-xl border border-dark-500 border-l-dark-600 bg-dark-700 transition-colors", h(f) ? "text-success" : "text-dark-50", Re[c()]))]), ne("click", t, () => void C()), M(e, t);
	};
	I(H, (e) => {
		a() && e(J);
	});
	var Y = i(H, 2), ee = (e) => {
		var t = xi(), n = E(t);
		{
			let e = K(() => h(d) ? "mdi:eye-off-outline" : "mdi:eye-outline");
			Z(n, {
				get icon() {
					return h(e);
				},
		...
		v(t), S((e) => {
			P(t, 1, e), r(t, "aria-label", h(d) ? "Hide password" : "Show password"), r(t, "aria-pressed", h(d));
		}, [() => q(Q("grid h-full place-items-center rounded-r-xl border border-dark-500 border-l-dark-600 bg-dark-700 text-dark-50", Re[c()]))]), ne("click", t, () => G(d, !h(d))), M(e, t);
	};
	I(Y, (e) => {
		h(m) && e(ee);
	}), v(j);
	...
	I(X, (e) => {
		...
		P(w, 1, e), P(j, 1, t);
	}, [() => q(Q("relative grid w-full min-w-0 gap-2")), () => q(Q("relative flex w-full min-w-0 items-center rounded-xl", !h(y) && "has-focus:ring-2 has-focus:ring-primary", t.error && !h(y) && "has-focus:ring-red-500", t.class))]), M(e, w), x();
}
X(["click"]);
//#endregion
//#region ../ui/src/lib/components/input/input-file-path.svelte
var Ti = Y("<div class=\"grid gap-2\"><div class=\"flex items-end gap-2\"><div class=\"min-w-0 flex-1\"><!></div> <!></div></div>");
function Ei(e, t) {
	u(t, !0);
...
var Di = Y("<p class=\"text-sm text-red-400\"> </p>"), Oi = Y("<div class=\"grid w-full min-w-0 gap-2\"><!> <button type=\"button\"><!> <span><!></span></button> <!></div>");
function ki(e, t) {
	u(t, !0);
...
var Ai = Y("<div class=\"grid grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)_auto] items-center gap-2\"><!> <!> <!></div>"), ji = Y("<p class=\"text-sm text-destructive-50\"> </p>"), Mi = Y("<div role=\"group\"><!> <div class=\"grid gap-2\"><!> <!></div> <!></div>");
function Ni(e, t) {
	u(t, !0);
...
var Pi = Y("<span class=\"text-red-400\" aria-hidden=\"true\">*</span>"), Fi = Y(" <!>", 1), Ii = Y("<button type=\"button\" role=\"tab\"> </button>"), Li = Y("<p class=\"text-sm text-red-400\"> </p>"), Ri = Y("<div><!> <div role=\"tablist\"></div> <div class=\"min-w-0\" role=\"tabpanel\"><!></div> <!></div>");
function zi(e, t) {
	u(t, !0);
...
var Bi = new Set([
	...
	"error",
	"value"
]), Vi = Y("<!> <!>", 1), Hi = Y("<div class=\"px-3 py-1.5 text-sm text-dark-300\"> </div>"), Ui = Y(" <!>", 1), Wi = Y("<!> <!> <!>", 1), Gi = Y("<div class=\"flex flex-wrap gap-1.5\"></div>"), Ki = Y("<li role=\"presentation\"><button type=\"button\" role=\"option\"><span> </span> <span class=\"text-dark-300\"> </span></button></li>"), qi = Y("<ul class=\"absolute top-[calc(100%-1.5rem)] z-50 mt-1 max-h-40 w-full overflow-y-auto rounded-xl border border-dark-600 bg-dark-800 p-1 shadow-md\" role=\"listbox\"></ul>"), Ji = Y("<p class=\"text-sm text-red-400\"> </p>"), Yi = Y("<div><!> <div><!> <div class=\"min-w-0 flex-1\"><input/></div></div> <!> <!> <!></div>");
function Xi(e, t) {
	u(t, !0);
	let n = k(t, "variables", 19, () => []), l = k(t, "id", 19, Fe), d = k(t, "value", 31, () => H({
		type: "",
		value: ""
	})), f = U(t, Bi), p = K(() => t.selectPlaceholder ?? "Select"), m = K(() => t.loadingPlaceholder ?? "Loading..."), g = Jr(() => t.items), y = N(null), b = N(!1), C = N(""), w = N(0), O = K(() => {
		if (!h(C)) return n();
...
var Zi = Y("<div class=\"flex items-center justify-between gap-4\"><!> <span class=\"text-sm text-dark-100\"> </span></div>"), Qi = Y("<p class=\"text-sm text-red-500\"> </p>"), $i = Y("<div><!> <input type=\"range\"/> <!></div>");
function ea(e, t) {
	u(t, !0);
...
var ta = Y("<p class=\"text-sm text-red-400\"> </p>"), na = Y("<div><div class=\"flex items-center gap-3\"><!> <!></div> <!></div>");
function ra(e, t) {
	u(t, !0);
	let n = k(t, "checked", 15, !1), r = k(t, "id", 19, Fe);
	var o = na(), s = E(o), c = E(s);
	{
...
var ia = Y("<div class=\"flex items-center gap-2\"><!> <!></div>"), aa = Y("<p class=\"text-sm text-destructive-50\"> </p>"), oa = Y("<div role=\"group\"><!> <div class=\"grid gap-2\"><!> <!></div> <!></div>");
function sa(e, t) {
	u(t, !0);
...
}, la = Y("<div class=\"relative w-full\"><div class=\"absolute inset-x-0 top-0\"></div></div>");
function ua(e, t) {
	u(t, !0);
...
var da = (e, t = V) => {
	...
	"error",
	"value"
]), pa = Y(" <!>", 1), ma = Y("<span class=\"text-red-400\">*</span>"), ha = Y("<div class=\"px-3 py-1.5 text-sm text-dark-300\"> </div>"), ga = Y("<div class=\"px-3 py-1.5 text-sm text-dark-300\"></div>"), _a = Y("<!> <!> <!>", 1), va = Y("<div><div class=\"min-w-0 flex-1\"><!></div> <button type=\"button\" aria-haspopup=\"listbox\"><!></button></div> <!>", 1), ya = Y("<p class=\"text-sm text-red-400\"> </p>"), ba = Y("<div><!> <!> <!></div>");
function xa(e, t) {
	u(t, !0);
	let n = k(t, "allowCustomValue", 3, !0), o = k(t, "id", 19, Fe), s = k(t, "value", 15, ""), c = U(t, fa), d = K(() => t.placeholder), f = K(() => t.loadingPlaceholder ?? "Loading..."), m = K(() => t.selectAriaLabel ?? "Select value"), g = N(!1), y = N(""), b = N(!1), C = new ca(), w = Jr(() => t.items, () => t.reloadKey?.()), T = new Hr(() => h(y), 100), O = K(() => new Map(w.items.map((e) => [e.value, e]))), A = K(() => h(O).get(s())), j = K(() => h(A)?.value ?? ""), F = K(() => {
		if (w.loading) return [];
...
var Sa = new Set([
	...
	"suffix",
	"value"
]), Ca = Y("<!> <!>", 1), wa = Y("<div class=\"px-3 py-1.5 text-sm text-dark-300\"> </div>"), Ta = Y(" <!>", 1), Ea = Y("<!> <!> <!>", 1), Da = Y("<div aria-hidden=\"true\">—</div>"), Oa = Y("<input/>"), ka = Y("<div class=\"flex shrink-0 items-center self-center\"><!></div>"), Aa = Y("<div class=\"flex flex-wrap gap-1.5\"></div>"), ja = Y("<li role=\"presentation\"><button type=\"button\" role=\"option\"><span> </span> <span class=\"text-dark-300\"> </span></button></li>"), Ma = Y("<ul class=\"absolute top-[calc(100%-1.5rem)] z-50 mt-1 max-h-40 w-full overflow-y-auto rounded-xl border border-dark-600 bg-dark-800 p-1 shadow-md\" role=\"listbox\"></ul>"), Na = Y("<p class=\"text-sm text-red-400\"> </p>"), Pa = Y("<div><!> <div class=\"flex items-center gap-3\"><div><input/> <!> <!></div> <!></div> <!> <!> <!></div>");
function Fa(e, t) {
	u(t, !0);
	let n = k(t, "variables", 19, () => []), l = k(t, "valuelessOperators", 19, () => []), d = k(t, "id", 19, Fe), f = k(t, "value", 31, () => H({
		...
		type: "equals",
		value: ""
	})), p = U(t, Sa), m = K(() => t.selectPlaceholder ?? "Select"), b = K(() => t.loadingPlaceholder ?? "Loading..."), C = Jr(() => t.items), O = N(null), A = N(null), R = N("path"), z = N(!1), B = N(""), V = N(0), Y = K(() => {
		if (!h(B)) return n();
...
var Ia = new Set([
	...
	"placeholder",
	"class"
]), La = Y("<div class=\"flex flex-wrap gap-1.5\"></div>"), Ra = Y("<li role=\"presentation\"><button type=\"button\" role=\"option\"><span> </span> <span class=\"text-dark-300\"> </span></button></li>"), za = Y("<ul class=\"absolute top-[calc(100%-1.5rem)] z-50 mt-1 max-h-40 w-full overflow-y-auto rounded-xl border border-dark-600 bg-dark-800 p-1 shadow-md\" role=\"listbox\"></ul>"), Ba = Y("<p class=\"text-sm text-red-400\"> </p>"), Va = Y("<div class=\"relative grid w-full min-w-0 gap-2\"><!> <div><input/></div> <!> <!> <!></div>");
function Ha(e, t) {
	u(t, !0);
	let n = k(t, "variables", 19, () => []), a = k(t, "value", 15, ""), l = k(t, "id", 19, Fe), d = U(t, Ia), f = N(null), p = N(!1), m = N(""), g = N(0), _ = K(() => {
		if (!h(m)) return n();
...
X(["mousedown"]);
//#endregion
export { Sr as _, ra as a, zi as c, Ei as d, wi as f, Or as g, Jr as h, sa as i, Ni as l, si as m, Fa as n, ea as o, vi as p, xa as r, Xi as s, Ha as t, ki as u, hr as v, dr as y };
