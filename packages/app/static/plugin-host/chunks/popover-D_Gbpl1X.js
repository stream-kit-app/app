import { At as e, Gt as t, Hr as n, Mt as r, On as i, Qn as a, Qr as o, Vr as s, Zn as c, ai as l, an as u, cr as d, f, in as p, it as m, m as h, on as g, or as _, p as v, pr as y, un as b } from "./index-client-BHp3UA-q.js";
import "./disclose-version-YhYaTdgb.js";
import { t as x } from "./utils-CRERhYYg.js";
import { C as S, D as C, d as w, l as T, o as E, r as D, u as O, x as k } from "./animations-complete-LXv254CE.js";
import { C as A, a as j, n as M, r as N, t as P, x as F } from "./popper-layer-force-mount-D-61-5ih.js";
import { i as I, n as L, r as R } from "./use-id-BrfCmVmn.js";
import { l as z, r as B, t as V } from "./presence-manager.svelte-BwnRDFCN.js";
import { t as H } from "./floating-layer-anchor-D-QDnc3J.js";
import { t as U } from "./safe-polygon.svelte-B9ARBAMQ.js";
import { t as W } from "./scroll-area-D4RE1kQW.js";
...
function $(e, d) {
	let g = b();
	n(d, !0);
	let _ = f(d, "ref", 15, null), x = f(d, "id", 19, () => L(g)), S = f(d, "forceMount", 3, !1), w = f(d, "onOpenAutoFocus", 3, A), T = f(d, "onCloseAutoFocus", 3, A), E = f(d, "onEscapeKeydown", 3, A), D = f(d, "onInteractOutside", 3, A), O = f(d, "trapFocus", 3, !0), k = f(d, "preventScroll", 3, !1), N = f(d, "customAnchor", 3, null), F = v(d, Z), R = Y.create({
		id: C(() => x()),
		ref: C(() => _(), (e) => _(e)),
	...
	var H = u(), U = a(H), W = (e) => {
		P(e, h(() => i(z), () => R.popperProps, {
			...
			popper: (e, n) => {
				let s = () => n?.().props, f = () => n?.().wrapperProps, h = y(() => I(s(), { style: j("popover") }, { style: d.style }));
				var g = u(), _ = a(g), v = (e) => {
					var t = u(), n = a(t);
					{
						let e = y(() => ({
					...
					m(t, () => ({ ...f() }));
					var n = c(t);
					m(n, () => ({ ...i(h) })), r(c(n), () => d.children ?? l), o(n), o(t), p(e, t);
				};
				t(_, (e) => {
					d.child ? e(v) : e(b, -1);
				}), p(e, g);
...
function ne(e, d) {
	let h = b();
	n(d, !0);
	let g = f(d, "id", 19, () => L(h)), _ = f(d, "ref", 15, null), x = f(d, "type", 3, "button"), S = f(d, "disabled", 3, !1), w = f(d, "openOnHover", 3, !1), T = f(d, "openDelay", 3, 700), E = f(d, "closeDelay", 3, 300), D = v(d, ee), O = J.create({
		id: C(() => g()),
		ref: C(() => _(), (e) => _(e)),
		disabled: C(() => !!S()),
		openOnHover: C(() => w()),
	...
	H(e, {
		...
		children: (e, n) => {
			var s = u(), f = a(s), h = (e) => {
				var t = u();
				r(a(t), () => d.child, () => ({ props: i(k) })), p(e, t);
			}, g = (e) => {
				var t = te();
				m(t, () => ({ ...i(k) })), r(c(t), () => d.children ?? l), o(t), p(e, t);
			};
			t(f, (e) => {
				d.child ? e(h) : e(g, -1);
			}), p(e, s);
...
function ae(e, d) {
	let h = b();
	n(d, !0);
	let g = f(d, "id", 19, () => L(h)), _ = f(d, "ref", 15, null), x = v(d, re), S = X.create({
		id: C(() => g()),
		ref: C(() => _(), (e) => _(e))
	}), w = y(() => I(x, S.props));
	var T = u(), E = a(T), D = (e) => {
		var t = u();
		r(a(t), () => d.child, () => ({ props: i(w) })), p(e, t);
	}, O = (e) => {
		var t = ie();
		m(t, () => ({ ...i(w) })), r(c(t), () => d.children ?? l), o(t), p(e, t);
	};
	t(E, (e) => {
		d.child ? e(D) : e(O, -1);
	}), p(e, T), s();
...
function oe(e, t) {
	n(t, !0);
	let i = f(t, "open", 15, !1), o = f(t, "onOpenChange", 3, A), c = f(t, "onOpenChangeComplete", 3, A);
	q.create({
		open: C(() => i(), (e) => {
			i(e), o()(e);
		}),
