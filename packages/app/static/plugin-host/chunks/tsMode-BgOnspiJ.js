import { a as e, c as t, f as n, h as r, o as i, p as a } from "./editor.api2-PvII3Pyt.js";
import { n as o } from "./monaco.contribution-JmWG9jcl.js";
import { t as s } from "./workers-CrbJEVSM.js";
	...
	_getClient() {
		return this._client ||= (async () => (this._worker = s({
			...
			createWorker: () => new Worker(new URL(
				/* @vite-ignore */
				"/plugin-host/assets/ts.worker-BptJClIA.js",
				"" + import.meta.url
			), { type: "module" }),
			label: this._modeId,
			keepIdleModels: !0,
