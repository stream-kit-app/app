import { $n as e, Gn as t, Gt as n, Hr as r, Mt as i, On as a, Qn as o, Vr as s, an as c, cr as l, f as u, in as d, m as f, ni as p, nr as m, o as h, on as g, or as _, p as v, pr as y } from "./index-client-BIJQxc2l.js";
import "./disclose-version-YhYaTdgb.js";
import { C as b, D as x, E as S, b as C, d as w, h as T, j as E, x as D } from "./animations-complete-mSylzqL5.js";
import { a as O, i as k, n as A, r as j, t as M } from "./scroll-lock-io5BKwUu.js";
import { a as N, i as ee, s as te, t as ne } from "./use-id-D_eLoXvH.js";
import { s as re } from "./presence-manager.svelte-DXU099Vb.js";
...
function Bt(e) {
	let n = e.whileElementsMounted, r = y(() => $(e.open) ?? !0), i = y(() => $(e.middleware)), o = y(() => $(e.transform) ?? !0), s = y(() => $(e.placement) ?? "bottom"), c = y(() => $(e.strategy) ?? "absolute"), u = y(() => $(e.sideOffset) ?? 0), d = y(() => $(e.alignOffset) ?? 0), f = e.reference, p = l(0), h = l(0), g = E(null), v = l(m(a(c))), b = l(m(a(s))), x = l(m({})), S = l(!1), C = !1, w = 0, T = y(() => {
		let e = g.current ? Rt(g.current, a(p)) : a(p), t = g.current ? Rt(g.current, a(h)) : a(h);
		return a(o) ? {
			position: a(v),
			left: "0",
			top: "0",
			transform: `translate(${e}px, ${t}px)`,
			...g.current && Lt(g.current) >= 1.5 && { willChange: "transform" }
		} : {
			position: a(v),
			left: `${e}px`,
			top: `${t}px`
	...
	function O() {
		...
		It(e, t, {
			...
			if (n === w && !(f.current !== e || g.current !== t)) {
				...
				if (!a(r) && a(p) !== 0 && a(h) !== 0) {
					let e = Math.max(Math.abs(a(u)), Math.abs(a(d)), 15);
					if (i.x <= e && i.y <= e) return;
				}
				_(p, i.x, !0), _(h, i.y, !0), _(v, i.strategy, !0), _(b, i.placement, !0), _(x, i.middlewareData, !0), _(S, !0);
			}
		});
	}
	function k() {
	...
	function A() {
		...
		a(r) && (f.current === null || g.current === null || (D = n(f.current, g.current, O)));
	}
	function j() {
		!a(r) && g.current === null && _(S, !1);
	}
	function M() {
		return [
			a(i),
...
var Ht = {
	...
	#r = y(() => this.#n?.width ?? 0);
	#i = y(() => this.#n?.height ?? 0);
	#a = y(() => this.opts.side?.current + (this.opts.align.current === "center" ? "" : `-${this.opts.align.current}`));
	#o = y(() => Array.isArray(this.opts.collisionBoundary.current) ? this.opts.collisionBoundary.current : [this.opts.collisionBoundary.current]);
	#s = y(() => a(this.#o).length > 0);
	...
	#p = y(() => [
		...
		Mt({
			...
			apply: ({ rects: e, availableWidth: t, availableHeight: n }) => {
				...
				_(this.#l, t, !0), _(this.#u, n, !0), _(this.#d, r, !0), _(this.#f, i, !0);
			}
		}),
	...
	floating;
	#m = y(() => Zt(this.floating.placement));
	get placedSide() {
		return a(this.#m);
	}
	set placedSide(e) {
	...
	#h = y(() => Qt(this.floating.placement));
	get placedAlign() {
		return a(this.#h);
	}
	set placedAlign(e) {
	...
	#g = y(() => this.floating.middlewareData.arrow?.x ?? 0);
	get arrowX() {
		return a(this.#g);
	}
	set arrowX(e) {
	...
	#_ = y(() => this.floating.middlewareData.arrow?.y ?? 0);
	get arrowY() {
		return a(this.#_);
	}
	set arrowY(e) {
	...
	#v = y(() => this.floating.middlewareData.arrow?.centerOffset !== 0);
...
function $t(e, t) {
	r(t, !0);
	let n = u(t, "tooltip", 3, !1);
	Kt.create(n());
	var a = c();
	i(o(a), () => t.children ?? p), d(e, a), s();
}
//#endregion
...
function en(e, t) {
	r(t, !0);
	let n = u(t, "side", 3, "bottom"), l = u(t, "sideOffset", 3, 0), f = u(t, "align", 3, "center"), m = u(t, "alignOffset", 3, 0), h = u(t, "arrowPadding", 3, 0), g = u(t, "avoidCollisions", 3, !0), _ = u(t, "collisionBoundary", 19, () => []), v = u(t, "collisionPadding", 3, 0), b = u(t, "hideWhenDetached", 3, !1), S = u(t, "onPlaced", 3, () => {}), C = u(t, "sticky", 3, "partial"), w = u(t, "updatePositionStrategy", 3, "optimized"), T = u(t, "strategy", 3, "fixed"), E = u(t, "dir", 3, "ltr"), D = u(t, "style", 19, () => ({})), O = u(t, "wrapperId", 19, ne), k = u(t, "customAnchor", 3, null), A = u(t, "tooltip", 3, !1), j = qt.create({
		side: x(() => n()),
		sideOffset: x(() => l()),
		align: x(() => f()),
		alignOffset: x(() => m()),
		...
		wrapperId: x(() => O()),
		customAnchor: x(() => k())
	}, A()), M = y(() => ee(j.wrapperProps, { style: { pointerEvents: "auto" } }));
	var N = c();
	i(o(N), () => t.content ?? p, () => ({
		props: j.props,
		wrapperProps: a(M)
...
function rn(e, t) {
	let r = u(t, "isStatic", 3, !1), i = v(t, nn);
	var a = c(), s = o(a), l = (e) => {
		tn(e, {
			get content() {
				return t.content;
...
function sn(t, l) {
	r(l, !0);
	let f = u(l, "interactOutsideBehavior", 3, "close"), m = u(l, "trapFocus", 3, !0), h = u(l, "isValidEvent", 3, () => !1), g = u(l, "customAnchor", 3, null), _ = u(l, "isStatic", 3, !1), b = u(l, "tooltip", 3, !1), x = u(l, "contentPointerEvents", 3, "auto"), S = v(l, an), C = y(() => l.preventScroll ?? !0), w = y(() => l.strategy ?? (a(C) ? "fixed" : "absolute"));
	rn(t, {
		get isStatic() {
			return _();
		},
		...
		get alignOffset() {
			return l.alignOffset;
		},
		get arrowPadding() {
			return l.arrowPadding;
		},
		get avoidCollisions() {
			return l.avoidCollisions;
		},
		get collisionBoundary() {
			return l.collisionBoundary;
		},
		get collisionPadding() {
			return l.collisionPadding;
		},
		get sticky() {
			return l.sticky;
		},
		get hideWhenDetached() {
			return l.hideWhenDetached;
		},
		get updatePositionStrategy() {
			return l.updatePositionStrategy;
		},
		get strategy() {
			return a(w);
		},
		...
		content: (t, r) => {
			let s = () => r?.().props, u = () => r?.().wrapperProps;
			var g = on(), _ = o(g), v = (e) => {
			...
			n(_, (e) => {
				l.forceMount && l.enabled ? e(v) : l.forceMount || e(b, 1);
			}), j(e(_, 2), {
				get onOpenAutoFocus() {
					return l.onOpenAutoFocus;
				},
				get onCloseAutoFocus() {
					return l.onCloseAutoFocus;
				},
				get loop() {
					return l.loop;
				},
				...
				focusScope: (e, t) => {
					...
					k(e, {
						get onEscapeKeydown() {
							return l.onEscapeKeydown;
						},
						get escapeKeydownBehavior() {
							return l.escapeKeydownBehavior;
						},
						get enabled() {
							return l.enabled;
						},
						...
						children: (e, t) => {
							O(e, {
								...
								get onInteractOutside() {
									return l.onInteractOutside;
								},
								get onFocusOutside() {
									return l.onFocusOutside;
								},
								...
								children: (e, t) => {
									...
									A(e, {
										...
										get preventOverflowTextSelection() {
											return l.preventOverflowTextSelection;
										},
										get onPointerDown() {
											return l.onPointerDown;
										},
										get onPointerUp() {
											return l.onPointerUp;
										},
										get enabled() {
											return l.enabled;
										},
										...
										children: (e, t) => {
											...
											{
												let e = y(() => ({
													props: ee(S, s(), r(), n(), { style: { pointerEvents: x() } }),
													wrapperProps: u()
												}));
												i(m, () => l.popper ?? p, () => a(e));
											}
...
function ln(e, t) {
	let r = u(t, "interactOutsideBehavior", 3, "close"), i = u(t, "trapFocus", 3, !0), a = u(t, "isValidEvent", 3, () => !1), s = u(t, "customAnchor", 3, null), l = u(t, "isStatic", 3, !1), p = v(t, cn);
	var m = c(), h = o(m), g = (e) => {
		sn(e, f({
			get popper() {
				return t.popper;
...
function dn(e, t) {
	let n = u(t, "interactOutsideBehavior", 3, "close"), r = u(t, "trapFocus", 3, !0), i = u(t, "isValidEvent", 3, () => !1), a = u(t, "customAnchor", 3, null), o = u(t, "isStatic", 3, !1), s = v(t, un);
	sn(e, f({
		get popper() {
			return t.popper;
		},
