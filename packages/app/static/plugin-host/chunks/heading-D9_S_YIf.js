import { $n as e, Et as t, Gt as n, Hr as r, Mt as i, Qn as a, Qr as o, Vr as s, Wn as c, Zn as l, an as u, in as d, it as f, ni as p, nn as m, on as h, p as g } from "./index-client-BIJQxc2l.js";
...
function x(h, x) {
	...
	t(a(C), () => `h${x.level}`, !1, (t, r) => {
		...
		var s = b(), u = a(s);
		i(u, () => x.children ?? p, () => ({ level: x.level }));
		var h = e(u, 2), g = (e) => {
			var t = y(), n = l(t, !0);
			o(t), c(() => m(n, x.subTitle)), d(e, t);
		};
		n(h, (e) => {
			x.subTitle && e(g);
		}), d(r, s);
