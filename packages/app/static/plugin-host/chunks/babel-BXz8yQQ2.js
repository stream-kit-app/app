...
t(r, {
	...
	__js_expression: () => gi,
	__ts_expression: () => _i,
	__vue_event_binding: () => mi,
	__vue_expression: () => gi,
	__vue_ts_event_binding: () => hi,
	__vue_ts_expression: () => _i,
	babel: () => mi,
	"babel-flow": () => vi,
	"babel-ts": () => hi
});
...
var a = class {
	...
	index;
	constructor(e, t, n) {
		this.line = e, this.column = t, this.index = n;
	}
}, o = class {
	start;
	end;
...
function s(e, t) {
	...
	return new a(n, r + t, i + t);
}
var c = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", l = {
...
}, d = (e) => e.type === "UpdateExpression" ? u.UpdateExpression[`${e.prefix}`] : u[e.type], f = {
...
- Did you mean \`import { "${e}" as foo }\`?`,
	...
	InvalidLhs: ({ ancestor: e }) => `Invalid left-hand side in ${d(e)}.`,
	InvalidLhsBinding: ({ ancestor: e }) => `Binding invalid left-hand side in ${d(e)}.`,
	InvalidLhsOptionalChaining: ({ ancestor: e }) => `Invalid optional chaining in the left-hand side of ${d(e)}.`,
	...
	PipeUnparenthesizedBody: ({ type: e }) => `Hack-style pipe body cannot be an unparenthesized ${d({ type: e })}; please wrap it in parentheses.`
}, {}), ne = ["message"];
function re(e, t, n) {
...
function ie({ toMessage: e, code: t, reasonCode: n, syntaxPlugin: r }) {
	let i = n === "MissingPlugin" || n === "MissingOneOfPlugins";
	return function o(s, c) {
		let l = /* @__PURE__ */ SyntaxError();
		return l.code = t, l.reasonCode = n, l.loc = s, l.pos = s.index, l.syntaxPlugin = r, i && (l.missingPlugin = c.missingPlugin), re(l, "clone", function(e = {}) {
			let { line: t, column: n, index: r } = e.loc ?? s;
			return o(new a(t, n, r), Object.assign({}, c, e.details));
		}), re(l, "details", c), Object.defineProperty(l, "message", {
			configurable: !0,
			get() {
...
var g = Object.assign({}, h(l), h(f), h(p), h(m), h`pipelineOperator`(te));
function ae() {
	return {
		sourceType: "script",
...
var { defineProperty: se } = Object, ce = (e, t) => {
	e && se(e, t, {
		enumerable: !1,
		value: e[t]
	});
...
function _(e) {
	return ce(e.loc.start, "index"), ce(e.loc.end, "index"), e;
}
var le = (e) => class extends e {
	parse() {
		let e = _(super.parse());
		return this.optionFlags & 256 && (e.tokens = e.tokens.map(_)), e;
	}
	...
	j_oTag: new ue("<tag"),
	j_cTag: new ue("</tag"),
	j_expr: new ue("<tag>...</tag>", !0)
}, y = !0, b = !0, de = !0, x = !0, S = !0, fe = !0, pe = class {
	label;
	keyword;
	beforeExpr;
	startsExpr;
...
var T = -1, he = [], ge = [], _e = [], ve = [], ye = [], be = [];
function E(e, t = {}) {
	return ++T, ge.push(e), _e.push(t.binop ?? -1), ve.push(t.beforeExpr ?? !1), ye.push(t.startsExpr ?? !1), be.push(t.prefix ?? !1), he.push(new pe(e, t)), T;
}
function D(e, t = {}) {
	return ++T, me.set(e, T), ge.push(e), _e.push(t.binop ?? -1), ve.push(t.beforeExpr ?? !1), ye.push(t.startsExpr ?? !1), be.push(t.prefix ?? !1), he.push(new pe("name", t)), T;
}
var xe = {
	bracketL: E("[", {
		beforeExpr: y,
	...
	parenR: E(")"),
	comma: E(",", { beforeExpr: y }),
	semi: E(";", { beforeExpr: y }),
	colon: E(":", { beforeExpr: y }),
	doubleColon: E("::", { beforeExpr: y }),
	dot: E("."),
	question: E("?", { beforeExpr: y }),
	questionDot: E("?."),
	arrow: E("=>", { beforeExpr: y }),
	template: E("template"),
	ellipsis: E("...", { beforeExpr: y }),
	backQuote: E("`", { startsExpr: b }),
	dollarBraceL: E("${", {
		beforeExpr: y,
		startsExpr: b
	}),
	templateTail: E("...`", { startsExpr: b }),
	templateNonTail: E("...${", {
		beforeExpr: y,
		startsExpr: b
	}),
	...
	doubleCaret: E("^^", { startsExpr: b }),
	doubleAt: E("@@", { startsExpr: b }),
	pipeline: w("|>", 0),
	nullishCoalescing: w("??", 1),
	logicalOR: w("||", 1),
	logicalAND: w("&&", 2),
	bitwiseOR: w("|", 3),
	bitwiseXOR: w("^", 4),
	...
	_break: C("break"),
	_case: C("case", { beforeExpr: y }),
	_catch: C("catch"),
	_continue: C("continue"),
	_debugger: C("debugger"),
	_default: C("default", { beforeExpr: y }),
	_else: C("else", { beforeExpr: y }),
	_finally: C("finally"),
	_function: C("function", { startsExpr: b }),
	_if: C("if"),
	_return: C("return", { beforeExpr: y }),
	_switch: C("switch"),
	_throw: C("throw", {
		beforeExpr: y,
		prefix: S,
	...
	_this: C("this", { startsExpr: b }),
	_super: C("super", { startsExpr: b }),
	_class: C("class", { startsExpr: b }),
	_extends: C("extends", { beforeExpr: y }),
	_export: C("export"),
	_import: C("import", { startsExpr: b }),
	_null: C("null", { startsExpr: b }),
	_true: C("true", { startsExpr: b }),
	_false: C("false", { startsExpr: b }),
	_typeof: C("typeof", {
		beforeExpr: y,
		prefix: S,
		startsExpr: b
	...
	_for: C("for", { isLoop: de }),
	_while: C("while", { isLoop: de }),
	_as: D("as", { startsExpr: b }),
	_assert: D("assert", { startsExpr: b }),
	_async: D("async", { startsExpr: b }),
	_await: D("await", { startsExpr: b }),
	_defer: D("defer", { startsExpr: b }),
	_from: D("from", { startsExpr: b }),
	_get: D("get", { startsExpr: b }),
	_let: D("let", { startsExpr: b }),
	_meta: D("meta", { startsExpr: b }),
	_of: D("of", { startsExpr: b }),
	_sent: D("sent", { startsExpr: b }),
	_set: D("set", { startsExpr: b }),
	_source: D("source", { startsExpr: b }),
	_static: D("static", { startsExpr: b }),
	_using: D("using", { startsExpr: b }),
	_yield: D("yield", { startsExpr: b }),
	_asserts: D("asserts", { startsExpr: b }),
	_checks: D("checks", { startsExpr: b }),
	_exports: D("exports", { startsExpr: b }),
	_global: D("global", { startsExpr: b }),
	_implements: D("implements", { startsExpr: b }),
	_intrinsic: D("intrinsic", { startsExpr: b }),
	_infer: D("infer", { startsExpr: b }),
	_is: D("is", { startsExpr: b }),
	_mixins: D("mixins", { startsExpr: b }),
	_proto: D("proto", { startsExpr: b }),
	_require: D("require", { startsExpr: b }),
	_satisfies: D("satisfies", { startsExpr: b }),
	_keyof: D("keyof", { startsExpr: b }),
	_readonly: D("readonly", { startsExpr: b }),
	_unique: D("unique", { startsExpr: b }),
	_abstract: D("abstract", { startsExpr: b }),
	_declare: D("declare", { startsExpr: b }),
	_enum: D("enum", { startsExpr: b }),
	_module: D("module", { startsExpr: b }),
	_namespace: D("namespace", { startsExpr: b }),
	_interface: D("interface", { startsExpr: b }),
	_type: D("type", { startsExpr: b }),
	_opaque: D("opaque", { startsExpr: b }),
	name: E("name", { startsExpr: b }),
	placeholder: E("%%", { startsExpr: b }),
	string: E("string", { startsExpr: b }),
	num: E("num", { startsExpr: b }),
	bigint: E("bigint", { startsExpr: b }),
	decimal: E("decimal", { startsExpr: b }),
	regexp: E("regexp", { startsExpr: b }),
	privateName: E("#name", { startsExpr: b }),
	eof: E("eof"),
	jsxName: E("jsxName"),
	jsxText: E("jsxText", { beforeExpr: y }),
	jsxTagStart: E("jsxTagStart", { startsExpr: b }),
...
var Re = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-࢏ࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚ౜ౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽ೜-ೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲊᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-Ƛ꟱-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ", ze = "·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࢗ-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-᫝᫠-᫫ᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‌‍‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯・꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿･", Be = RegExp("[" + Re + "]"), Ve = RegExp("[" + Re + ze + "]");
Re = ze = null;
var He = [
	0,
	11,
...
function M(e) {
	return e < 65 ? e === 36 : e <= 90 ? !0 : e < 97 ? e === 95 : e <= 122 ? !0 : e <= 65535 ? e >= 170 && Be.test(String.fromCharCode(e)) : We(e, He);
}
function N(e) {
	return e < 48 ? e === 36 : e < 58 ? !0 : e < 65 ? !1 : e <= 90 ? !0 : e < 97 ? e === 95 : e <= 122 ? !0 : e <= 65535 ? e >= 170 && Ve.test(String.fromCharCode(e)) : We(e, He) || We(e, Ue);
}
var Ge = {
...
}, Ke = new Set(Ge.keyword), qe = new Set(Ge.strict), Je = new Set(Ge.strictBind);
function Ye(e, t) {
	return t && e === "await" || e === "enum";
}
function Xe(e, t) {
	return Ye(e, t) || qe.has(e);
}
function Ze(e) {
	return Je.has(e);
}
...
var tt = new Set(/* @__PURE__ */ "break.case.catch.continue.debugger.default.do.else.finally.for.function.if.return.switch.throw.try.var.const.while.with.new.this.super.class.extends.export.import.null.true.false.in.instanceof.typeof.void.delete.implements.interface.let.package.private.protected.public.static.yield.eval.arguments.enum.await".split("."));
function nt(e) {
	return tt.has(e);
}
var rt = class {
...
var ft = /\*?\s*@((?:no)?flow)\b/, pt = (e) => class extends e {
	flowPragma = void 0;
	getScopeHandler() {
		return ot;
	}
	...
	flowParsePredicate() {
		...
		return this.next(), this.expectContextual(110), this.state.lastTokStartLoc.index > t.index + 1 && this.raise(P.UnexpectedSpaceBetweenModuloChecks, t), this.eat(10) ? (e.value = super.parseExpression(), this.expect(11), this.finishNode(e, "DeclaredPredicate")) : this.finishNode(e, "InferredPredicate");
	}
	...
	flowParseDeclare(e, t) {
		...
		if (this.eatContextual(127)) return this.match(16) ? this.flowParseDeclareModuleExports(e) : (t && this.raise(P.NestedDeclareModule, this.state.lastTokStartLoc), this.flowParseDeclareModule(e));
	...
	flowParseDeclareModule(e) {
		...
		for (this.expect(5); !this.match(8);) {
			...
			this.match(83) ? (this.next(), !this.isContextual(130) && !this.match(87) && this.raise(P.InvalidNonTypeImportInDeclareModule, this.state.lastTokStartLoc), n.push(super.parseImport(e))) : (this.expectContextual(125, P.UnsupportedStatementInDeclareModule), n.push(this.flowParseDeclare(e, !0)));
		}
		this.scope.exit(), this.expect(8), this.finishNode(t, "BlockStatement");
		let r = null, i = !1;
		return n.forEach((e) => {
			ct(e) ? (r === "CommonJS" && this.raise(P.AmbiguousDeclareModuleKind, e), r = "ES") : e.type === "DeclareModuleExports" && (i && this.raise(P.DuplicateDeclareModuleExports, e), r === "ES" && this.raise(P.AmbiguousDeclareModuleKind, e), r = "CommonJS", i = !0);
	...
	checkReservedType(e, t, n) {
		st.has(e) && this.raise(n ? P.AssignReservedType : P.UnexpectedReservedType, t, { reservedType: e });
	}
	...
	flowParseTypeParameter(e = !1) {
		...
		return n.name = i.name, n.variance = r, n.bound = i.typeAnnotation, this.match(29) ? (this.eat(29), n.default = this.flowParseType()) : e && this.raise(P.MissingTypeParamDefault, t), this.finishNode(n, "TypeParameter");
	}
	...
	flowParseTypeParameterInstantiation() {
		...
		}), this.state.inType = t, !this.state.inType && this.curContext() === v.brace && this.reScan_lt_gt(), this.expect(48), this.finishNode(e, "TypeParameterInstantiation");
	}
	...
	flowParseObjectType({ allowStatic: e, allowExact: t, allowSpread: n, allowProto: r, allowInexact: i }) {
		...
		for (t && this.match(6) ? (this.expect(6), s = 9, c = !0) : (this.expect(5), s = 8, c = !1), o.exact = c; !this.match(s);) {
			...
			if (this.eat(0)) a != null && this.unexpected(a), this.eat(0) ? (d && this.unexpected(d.loc.start), o.internalSlots.push(this.flowParseObjectTypeInternalSlot(u, t))) : o.indexers.push(this.flowParseObjectTypeIndexer(u, t, d));
				...
				let e = "init";
				(this.isContextual(99) || this.isContextual(104)) && Ce(this.lookahead().type) && (e = this.state.value, this.next());
				let r = this.flowParseObjectTypeProperty(u, t, a, d, e, n, i ?? !c);
				r === null ? (l = !0, s = this.state.lastTokStartLoc) : o.properties.push(r);
			}
			this.flowObjectTypeSemicolon(), s && !this.match(8) && !this.match(9) && this.raise(P.UnexpectedExplicitInexactInObject, s);
		}
	...
	flowParseObjectTypeProperty(e, t, n, r, i, a, o) {
		if (this.eat(21)) return this.match(12) || this.match(13) || this.match(8) || this.match(9) ? (a ? o || this.raise(P.InexactInsideExact, this.state.lastTokStartLoc) : this.raise(P.InexactInsideNonObject, this.state.lastTokStartLoc), r && this.raise(P.InexactVariance, r), null) : (a || this.raise(P.UnexpectedSpreadType, this.state.lastTokStartLoc), n != null && this.unexpected(n), r && this.raise(P.SpreadVariance, r), e.argument = this.flowParseType(), this.finishNode(e, "ObjectTypeSpreadProperty"));
		{
			e.key = this.flowParseObjectPropertyKey(), e.static = t, e.proto = n != null, e.kind = i;
			let o = !1;
			return this.match(47) || this.match(10) ? (e.method = !0, n != null && this.unexpected(n), r && this.unexpected(r.loc.start), e.value = this.flowParseObjectTypeMethodish(this.startNodeAt(e.loc.start)), (i === "get" || i === "set") && this.flowCheckGetterSetterParams(e), !a && e.key.name === "constructor" && e.value.this && this.raise(P.ThisParamBannedInConstructor, e.value.this)) : (i !== "init" && this.unexpected(), e.method = !1, this.eat(17) && (o = !0), e.value = this.flowParseTypeInitialiser(), e.variance = r), e.optional = o, this.finishNode(e, "ObjectTypeProperty");
		}
	}
	...
	flowParseFunctionTypeParam(e) {
		...
		return a.type === 14 || a.type === 17 ? (o && !e && this.raise(P.ThisParamMustBeFirst, i), t = this.parseIdentifier(o), this.eat(17) && (n = !0, o && this.raise(P.ThisParamMayNotBeOptional, i)), r = this.flowParseTypeInitialiser()) : r = this.flowParseType(), i.name = t, i.optional = n, i.typeAnnotation = r, this.finishNode(i, "FunctionTypeParam");
	}
	...
	flowParsePrimaryType() {
		...
		switch (this.state.type) {
			...
			case 10: {
				let e = this.startNode();
				if (this.next(), !this.match(11) && !this.match(21)) if (O(this.state.type) || this.match(78)) {
			...
			} else if (O(this.state.type)) return this.isContextual(129) ? this.flowParseInterfaceType() : this.flowIdentToTypeAnnotation(e, t, this.parseIdentifier());
		}
		throw this.unexpected();
	}
	flowParsePostfixType() {
		...
		for (; (this.match(0) || this.match(18)) && !this.canInsertSemicolon();) {
			...
			n ||= i, this.expect(0), !i && this.match(3) ? (r.elementType = t, this.next(), t = this.finishNode(r, "ArrayTypeAnnotation")) : (r.objectType = t, r.indexType = this.flowParseType(), this.expect(3), n ? (r.optional = i, t = this.finishNode(r, "OptionalIndexedAccessType")) : t = this.finishNode(r, "IndexedAccessType"));
		}
		return t;
	}
	flowParsePrefixType() {
	...
	parseExpressionStatement(e, t, n) {
		if (t.type === "Identifier") {
			if (t.name === "declare") {
				if (this.match(80) || O(this.state.type) || this.match(68) || this.match(74) || this.match(82)) return this.flowParseDeclare(e);
	...
	shouldParseExportDeclaration() {
		...
		return e === 126 || Ee(e) ? !this.state.containsEsc : super.shouldParseExportDeclaration();
	}
	isExportDefaultSpecifier() {
		let { type: e } = this.state;
		return e === 126 || Ee(e) ? this.state.containsEsc : super.isExportDefaultSpecifier();
	}
	...
	parseConditional(e, t, n) {
		...
		if (s || l.length > 0) {
			...
			s && c.length > 1 && this.raise(P.AmbiguousConditionalArrow, r.startLoc), s && c.length === 1 && (this.state = r, e.push(c[0].start), this.state.noArrowAt = e, {consequent: o, failed: s} = this.tryParseConditionalConsequent());
		}
	...
	getArrowLikeExpressions(e, t) {
		...
		return t ? (r.forEach((e) => this.finishArrowValidation(e)), [r, []]) : dt(r, (e) => e.params.every((e) => this.isAssignable(e, !0)));
	}
	...
	getTokenFromCode(e) {
		...
		e === 123 && t === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? t === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : et(e, t, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
	}
	isAssignable(e, t) {
	...
	toReferencedList(e, t) {
		for (let n = 0; n < e.length; n++) {
			let r = e[n];
			r && r.type === "TypeCastExpression" && !r.extra?.parenthesized && (e.length > 1 || !t) && this.raise(P.TypeCastInPattern, r.typeAnnotation);
		}
		return e;
	}
	parseArrayLike(e, t, n) {
		let r = super.parseArrayLike(e, t, n);
		return n != null && !this.state.maybeInArrowParameters && this.toReferencedList(r.elements), r;
	}
	isValidLVal(e, t, n, r) {
	...
	parseFunctionParamType(e) {
		return this.eat(17) && (e.type !== "Identifier" && this.raise(P.PatternIsOptional, e), this.isThisParam(e) && this.raise(P.ThisParamMayNotBeOptional, e), e.optional = !0), this.match(14) ? e.typeAnnotation = this.flowParseTypeAnnotation() : this.isThisParam(e) && this.raise(P.ThisParamAnnotationRequired, e), this.match(29) && this.isThisParam(e) && this.raise(P.ThisParamNoDefault, e), this.resetEndLocation(e), e;
	}
	...
	checkImportReflection(e) {
		super.checkImportReflection(e), e.module && e.importKind !== "value" && this.raise(P.ImportReflectionHasImportType, e.specifiers[0].loc.start);
	}
	parseImportSpecifierLocal(e, t, n) {
		t.local = lt(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(t, n));
	}
	...
	parseImportSpecifier(e, t, n, r, i) {
		...
		if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
			...
			o !== null && !k(this.state.type) ? (e.imported = t, e.importKind = o, e.local = this.cloneIdentifier(t)) : (e.imported = a, e.importKind = null, e.local = this.parseIdentifier());
		} else {
			if (o !== null && k(this.state.type)) e.imported = this.parseIdentifier(!0), e.importKind = o;
			else {
		...
		let c = lt(e);
		return n && c && this.raise(P.ImportTypeShorthandOnlyInPureImport, e), (n || c) && this.checkReservedType(e.local.name, e.local.loc.start, !0), s && !n && !c && this.checkReservedWord(e.local.name, e.loc.start, !0, !0), this.finishImportSpecifier(e, "ImportSpecifier");
	}
	parseBindingAtom() {
		switch (this.state.type) {
	...
	flowEnumErrorBooleanMemberNotInitialized(e, { enumName: t, memberName: n }) {
		this.raise(P.EnumBooleanMemberNotInitialized, e, {
			memberName: n,
			enumName: t
		});
	}
	...
	flowEnumParseExplicitType({ enumName: e }) {
		...
		if (!O(this.state.type)) throw this.raise(P.EnumInvalidExplicitTypeUnknownSupplied, this.state.startLoc, { enumName: e });
...
var yt = (e) => class extends e {
	...
	jsxParseIdentifier() {
		let e = this.startNode();
		return this.match(141) ? e.name = this.state.value : Oe(this.state.type) ? e.name = j(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
	}
	...
	jsxParseAttributeValue() {
		let e;
		switch (this.state.type) {
			case 5: return e = this.startNode(), this.setContext(v.brace), this.next(), e = this.jsxParseExpressionContainer(e, v.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(I.AttributeIsEmpty, e), e;
			case 143:
	...
	jsxParseElementAt(e) {
		...
		if (!r.selfClosing) {
			e: for (;;) switch (this.state.type) {
				...
				case 5: {
					let e = this.startNode();
					this.setContext(v.brace), this.next(), this.match(21) ? n.push(this.jsxParseSpreadChild(e)) : n.push(this.jsxParseExpressionContainer(e, v.j_expr));
					break;
				}
		...
		if (L(r) ? (t.openingFragment = r, t.closingFragment = i) : (t.openingElement = r, t.closingElement = i), t.children = n, this.match(47)) throw this.raise(I.UnwrappedAdjacentJSXElements, this.state.startLoc);
	...
	updateContext(e) {
		...
		if (n === 56 && e === 143) t.splice(-2, 2, v.j_cTag), this.state.canStartJSXElement = !1;
		else if (n === 143) t.push(v.j_oTag);
		else if (n === 144) {
			let n = t[t.length - 1];
			n === v.j_oTag && e === 56 || n === v.j_cTag ? (t.pop(), this.state.canStartJSXElement = t[t.length - 1] === v.j_expr) : (this.setContext(v.j_expr), this.state.canStartJSXElement = !0);
	...
	importsStack = [];
	createScope(e) {
		return this.importsStack.push(/* @__PURE__ */ new Set()), new bt(e);
	}
	enter(e) {
		e === 1024 && this.importsStack.push(/* @__PURE__ */ new Set()), super.enter(e);
	}
	exit() {
		let e = super.exit();
		return e === 1024 && this.importsStack.pop(), e;
	}
	hasImport(e, t) {
...
function B(e, t, n) {
	...
	r === null || r.start > n.start ? z(e, n.comments) : Tt(r, n.comments);
}
var Dt = class extends wt {
	addComment(e) {
	...
	finalizeComment(e) {
		let { comments: t } = e;
		if (e.leadingNode !== null || e.trailingNode !== null) e.leadingNode !== null && Tt(e.leadingNode, t), e.trailingNode !== null && Et(e.trailingNode, t);
		else {
	...
	init({ strictMode: e, sourceType: t, startIndex: n, startLine: r, startColumn: i }) {
		this.strict = e === !1 ? !1 : e === !0 ? !0 : t === "module", this.startIndex = n, this.curLine = r, this.lineStart = -i, this.startLoc = this.endLoc = new a(r, i, n);
	}
	errors = [];
	potentialArrowAt = -1;
	noArrowAt = [];
	...
	tokensLength = 0;
	curPosition() {
		return new a(this.curLine, this.pos - this.lineStart, this.pos + this.startIndex);
	}
	clone() {
		let t = new e();
...
var Rt = new Set([
	...
	constructor(e) {
		...
		this.type = e.type, this.value = e.value, this.start = t + e.start, this.end = t + e.end, this.loc = new o(e.startLoc, e.endLoc);
	}
}, Bt = class extends Dt {
	isLookahead;
	tokens = [];
	constructor(e, t) {
		super(), this.state = new Ot(), this.state.init(e), this.input = t, this.length = t.length, this.comments = [], this.isLookahead = !1;
	}
	pushToken(e) {
		this.tokens.length = this.state.tokensLength, this.tokens.push(e), ++this.state.tokensLength;
	}
	next() {
		this.checkKeywordEscapes(), this.optionFlags & 256 && this.pushToken(new zt(this.state)), this.state.lastTokEndLoc = this.state.endLoc, this.state.lastTokStartLoc = this.state.startLoc, this.nextToken();
	}
	eat(e) {
	...
	nextTokenStartSince(e) {
		return gt.lastIndex = e, gt.test(this.input) ? gt.lastIndex : e;
	}
	lookaheadCharCode() {
	...
	skipBlockComment(e) {
		...
		for (this.state.pos = r + e.length, mt.lastIndex = n + 2; mt.test(this.input) && mt.lastIndex <= r;) ++this.state.curLine, this.state.lineStart = mt.lastIndex;
		...
		let i = {
			...
			loc: new o(t, this.state.curPosition())
		};
	...
	skipLineComment(e) {
		...
		let i = this.state.pos, a = {
			...
			loc: new o(n, this.state.curPosition())
		};
		...
		e: for (; this.state.pos < this.length;) {
			...
			switch (n) {
				...
				case 47:
					...
					break;
				default: if (vt(n)) ++this.state.pos;
	...
	readToken_numberSign() {
		...
		M(t) ? (++this.state.pos, this.finishToken(139, this.readWord1(t))) : t === 92 ? (++this.state.pos, this.finishToken(139, this.readWord1())) : this.finishOp(27, 1);
	}
	readToken_dot() {
	...
	readRegexp() {
		...
		for (;; ++i) {
			if (i >= this.length) throw this.raise(g.UnterminatedRegExp, s(e, 1));
			let t = this.input.charCodeAt(i);
			if (F(t)) throw this.raise(g.UnterminatedRegExp, s(e, 1));
			if (n) n = !1;
			else {
				if (t === 91) r = !0;
				else if (t === 93 && r) r = !1;
		...
		for (; i < this.length;) {
			...
			if (Rt.has(e)) e === 118 ? o.includes("u") && this.raise(g.IncompatibleRegExpUVFlags, c()) : e === 117 && o.includes("v") && this.raise(g.IncompatibleRegExpUVFlags, c()), o.includes(t) && this.raise(g.DuplicateRegExpFlags, c());
			else if (N(e) || e === 92) this.raise(g.MalformedRegExpFlags, c());
			else break;
			++i, o += t;
		}
		this.state.pos = i, this.finishToken(138, {
			pattern: a,
			flags: o
		});
	}
	...
	readRadixNumber(e) {
		...
		i ?? this.raise(g.InvalidDigit, s(n, 2), { radix: e });
		let a = this.input.charCodeAt(this.state.pos);
		if (a === 110) ++this.state.pos, r = !0;
		else if (a === 109) throw this.raise(g.InvalidDecimal, n);
		if (M(this.codePointAtPos(this.state.pos))) throw this.raise(g.NumberIdentifier, this.state.curPosition());
		if (r) {
	...
	readNumber(e) {
		...
		if (o) {
			...
			if (this.recordStrictModeErrors(g.StrictOctalLiteral, n), !this.state.strict) {
				let t = e.indexOf("_");
				t > 0 && this.raise(g.ZeroDigitNumericSeparator, s(n, t));
			}
			a = o && !/[89]/.test(e);
		}
		let c = this.input.charCodeAt(this.state.pos);
		if (c === 46 && !a && (++this.state.pos, this.readInt(10), r = !0, c = this.input.charCodeAt(this.state.pos)), (c === 69 || c === 101) && !a && (c = this.input.charCodeAt(++this.state.pos), (c === 43 || c === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(g.InvalidOrMissingExponent, n), r = !0, c = this.input.charCodeAt(this.state.pos)), c === 110 && ((r || o) && this.raise(g.InvalidBigIntLiteral, n), ++this.state.pos, i = !0), M(this.codePointAtPos(this.state.pos))) throw this.raise(g.NumberIdentifier, this.state.curPosition());
		let l = this.input.slice(t, this.state.pos).replace(/[_mn]/g, "");
		if (i) {
			this.finishToken(136, l);
			return;
		}
		let u = a ? parseInt(l, 8) : parseFloat(l);
	...
	readTemplateToken() {
		let e = this.input[this.state.pos], { str: t, firstInvalidLoc: n, pos: r, curLine: i, lineStart: o } = Mt("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
		this.state.pos = r + 1, this.state.lineStart = o, this.state.curLine = i, n && (this.state.firstInvalidTemplateEscapePos = new a(n.curLine, n.pos - n.lineStart, this.sourceToOffsetPos(n.pos))), this.input.codePointAt(r) === 96 ? this.finishToken(24, n ? null : e + t + "`") : (this.state.pos++, this.finishToken(25, n ? null : e + t + "${"));
	}
	...
	readWord(e) {
		...
		n === void 0 ? this.finishToken(132, t) : this.finishToken(n, j(n));
	}
	checkKeywordEscapes() {
		let { type: e } = this.state;
		Oe(e) && this.state.containsEsc && this.raise(g.InvalidEscapedReservedWord, this.state.startLoc, { reservedWord: j(e) });
	}
	raise(e, t, n = {}) {
		let r = e(t instanceof a ? t : t.loc.start, n);
		if (!(this.optionFlags & 2048)) throw r;
		return this.isLookahead || this.state.errors.push(r), r;
	}
	raiseOverwrite(e, t, n = {}) {
		let r = t instanceof a ? t : t.loc.start, i = r.index, o = this.state.errors;
		for (let t = o.length - 1; t >= 0; t--) {
			let a = o[t];
			if (a.loc.index === i) return o[t] = e(r, n);
			if (a.loc.index < i) break;
		}
		return this.raise(e, t, n);
	}
	updateContext(e) {}
	unexpected(e, t) {
		throw this.raise(g.UnexpectedToken, e ?? this.state.startLoc, { expected: t ? j(t) : null });
	}
	expectPlugin(e, t) {
	...
	errorHandlers_readInt = {
		invalidDigit: (e, t, n, r) => this.optionFlags & 2048 ? (this.raise(g.InvalidDigit, V(e, t, n), { radix: r }), !0) : !1,
...
var Xt = class extends Bt {
	...
	hasPrecedingLineBreak() {
		return ht(this.input, this.offsetToSourcePos(this.state.lastTokEndLoc.index), this.state.start);
	}
	hasFollowingLineBreak() {
		return ht(this.input, this.state.end, this.nextTokenStart());
	}
	isLineTerminator() {
	...
	initializeScopes(e = this.options.sourceType === "module") {
		...
		this.prodParam = new St();
		let s = this.classScope;
		this.classScope = new Ht(this);
		let c = this.expressionScope;
		return this.expressionScope = new Gt(this), () => {
	...
	constructor(e, t, n) {
		this.start = t, this.end = 0, this.loc = new o(n), e?.optionFlags & 128 && (this.range = [t, 0]), e?.filename && (this.loc.filename = e.filename);
	}
	type = "";
}, $t = Qt.prototype, en = class extends Xt {
	startNode() {
		let e = this.state.startLoc;
		return new Qt(this, e.index, e);
	}
	startNodeAt(e) {
		return new Qt(this, e.index, e);
	}
	...
	toAssignable(e, t = !1) {
		...
		switch ((e.type === "ParenthesizedExpression" || e.extra?.parenthesized) && (n = tn(e), t ? n.type === "Identifier" ? this.expressionScope.recordArrowParameterBindingError(g.InvalidParenthesizedAssignment, e) : n.type !== "CallExpression" && n.type !== "MemberExpression" && !this.isOptionalMemberExpression(n) && this.raise(g.InvalidParenthesizedAssignment, e) : this.raise(g.InvalidParenthesizedAssignment, e)), e.type) {
			...
			case "AssignmentExpression":
				e.operator !== "=" && this.raise(g.MissingEqInAssignment, e.left.loc.end), this.castNodeTo(e, "AssignmentPattern"), delete e.operator, e.left.type === "VoidPattern" && this.raise(g.VoidPatternInitializer, e.left), this.toAssignable(e.left, t);
				break;
	...
	parseBindingList(e, t, n) {
		...
		for (; !this.eat(e);) if (a ? a = !1 : this.expect(12), r && this.match(12)) i.push(null);
			...
			if (this.match(21)) {
				...
				let e = [];
				if (n & 2) for (this.match(26) && this.hasPlugin("decorators") && this.raise(g.UnsupportedParameterDecorator, this.state.startLoc); this.match(26);) e.push(this.parseDecorator());
	...
	parseBindingRestProperty(e) {
		return this.next(), this.hasPlugin("discardBinding") && this.match(88) ? (e.argument = this.parseVoidPattern(null), this.raise(g.UnexpectedVoidPattern, e.argument)) : e.argument = this.parseIdentifier(), this.checkCommaAfterRest(125), this.finishNode(e, "RestElement");
	}
	...
	parseBindingElement(e, t) {
		...
		return e & 2 && this.parseFunctionParamType(n), t.length && (n.decorators = t, this.resetStartLocationFromNode(n, t[0])), this.parseMaybeDefault(n.loc.start, n);
	}
	parseFunctionParamType(e) {
		return e;
	}
	parseMaybeDefault(e, t) {
		if (e ??= this.state.startLoc, t ??= this.parseBindingAtom(), !this.eat(29)) return t;
		let n = this.startNodeAt(e);
	...
	isValidLVal(e, t, n, r) {
		switch (e) {
			...
			case "VoidPattern": return !0;
			case "CallExpression": if (!t && !this.state.strict && this.optionFlags & 8192) return !0;
		}
		return !1;
	}
	isOptionalMemberExpression(e) {
	...
	checkLVal(e, t, n = 64, r = !1, i = !1, a = !1, o = !1) {
		...
		if (c || s === "MemberExpression") {
			c && (this.expectPlugin("optionalChainingAssign", e.loc.start), t.type !== "AssignmentExpression" && this.raise(g.InvalidLhsOptionalChaining, e, { ancestor: t })), n !== 64 && this.raise(g.InvalidPropertyBindingPattern, e);
			return;
		}
		if (s === "Identifier") {
	...
	checkIdentifier(e, t, n = !1) {
		this.state.strict && (n ? Qe(e.name, this.inModule) : Ze(e.name)) && (t === 64 ? this.raise(g.StrictEvalArguments, e, { referenceName: e.name }) : this.raise(g.StrictEvalArgumentsBinding, e, { bindingName: e.name })), t & 8192 && e.name === "let" && this.raise(g.LetInLexicalBinding, e), t & 64 || this.declareNameFromIdentifier(e, t);
	}
	...
	checkCommaAfterRest(e) {
		return this.match(12) ? (this.raise(this.lookaheadCharCode() === e ? g.RestTrailingComma : g.ElementAfterRest, this.state.startLoc), !0) : !1;
	}
...
var dn = (e) => class extends e {
	...
	tsParseModifier(e, t, n) {
		if (!O(this.state.type) && this.state.type !== 58 && this.state.type !== 75) return;
	...
	tsParseModifiers({ allowedModifiers: e, disallowedModifiers: t, stopOnStartOfClassStaticBlock: n, errorTemplate: r = H.InvalidModifierOnTypeMember }, i) {
		...
		for (;;) {
			...
			if (!c) break;
			cn(c) ? i.accessibility ? this.raise(H.DuplicateAccessibilityModifier, s, { modifier: c }) : (a(s, c, c, "override"), a(s, c, c, "static"), a(s, c, c, "readonly"), i.accessibility = c) : ln(c) ? (i[c] && this.raise(H.DuplicateModifier, s, { modifier: c }), i[c] = !0, a(s, c, "in", "out")) : (Object.prototype.hasOwnProperty.call(i, c) ? this.raise(H.DuplicateModifier, s, { modifier: c }) : (a(s, c, "static", "readonly"), a(s, c, "static", "override"), a(s, c, "override", "readonly"), a(s, c, "abstract", "override"), o(s, c, "declare", "override"), o(s, c, "static", "abstract")), i[c] = !0), t?.includes(c) && this.raise(r, s, { modifier: c });
		}
	}
	...
	tsParseImportTypeWithPropertyValue() {
		...
		for (this.expect(5); !this.match(8);) {
			...
			O(e) || e === 134 ? t.push(super.parsePropertyDefinition(null)) : this.unexpected(), this.eat(12);
		}
	...
	tsFillSignature(e, t) {
		let n = e === 19;
		t.typeParameters = this.tsTryParseTypeParameters(this.tsParseConstModifier), this.expect(10), t.params = this.tsParseBindingListForSignature(), (n || this.match(e)) && (t.returnType = this.tsParseTypeOrTypePredicateAnnotation(e));
	}
	...
	tsIsUnambiguouslyIndexSignature() {
		return this.next(), O(this.state.type) ? (this.next(), this.match(14)) : !1;
	}
	...
	tsParsePropertyOrMethodSignature(e, t) {
		if (this.eat(17) && (e.optional = !0), this.match(10) || this.match(47)) {
			...
			let n = e;
			n.kind && this.match(47) && this.raise(H.AccessorCannotHaveTypeParameters, this.state.curPosition()), this.tsFillSignature(14, n), this.tsParseTypeMemberSemicolon();
			let r = "params", i = "returnType";
			if (n.kind === "get") n[r].length > 0 && (this.raise(g.BadGetterArity, this.state.curPosition()), this.isThisParam(n[r][0]) && this.raise(H.AccessorCannotDeclareThisParameter, this.state.curPosition()));
			else if (n.kind === "set") {
				if (n[r].length !== 1) this.raise(g.BadSetterArity, this.state.curPosition());
				else {
					let e = n[r][0];
				...
				n[i] && this.raise(H.SetAccessorCannotHaveReturnType, n[i]);
			} else n.kind = "method";
	...
	tsParseTupleElementType() {
		let e = this.state.startLoc, t = this.eat(21), { startLoc: n } = this.state, r, i, a, o, s = k(this.state.type) ? this.lookaheadCharCode() : null;
	...
	tsParseNonArrayType() {
		switch (this.state.type) {
			...
			default: {
				let { type: e } = this.state;
				if (O(e) || e === 88 || e === 84) {
					let t = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : sn(this.state.value);
	...
	tsParseTypeOperatorOrHigher() {
		return Me(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(115) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
	}
	...
	tsSkipParameterStart() {
		if (O(this.state.type) || this.match(78)) return this.next(), !0;
		if (this.match(5)) {
	...
	tsParseTypePredicateAsserts() {
		...
		return this.next(), !O(this.state.type) && !this.match(78) ? !1 : (e && this.raise(g.InvalidEscapedReservedWord, this.state.lastTokStartLoc, { reservedWord: "asserts" }), !0);
	}
		...
		let t = this.state.startLoc, n = this.tsParseDelimitedList("HeritageClauseElement", () => {
			{
				...
				un(t) || this.raise(H.InvalidHeritageClauseType, t.loc.start, { token: e });
				...
				return r.expression = t, (this.match(47) || this.match(51)) && (r.typeArguments = this.tsParseTypeArgumentsInExpression()), this.finishNode(r, n);
			}
		});
	...
	tsParseInterfaceDeclaration(e, t = {}) {
		...
		this.expectContextual(129), t.declare && (e.declare = !0), O(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, 130)) : (e.id = null, this.raise(H.MissingInterfaceName, this.state.startLoc)), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
		let n = this.startNode();
	...
	tsParseImportEqualsDeclaration(e, t, n) {
		...
		return e.importKind === "type" && r.type !== "TSExternalModuleReference" && this.raise(H.ImportAliasHasImportType, r), e.moduleReference = r, this.semicolon(), this.finishNode(e, "TSImportEqualsDeclaration");
	}
	...
	tsTryParseDeclare(e) {
		...
		return this.tsInAmbientContext(() => {
			switch (t) {
				...
				default: if (O(t)) return this.tsParseDeclaration(e, this.state.type, !0, null);
			}
		});
	}
	...
	tsParseDeclaration(e, t, n, r) {
		switch (t) {
			case 124:
				if (this.tsCheckLineTerminator(n) && (this.match(80) || O(this.state.type))) return this.tsParseAbstractDeclaration(e, r);
				break;
			case 127:
				if (this.tsCheckLineTerminator(n)) {
					if (this.match(134)) return this.tsParseAmbientExternalModuleDeclaration(e);
					if (O(this.state.type)) return e.kind = "module", this.tsParseModuleOrNamespaceDeclaration(e);
				}
				break;
			case 128:
				if (this.tsCheckLineTerminator(n) && O(this.state.type)) return e.kind = "namespace", this.tsParseModuleOrNamespaceDeclaration(e);
				break;
			case 130:
				if (this.tsCheckLineTerminator(n) && O(this.state.type)) return this.tsParseTypeAliasDeclaration(e);
				break;
		}
	}
	...
	tsParseTypeArguments() {
		let e = this.startNode();
		return e.params = this.tsInType(() => this.tsInTopLevelContext(() => (this.expect(47), this.tsParseDelimitedList("TypeParametersOrArguments", this.tsParseType.bind(this))))), e.params.length === 0 ? this.raise(H.EmptyTypeArguments, e) : !this.state.inType && this.curContext() === v.brace && this.reScan_lt_gt(), this.expect(48), this.finishNode(e, "TSTypeParameterInstantiation");
	}
	...
	parseBindingElement(e, t) {
		...
		!(e & 4) && (i || o || a) && this.raise(H.UnexpectedParameterModifier, n);
		let s = this.parseMaybeDefault();
		e & 2 && this.parseFunctionParamType(s);
		let c = this.parseMaybeDefault(s.loc.start, s);
		if (i || o || a) {
			let e = this.startNodeAt(n);
			return t.length && (e.decorators = t), i && (e.accessibility = i), o && (e.readonly = o), a && (e.override = a), c.type !== "Identifier" && c.type !== "AssignmentPattern" && this.raise(H.UnsupportedParameterPropertyKind, e), e.parameter = c, this.finishNode(e, "TSParameterProperty");
		}
	...
	parseFunctionBodyAndFinish(e, t, n = !1) {
		...
		return r && !this.match(5) && this.isLineTerminator() ? this.finishNode(e, r) : r === "TSDeclareFunction" && this.state.isAmbientContext && (this.raise(H.DeclareFunctionHasImplementation, e), e.declare) ? super.parseFunctionBodyAndFinish(e, r, n) : (this.tsDisallowOptionalPattern(e), super.parseFunctionBodyAndFinish(e, t, n));
	}
	...
	parseSubscript(e, t, n, r) {
		...
		if (this.match(47) || this.match(51)) {
			let a, o = this.tsTryParseAndCatch(() => {
				...
				if (s === 48 || s === 52 || s !== 10 && A(s) && !this.hasPrecedingLineBreak()) return;
				let c = this.startNodeAt(t);
				return c.expression = e, c.typeArguments = o, this.finishNode(c, "TSInstantiationExpression");
			});
			if (a && this.unexpected(a, 10), o) return o.type === "TSInstantiationExpression" && ((this.match(16) || this.match(18) && this.lookaheadCharCode() !== 40) && this.raise(H.InvalidPropertyAccessAfterInstantiationExpression, this.state.startLoc), !this.match(16) && !this.match(18) && (o.expression = super.stopParseSubscript(e, r))), o;
		}
		return super.parseSubscript(e, t, n, r);
	}
	parseNewCallee(e) {
	...
	parseExprOp(e, t, n) {
		let r;
		if (Pe(58) > n && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (r = this.isContextual(120)))) {
			let i = this.startNodeAt(t);
			return i.expression = e, i.typeAnnotation = this.tsInType(() => (this.next(), this.match(75) ? (r && this.raise(g.UnexpectedKeyword, this.state.startLoc, { keyword: "const" }), this.tsParseTypeReference()) : this.tsParseType())), this.finishNode(i, r ? "TSSatisfiesExpression" : "TSAsExpression"), this.reScan_lt_gt(), this.parseExprOp(i, t, n);
		}
	...
	parseImport(e) {
		...
		let t;
		if (O(this.state.type) && this.lookaheadCharCode() === 61) return e.importKind = "value", this.tsParseImportEqualsDeclaration(e);
		if (this.isContextual(130)) {
		...
		return t.importKind === "type" && t.specifiers.length > 1 && t.specifiers[0].type === "ImportDefaultSpecifier" && this.raise(H.TypeImportCannotSpecifyDefaultAndNamed, t), t;
	}
	parseExport(e, t) {
		if (this.match(83)) {
			let t = this.startNode();
			this.next();
			let n = null;
			this.isContextual(130) && this.isPotentialImportPhase(!1) ? n = this.parseMaybeImportPhase(t, !1) : t.importKind = "value";
			let r = this.tsParseImportEqualsDeclaration(t, n, !0);
	...
	parseVarStatement(e, t, n = !1) {
		...
		for (let { id: e, init: n } of i.declarations) n && (t === "var" || t === "let" || e.typeAnnotation ? this.raise(H.InitializerNotAllowedInAmbientContext, n) : pn(n, this.hasPlugin("estree")) || this.raise(H.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, n));
		return i;
	}
		...
		if (!this.state.containsEsc) switch (this.state.type) {
			...
			case 125:
				if (this.nextTokenIsIdentifierAndNotTSRelationalOperatorOnSameLine()) {
					...
					this.next();
					let r = e === 125 ? this.tsTryParseDeclare(n) : this.tsParseAbstractDeclaration(n, t);
					return r ? (e === 125 && (r.declare = !0), r) : (n.expression = this.createIdentifier(this.startNodeAt(n.loc.start), e === 125 ? "declare" : "abstract"), this.semicolon(!1), this.finishNode(n, "ExpressionStatement"));
				}
				break;
	...
	parseExportDeclaration(e) {
		...
		if (n && (this.isContextual(125) || !this.shouldParseExportDeclaration())) throw this.raise(H.ExpectedAmbientAfterExportDeclare, this.state.startLoc);
		let r = O(this.state.type) && this.tsTryParseExportDeclaration() || super.parseExportDeclaration(e);
	...
	parseMaybeAssign(e, t) {
		...
		if (!r?.error && !this.match(47)) return super.parseMaybeAssign(e, t);
		...
		let a, o = this.tryParse((n) => {
			...
			if ((r.type !== "ArrowFunctionExpression" || r.extra?.parenthesized) && n(), a?.params.length !== 0 && this.resetStartLocationFromNode(r, a), r.typeParameters = a, this.hasPlugin("jsx") && r.typeParameters.params.length === 1 && !r.typeParameters.extra?.trailingComma) {
				...
				e.constraint || this.raise(H.SingleTypeParameterWithoutTrailingComma, s(e.loc.end, 1), { typeParameterName: e.name.name });
			}
			return r;
		}, n);
		if (!o.error && !o.aborted) return a && this.reportReservedArrowTypeParam(a), o.node;
		if (!r && (on(!this.hasPlugin("jsx")), i = this.tryParse(() => super.parseMaybeAssign(e, t), n), !i.error)) return i.node;
		if (r?.node) return this.state = r.failState, r.node;
	...
	tsParseAbstractDeclaration(e, t) {
		...
		if (this.isContextual(129)) return this.hasFollowingLineBreak() ? null : (e.abstract = !0, this.raise(H.NonClassMethodPropertyHasAbstractModifier, e), this.tsParseInterfaceDeclaration(e));
	...
	parseTypeOnlyImportExportSpecifier(e, t, n) {
		...
		if (this.isContextual(93)) {
			...
			if (this.isContextual(93)) {
				...
				k(this.state.type) ? (s = !0, a = e, o = t ? this.parseIdentifier() : this.parseModuleExportName(), c = !1) : (o = n, c = !1);
			} else k(this.state.type) ? (c = !1, o = t ? this.parseIdentifier() : this.parseModuleExportName()) : (s = !0, a = e);
		} else k(this.state.type) && (s = !0, t ? (a = this.parseIdentifier(!0), this.isContextual(93) || this.checkReservedWord(a.name, a.loc.start, !0, !0)) : a = this.parseModuleExportName());
	...
	nextTokenIsIdentifierOrStringLiteralOnSameLine() {
		let e = this.nextTokenInLineStart(), t = this.codePointAtPos(e);
		return this.chStartsBindingIdentifier(t, e) || t === 34 || t === 39;
	}
};
function fn(e) {
...
var _n = h`placeholders`({
	...
	parseClass(e, t, n) {
		...
		if (a) if (this.match(81) || this.match(133) || this.match(5)) e.id = a;
			...
			throw this.raise(_n.ClassNameIsRequired, this.state.startLoc);
		}
	...
	parseV8Intrinsic() {
		if (this.match(54)) {
			...
			if (this.next(), O(this.state.type)) {
...
function Sn(e) {
	...
	if (e.has("importAssertions")) throw Error("`importAssertions` has been removed in Babel 8, please use import attributes instead. To use the non-standard `assert` syntax you can enable the `deprecatedImportAssert` parser plugin.");
	if (!e.has("deprecatedImportAssert") && e.has("importAttributes") && e.get("importAttributes").deprecatedAssertSyntax) throw Error("The 'importAttributes' plugin has been removed in Babel 8. If you need to enable support for the deprecated `assert` syntax, you can enable the `deprecatedImportAssert` parser plugin.");
	if (e.has("recordAndTuple")) throw Error("The 'recordAndTuple' plugin has been removed in Babel 8. Please remove it from your configuration.");
...
var Cn = {
	...
	checkProto(e, t, n, r) {
		...
		let i = e.key;
		return (i.type === "Identifier" ? i.name : i.value) === "__proto__" ? t ? (this.raise(g.RecordNoProto, i), !0) : (n && (r ? r.doubleProtoLoc === null && (r.doubleProtoLoc = i.loc.start) : this.raise(g.DuplicateProto, i)), !0) : n;
	}
	shouldExitDescending(e, t) {
		return e.type === "ArrowFunctionExpression" && this.offsetToSourcePos(e.start) === t;
	}
	getExpression() {
		if (this.enterInitialScopes(), this.nextToken(), this.match(140)) throw this.raise(g.ParseExpressionEmptyInput, this.state.startLoc);
		let e = this.parseExpression();
		if (!this.match(140)) throw this.raise(g.ParseExpressionExpectsEOF, this.state.startLoc, { unexpected: this.input.codePointAt(this.state.start) });
	...
	parseMaybeAssign(e, t) {
		...
		(a === 10 || O(a)) && (this.state.potentialArrowAt = this.state.start);
		let o = this.parseMaybeConditional(e);
		if (t && (o = t.call(this, o, n)), Te(this.state.type)) {
		...
		if (r) {
			let { type: e } = this.state;
			if ((this.hasPlugin("v8intrinsic") ? A(e) : A(e) && !this.match(54)) && !this.isAmbiguousPrefixOrIdentifier()) return this.raiseOverwrite(g.YieldNotInGeneratorFunction, n), this.parseYield(n);
		}
		return o;
	}
	...
	parseExprOp(e, t, n) {
		if (this.isPrivateName(e)) {
			...
			(n >= Pe(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(g.PrivateInExpectedIn, e, { identifierName: t }), this.classScope.usePrivateName(t, e.loc.start);
		}
		let r = this.state.type;
		if (ke(r) && (this.prodParam.hasIn || !this.match(58))) {
			let i = Pe(r);
			if (i > n) {
				if (r === 39) {
				...
				s && (i = Pe(42)), this.next(), a.right = this.parseExprOpRightExpr(r, i);
				let c = this.finishNode(a, o || s ? "LogicalExpression" : "BinaryExpression"), l = this.state.type;
				if (s && (l === 41 || l === 42) || o && l === 40) throw this.raise(g.MixingCoalesceWithLogical, this.state.startLoc);
	...
	parseHackPipeBody() {
		...
		return ee.has(t.type) && !t.extra?.parenthesized && this.raise(g.PipeUnparenthesizedBody, e, { type: t.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(g.PipeTopicUnused, e), t;
	}
	...
	parseMaybeUnary(e, t) {
		...
		if (r) {
			let { type: e } = this.state;
			if ((this.hasPlugin("v8intrinsic") ? A(e) : A(e) && !this.match(54)) && !this.isAmbiguousPrefixOrIdentifier()) return this.raiseOverwrite(g.AwaitNotInAsyncContext, n), this.parseAwait(n);
		}
		return o;
	}
	parseUpdate(e, t, n) {
	...
	parseCoverCallAndAsyncArrowHead(e, t, n, r) {
		...
		s && (this.expressionScope.enter(Jt()), a = new Zt()), c && (o.optional = r), r ? o.arguments = this.parseCallExpressionArguments() : o.arguments = this.parseCallExpressionArguments(e.type !== "Super", o, a);
	...
	parseCallExpressionArguments(e, t, n) {
		...
		for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(11);) {
			...
			r.push(this.parseExprListItem(11, !1, n, e));
		}
	...
	parseAsyncArrowFromCallExpression(e, t) {
		return this.resetPreviousNodeTrailingComments(t), this.expect(19), this.parseArrowExpression(e, t.arguments, !0, t.extra?.trailingCommaLoc), t.innerComments && z(e, t.innerComments), t.callee.trailingComments && z(e, t.callee.trailingComments), e;
	}
	parseNoCallExpr() {
		let e = this.state.startLoc;
	...
	parseExprAtom(e) {
		...
		switch (r) {
			...
			case 83: return t = this.startNode(), this.next(), this.match(16) ? this.parseImportMetaPropertyOrPhaseCall(t) : this.match(10) ? this.optionFlags & 512 ? this.parseImportCall(t) : this.finishNode(t, "Import") : (this.raise(g.UnsupportedImport, this.state.lastTokStartLoc), this.finishNode(t, "Import"));
			...
			case 0: return this.parseArrayLike(3, !1, e);
			...
			case 139: return this.raise(g.PrivateInExpectedIn, this.state.startLoc, { identifierName: this.state.value }), this.parsePrivateName();
			...
			default: if (O(r)) {
				...
				if (!t && n.name === "async" && !this.canInsertSemicolon()) {
					...
					if (O(e)) return this.lookaheadCharCode() === 61 ? this.parseAsyncArrowUnaryFunction(this.startNodeAtNode(n)) : n;
	...
	parseTopicReferenceThenEqualsSign(e, t) {
		...
		if (n) return this.state.type = e, this.state.value = t, this.state.pos--, this.state.end--, this.state.endLoc = s(this.state.endLoc, -1), this.parseTopicReference(n);
		throw this.unexpected();
	}
	...
	finishTopicReference(e, t, n, r) {
		...
		throw this.raise(g.PipeTopicUnconfiguredToken, t, { token: j(r) });
	}
	testTopicReferenceConfiguration(e, t, n) {
		switch (e) {
			case "hack": return this.hasPlugin(["pipelineOperator", { topicToken: j(n) }]);
	...
	parseSuper() {
		let e = this.startNode();
		return this.next(), this.match(10) && !this.scope.allowDirectSuper ? this.raise(g.SuperNotAllowed, e) : this.scope.allowSuper || this.raise(g.UnexpectedSuper, e), !this.match(10) && !this.match(0) && !this.match(16) && this.raise(g.UnsupportedSuper, e), this.finishNode(e, "Super");
	}
	parsePrivateName() {
		let e = this.startNode(), t = this.startNodeAt(s(this.state.startLoc, 1)), n = this.state.value;
	...
	parseImportMetaPropertyOrPhaseCall(e) {
		if (this.next(), this.isContextual(105) || this.isContextual(97)) {
			...
			return this.isContextual(101) && (this.inModule || this.raise(g.ImportMetaOutsideModule, t), this.sawUnambiguousESM = !0), this.parseMetaProperty(e, t, "meta");
		}
	}
	...
	parseParenAndDistinguishExpression(e) {
		...
		for (; !this.match(11);) {
			...
			} else o.push(this.parseMaybeAssignAllowInOrVoidPattern(11, s, this.parseParenItem));
		}
	...
	parseNewCallee(e) {
		...
		e.callee = n, t && (n.type === "Import" || n.type === "ImportExpression") && this.raise(g.ImportCallNotNewExpression, n);
	}
	parseTemplateElement(e) {
		let { start: t, startLoc: n, end: r, value: i } = this.state, a = t + 1, o = this.startNodeAt(s(n, 1));
		i === null && (e || this.raise(g.InvalidEscapeSequenceTemplate, s(this.state.firstInvalidTemplateEscapePos, 1)));
		...
		return this.resetEndLocation(d, s(this.state.lastTokEndLoc, l)), d;
	}
	parseTemplate(e) {
	...
	parseObjectLike(e, t, n, r) {
		...
		for (s.properties = [], this.next(); !this.match(e);) {
			...
			let i;
			t ? i = this.parseBindingProperty() : (i = this.parsePropertyDefinition(r), a = this.checkProto(i, n, a, r)), n && !this.isObjectProperty(i) && i.type !== "SpreadElement" && this.raise(g.InvalidRecordProperty, i), s.properties.push(i);
		}
	...
	parsePropertyDefinition(e) {
		...
		if (this.parsePropertyName(n, e), !o && !s && this.maybeAsyncOrAccessorProp(n)) {
			...
			t === "async" && !this.hasPrecedingLineBreak() && (r = !0, this.resetPreviousNodeTrailingComments(e), o = this.eat(55), this.parsePropertyName(n)), (t === "get" || t === "set") && (i = !0, this.resetPreviousNodeTrailingComments(e), n.kind = t, this.match(55) && (o = !0, this.raise(g.AccessorIsGenerator, this.state.curPosition(), { kind: t }), this.next()), this.parsePropertyName(n));
		}
	...
	parseObjectProperty(e, t, n, r) {
		if (e.shorthand = !1, this.eat(14)) return e.value = n ? this.parseMaybeDefault(this.state.startLoc) : this.parseMaybeAssignAllowInOrVoidPattern(8, r), this.finishObjectProperty(e);
	...
	parsePropertyName(e, t) {
		if (this.eat(0)) e.computed = !0, e.key = this.parseMaybeAssignAllowIn(), this.expect(3);
			...
			if (k(n)) i = this.parseIdentifier(!0);
			else switch (n) {
				case 135:
	...
	parseMethod(e, t, n, r, i, a, o = !1) {
		this.initFunction(e, n), e.generator = t, this.scope.enter(530 | (o ? 576 : 0) | (i ? 32 : 0)), this.prodParam.enter(Ct(n, e.generator)), this.parseFunctionParams(e, r);
	...
	parseArrayLike(e, t, n) {
		...
		this.state.inFSharpPipelineDirectBody = !1;
		let i = this.startNode();
		return this.next(), i.elements = this.parseExprList(e, !t, n, i), this.state.inFSharpPipelineDirectBody = r, this.finishNode(i, t ? "TupleExpression" : "ArrayExpression");
	}
	...
	parseFunctionBody(e, t, n = !1) {
		...
		if (this.expressionScope.enter(Yt()), r) e.body = this.parseMaybeAssign(), this.checkParams(e, !1, t, !1);
		else {
			...
			this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | 4), e.body = this.parseBlock(!0, !1, (i) => {
				...
				i && a && this.raise(g.IllegalLanguageModeDirective, (e.kind === "method" || e.kind === "constructor") && e.key ? e.key.loc.end : e);
	...
	parseExprListItem(e, t, n, r) {
		let i;
		if (this.match(12)) t || this.raise(g.UnexpectedToken, this.state.curPosition(), { unexpected: "," }), i = null;
	...
	parseIdentifierName(e) {
		...
		k(r) ? t = this.state.value : this.unexpected();
		let i = Se(r);
	...
	checkReservedWord(e, t, n, r) {
		if (!(e.length > 10 || !nt(e))) {
			...
			if ((this.state.strict ? r ? Qe : Xe : Ye)(e, this.inModule)) {
	...
	parseAwait(e) {
		let t = this.startNodeAt(e);
		return this.expressionScope.recordParameterInitializerError(g.AwaitExpressionFormalParameter, t), this.eat(55) && this.raise(g.ObsoleteAwaitStar, t), !this.scope.inFunction && !(this.optionFlags & 1) && (this.isAmbiguousPrefixOrIdentifier() ? this.ambiguousScriptDifferentAst = !0 : this.sawUnambiguousESM = !0), this.state.soloAwait || (t.argument = this.parseMaybeUnary(null, !0)), this.finishNode(t, "AwaitExpression");
	}
	isAmbiguousPrefixOrIdentifier() {
		if (this.hasPrecedingLineBreak()) return !0;
		let { type: e } = this.state;
		return e === 53 || e === 10 || e === 0 || Ie(e) || e === 102 && !this.state.containsEsc || e === 138 || e === 56 || this.hasPlugin("v8intrinsic") && e === 54;
	}
	parseYield(e) {
		let t = this.startNodeAt(e);
		this.expressionScope.recordParameterInitializerError(g.YieldInParameter, t);
		let n = !1, r = null;
	...
	checkPipelineAtInfixOperator(e, t) {
		this.hasPlugin(["pipelineOperator", { proposal: "smart" }]) && e.type === "SequenceExpression" && this.raise(g.PipelineHeadSequenceExpression, t);
	}
	...
	parseMaybeAssignAllowInOrVoidPattern(e, t, n) {
		if (t != null && this.match(88)) {
			let n = this.lookaheadCharCode();
			if (n === 44 || n === (e === 3 ? 93 : e === 8 ? 125 : 41) || n === 61) return this.parseMaybeDefault(this.state.startLoc, this.parseVoidPattern(t));
		}
		return this.parseMaybeAssignAllowIn(t, n);
	}
	parsePropertyNamePrefixOperator(e) {}
}, En = { kind: 1 }, Dn = { kind: 2 }, On = /[\uD800-\uDFFF]/u, kn = /in(?:stanceof)?/y;
function An(e, t, n) {
	for (let t = 0; t < e.length; t++) {
		let n = e[t], { type: r } = n;
...
var jn = class extends Tn {
	parseTopLevel(e, t) {
		return e.program = this.parseProgram(t, 140, this.options.sourceType === "module" ? "module" : "script"), e.comments = this.comments, this.optionFlags & 256 && (e.tokens = An(this.tokens, this.input, this.startIndex)), this.finishNode(e, "File");
	}
	parseProgram(e, t, n) {
		...
		let r;
		return r = t === 140 ? this.finishNode(e, "Program") : this.finishNodeAt(e, "Program", s(this.state.startLoc, -1)), r;
	}
	stmtToDirective(e) {
	...
	chStartsBindingIdentifier(e, t) {
		if (M(e)) {
			if (kn.lastIndex = t, kn.test(this.input)) {
				let e = this.codePointAtPos(kn.lastIndex);
				if (!N(e) && e !== 92) return !1;
			}
			return !0;
		} else return e === 92;
	...
	parseStatementContent(e, t) {
		...
		switch (n) {
			...
			case 75: i || this.raise(g.UnexpectedLexicalDeclaration, this.state.startLoc);
			case 74: {
				let e = this.state.value;
		...
		return O(n) && c.type === "Identifier" && this.eat(14) ? this.parseLabeledStatement(r, s, c, e) : this.parseExpressionStatement(r, c, t);
	}
	assertModuleNodeAllowed(e) {
	...
	maybeTakeDecorators(e, t, n) {
		return e && (t.decorators?.length ? (typeof this.getPluginOption("decorators", "decoratorsBeforeExport") != "boolean" && this.raise(g.DecoratorsBeforeAfterExport, t.decorators[0]), t.decorators.unshift(...e)) : t.decorators = e, this.resetStartLocationFromNode(t, e[0]), n && this.resetStartLocationFromNode(n, t)), t;
	}
	canHaveLeadingDecorator() {
	...
	parseDecorator() {
		...
		if (this.next(), this.hasPlugin("decorators")) {
			...
			if (this.match(10)) {
				...
				e.expression = this.parseMaybeDecoratorArguments(n, t), this.getPluginOption("decorators", "allowCallParenthesized") === !1 && e.expression !== n && this.raise(g.DecoratorArgumentsOutsideParentheses, r);
			} else {
	...
	parseDoWhileStatement(e) {
		return this.next(), this.state.labels.push(En), e.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement()), this.state.labels.pop(), this.expect(92), e.test = this.parseHeaderExpression(), this.eat(13), this.finishNode(e, "DoWhileStatement");
	}
	parseForStatement(e) {
		this.next(), this.state.labels.push(En);
		let t = null;
		...
		let n = this.isContextual(100);
		{
			...
			if (this.match(74) || this.match(75) || a) {
				...
				return s && i && this.raise(g.ForInUsing, o), (s || this.isContextual(102)) && o.declarations.length === 1 ? this.parseForIn(e, o, t) : (t !== null && this.unexpected(t), this.parseFor(e, o));
			}
		}
		let r = this.isContextual(95), i = new Zt(), a = this.parseExpression(!0, i), o = this.isContextual(102);
		if (o && (n && this.raise(g.ForOfLet, a), t === null && r && a.type === "Identifier" && this.raise(g.ForOfAsync, a)), o || this.match(58)) {
	...
	parseSwitchStatement(e) {
		...
		let t = e.cases = [];
		this.expect(5), this.state.labels.push(Dn), this.scope.enter(256);
		let n;
		for (let e; !this.match(8);) if (this.match(61) || this.match(65)) {
			let r = this.match(61);
			n && this.finishNode(n, "SwitchCase"), t.push(n = this.startNode()), n.consequent = [], this.next(), r ? n.test = this.parseExpression() : (e && this.raise(g.MultipleDefaultsInSwitch, this.state.lastTokStartLoc), e = !0, n.test = null), this.expect(14);
	...
	parseWhileStatement(e) {
		return this.next(), e.test = this.parseHeaderExpression(), this.state.labels.push(En), e.body = this.withSmartMixTopicForbiddingContext(() => this.parseStatement()), this.state.labels.pop(), this.finishNode(e, "WhileStatement");
	}
	...
	parseVar(e, t, n, r = !1) {
		...
		for (e.kind = n;;) {
			let e = this.startNode();
			if (this.parseVarId(e, n), e.init = this.eat(29) ? t ? this.parseMaybeAssignDisallowIn() : this.parseMaybeAssignAllowIn() : null, e.init === null && !r && (e.id.type !== "Identifier" && !(t && (this.match(58) || this.isContextual(102))) ? this.raise(g.DeclarationMissingInitializer, this.state.lastTokEndLoc, { kind: "destructuring" }) : (n === "const" || n === "using" || n === "await using") && !(this.match(58) || this.isContextual(102)) && this.raise(g.DeclarationMissingInitializer, this.state.lastTokEndLoc, { kind: n })), i.push(this.finishNode(e, "VariableDeclarator")), !this.eat(12)) break;
		}
		return e;
	}
	parseVarId(e, t) {
		let n = this.parseBindingAtom();
		t === "using" || t === "await using" ? (n.type === "ArrayPattern" || n.type === "ObjectPattern") && this.raise(g.UsingDeclarationHasBindingPattern, n.loc.start) : n.type === "VoidPattern" && this.raise(g.UnexpectedVoidPattern, n.loc.start), this.checkLVal(n, { type: "VariableDeclarator" }, t === "var" ? 5 : 8201), e.id = n;
	}
	...
	parseFunction(e, t = 0) {
		...
		this.initFunction(e, a), this.match(55) && (n && this.raise(g.GeneratorInSingleStatementContext, this.state.startLoc), this.next(), e.generator = !0), r && (e.id = this.parseFunctionId(i));
		let o = this.state.maybeInArrowParameters;
		return this.state.maybeInArrowParameters = !1, this.scope.enter(514), this.prodParam.enter(Ct(a, e.generator)), r || (e.id = this.parseFunctionId()), this.parseFunctionParams(e, !1), this.withSmartMixTopicForbiddingContext(() => {
	...
	parseFunctionId(e) {
		return e || O(this.state.type) ? this.parseIdentifier() : null;
	}
	parseFunctionParams(e, t) {
		this.expect(10), this.expressionScope.enter(Kt()), e.params = this.parseBindingList(11, 41, 2 | (t ? 4 : 0)), this.expressionScope.exit();
	}
	registerFunctionStatementId(e) {
	...
	parseClassBody(e, t) {
		...
		if (i.body = [], this.expect(5), this.withSmartMixTopicForbiddingContext(() => {
			for (; !this.match(8);) {
				...
				let e = this.startNode();
				r.length && (e.decorators = r, this.resetStartLocationFromNode(e, r[0]), r = []), this.parseClassMember(i, e, n), e.kind === "constructor" && e.decorators && e.decorators.length > 0 && this.raise(g.DecoratorConstructor, e);
			}
		}), this.state.strict = t, this.next(), r.length) throw this.raise(g.TrailingDecorator, this.state.startLoc);
	...
	parseClassMemberWithIsStatic(e, t, n, r) {
		...
		let d = !this.state.containsEsc && O(this.state.type), f = this.parseClassElementName(t), p = d ? f.name : null, m = this.isPrivateName(f), ee = this.state.startLoc;
		if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
			...
			r && (i.kind = "constructor", n.hadConstructor && !this.hasPlugin("typescript") && this.raise(g.DuplicateConstructor, f), r && this.hasPlugin("typescript") && t.override && this.raise(g.OverrideOnConstructor, f), n.hadConstructor = !0, o = n.hadSuperClass), this.pushClassMethod(e, i, !1, !1, r, o);
	...
	parseClassElementName(e) {
		...
		if ((t === 132 || t === 134) && e.static && n === "prototype" && this.raise(g.StaticPrototype, this.state.startLoc), t === 139) {
	...
	parseClassStaticBlock(e, t) {
		...
		let r = t.body = [];
		this.parseBlockOrModuleBlockBody(r, void 0, !1, 8), this.prodParam.exit(), this.scope.exit(), this.state.labels = n, e.body.push(this.finishNode(t, "StaticBlock")), t.decorators?.length && this.raise(g.DecoratorStaticBlock, t);
	}
	...
	parseInitializer(e) {
		this.scope.enter(592), this.expressionScope.enter(Yt()), this.prodParam.enter(0), e.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
	}
	parseClassId(e, t, n, r = 8331) {
		if (O(this.state.type)) e.id = this.parseIdentifier(), t && this.declareNameFromIdentifier(e.id, r);
	...
	parseExportDefaultExpression() {
		...
		if (this.match(26)) return this.hasPlugin("decorators") && this.getPluginOption("decorators", "decoratorsBeforeExport") === !0 && this.raise(g.DecoratorBeforeExport, this.state.startLoc), this.parseClass(this.maybeTakeDecorators(this.parseDecorators(!1), this.startNode()), !0, !0);
		if (this.match(75) || this.match(74) || this.isLet() || this.isUsing() || this.isAwaitUsing()) throw this.raise(g.UnsupportedDefaultExport, this.state.startLoc);
	...
	isExportDefaultSpecifier() {
		...
		if (this.input.charCodeAt(t) === 44 || O(this.state.type) && n) return !0;
		if (this.match(65) && n) {
	...
	shouldParseExportDeclaration() {
		let { type: e } = this.state;
		return e === 26 && (this.expectOnePlugin(["decorators", "decorators-legacy"]), this.hasPlugin("decorators")) ? (this.getPluginOption("decorators", "decoratorsBeforeExport") === !0 && this.raise(g.DecoratorBeforeExport, this.state.startLoc), !0) : this.isUsing() || this.isAwaitUsing() ? (this.raise(g.UsingDeclarationExport, this.state.startLoc), !0) : e === 74 || e === 75 || e === 68 || e === 80 || this.isLet() || this.isAsyncFunction();
	}
	checkExport(e, t, n, r) {
		if (t) {
			if (n) {
				...
				if (this.checkDuplicateExports(t, n), !r && t.local) {
					let { local: e } = t;
					e.type === "Identifier" ? (this.checkReservedWord(e.name, e.loc.start, !0, !1), this.scope.checkLocalExport(e)) : this.raise(g.ExportBindingIsString, t, {
						localName: e.value,
						exportName: n
					});
				}
	...
	parseExportSpecifier(e, t, n, r) {
		return this.eatContextual(93) ? e.exported = this.parseModuleExportName() : t ? e.exported = this.cloneStringLiteral(e.local) : e.exported ||= this.cloneIdentifier(e.local), this.finishNode(e, "ExportSpecifier");
	}
	parseModuleExportName() {
		if (this.match(134)) {
			let e = this.parseStringLiteral(this.state.value), t = On.exec(e.value);
	...
	checkImportReflection(e) {
		...
		e.phase === "source" ? n !== "ImportDefaultSpecifier" && this.raise(g.SourcePhaseImportRequiresDefault, t[0].loc.start) : e.phase === "defer" ? n !== "ImportNamespaceSpecifier" && this.raise(g.DeferImportRequiresNamespace, t[0].loc.start) : e.module && (n !== "ImportDefaultSpecifier" && this.raise(g.ImportReflectionNotBinding, t[0].loc.start), e.assertions?.length > 0 && this.raise(g.ImportReflectionHasAssertion, t[0].loc.start));
	}
	checkJSONModuleImport(e) {
		if (this.isJSONModuleImport(e) && e.type !== "ExportAllDeclaration") {
			...
			if (t != null) {
				...
				e !== void 0 && this.raise(g.ImportJSONBindingNotDefault, e.loc.start);
			}
		}
	}
	isPotentialImportPhase(e) {
		return e ? !1 : this.isContextual(105) || this.isContextual(97);
	}
	applyImportPhase(e, t, n, r) {
		t || (this.hasPlugin("importReflection") && (e.module = !1), n === "source" ? (this.expectPlugin("sourcePhaseImports", r), e.phase = "source") : n === "defer" ? (this.expectPlugin("deferredImportEvaluation", r), e.phase = "defer") : this.hasPlugin("sourcePhaseImports") && (e.phase = null));
	}
	parseMaybeImportPhase(e, t) {
		...
		return (k(i) ? i !== 98 || this.lookaheadCharCode() === 102 : i !== 12) ? (this.applyImportPhase(e, t, r, n.loc.start), null) : (this.applyImportPhase(e, t, null), this.createIdentifier(n, r));
	}
	isPrecedingIdImportPhase(e) {
		let { type: t } = this.state;
		return O(t) ? t !== 98 || this.lookaheadCharCode() === 102 : t !== 12;
	}
	parseImport(e) {
	...
	parseImportSourceAndAttributes(e) {
		return e.specifiers ??= [], e.source = this.parseImportSource(), this.maybeParseImportAttributes(e), this.checkImportReflection(e), this.checkJSONModuleImport(e), this.semicolon(), this.sawUnambiguousESM = !0, this.finishNode(e, "ImportDeclaration");
	}
	parseImportSource() {
	...
	parseImportAttributes() {
		...
		do {
			...
			if (t.has(r) && this.raise(g.ModuleAttributesWithDuplicateKeys, this.state.startLoc, { key: r }), t.add(r), this.match(134) ? n.key = this.parseStringLiteral(r) : n.key = this.parseIdentifier(!0), this.expect(14), !this.match(134)) throw this.raise(g.ModuleAttributeInvalidValue, this.state.startLoc);
	...
	parseModuleAttributes() {
		...
		do {
			let n = this.startNode();
			if (n.key = this.parseIdentifier(!0), n.key.name !== "type" && this.raise(g.ModuleAttributeDifferentFromType, n.key), t.has(n.key.name) && this.raise(g.ModuleAttributesWithDuplicateKeys, n.key, { key: n.key.name }), t.add(n.key.name), this.expect(14), !this.match(134)) throw this.raise(g.ModuleAttributeInvalidValue, this.state.startLoc);
			n.value = this.parseStringLiteral(this.state.value), e.push(this.finishNode(n, "ImportAttribute"));
		} while (this.eat(12));
		return e;
	}
	maybeParseImportAttributes(e) {
		...
		} else this.isContextual(94) && !this.hasPrecedingLineBreak() ? (this.hasPlugin("deprecatedImportAssert") || this.raise(g.ImportAttributesUseAssert, this.state.startLoc), this.addExtra(e, "deprecatedAssertSyntax", !0), this.next(), t = this.parseImportAttributes()) : t = [];
		e.attributes = t;
	}
	maybeParseDefaultImportSpecifier(e, t) {
		...
		} else if (k(this.state.type)) return this.parseImportSpecifierLocal(e, this.startNode(), "ImportDefaultSpecifier"), !0;
		return !1;
	}
	...
	parseImportSpecifier(e, t, n, r, i) {
		if (this.eatContextual(93)) e.local = this.parseIdentifier();
			...
			this.checkReservedWord(n.name, e.loc.start, !0, !0), e.local ||= this.cloneIdentifier(n);
		}
...
var Gn = Wn;
function Kn(e, t) {
	return t === !1 ? !1 : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? Bn(e, t) : t;
}
var qn = Kn;
function Jn(e, t) {
	let n = null, r = t;
	for (; r !== n;) n = r, r = zn(e, r), r = Hn(e, r), r = qn(e, r), r = Gn(e, r);
	return r;
}
var Yn = Jn;
function Xn(e) {
...
var Qn = Zn, $n = (e, t) => (n, r, ...i) => n | 1 && r == null ? void 0 : (t.call(r) ?? r[e]).apply(r, i), er = Array.prototype.findLast ?? function(e) {
	for (let t = this.length - 1; t >= 0; t--) {
		let n = this[t];
		if (e(n, t, this)) return n;
	}
}, tr = $n("findLast", function() {
	if (Array.isArray(this)) return er;
});
function nr(e) {
	return this[e < 0 ? this.length + e : e];
}
var rr = $n("at", function() {
...
function lr(e) {
	return cr.has(e) || cr.set(e, or(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/u.test(e.value)), cr.get(e);
}
var ur = lr;
function dr(e) {
	if (!or(e)) return !1;
...
function pr(e) {
	return fr.has(e) || fr.set(e, dr(e)), fr.get(e);
}
var mr = pr;
function hr(e) {
	...
	for (let n = e.length - 1; n >= 0; n--) {
		let r = e[n];
		if (t && G(r) === W(t) && mr(r) && mr(t) && (e.splice(n + 1, 1), r.value += "*//*" + t.value, r.range = [W(r), G(t)]), !sr(r) && !or(r)) throw TypeError(`Unknown comment type: "${r.type}".`);
		t = r;
	}
}
var gr = hr;
...
var yr = 10;
for (let e = 0; e <= yr; e++) q();
function br(e) {
	return q(e);
}
function xr(e, t = "type") {
	br(e);
	function n(n) {
		let r = n[t], i = e[r];
...
var Sr = xr, J = [
	...
	AccessorProperty: J[0],
	AnyTypeAnnotation: J[1],
	ArgumentPlaceholder: J[1],
	...
	AsConstExpression: J[3],
	AsExpression: J[4],
	AssignmentExpression: J[5],
	AssignmentPattern: [
		"left",
		"right",
		"decorators",
	...
	AwaitExpression: J[6],
	BigIntLiteral: J[1],
	BigIntLiteralTypeAnnotation: J[1],
	BigIntTypeAnnotation: J[1],
	BinaryExpression: J[5],
	BindExpression: ["object", "callee"],
	BlockStatement: J[7],
	BooleanLiteral: J[1],
	BooleanLiteralTypeAnnotation: J[1],
	BooleanTypeAnnotation: J[1],
	BreakStatement: J[8],
	CallExpression: J[9],
	CatchClause: ["param", "body"],
	ChainExpression: J[3],
	ClassAccessorProperty: J[0],
	ClassBody: J[10],
	ClassDeclaration: J[11],
	ClassExpression: J[11],
	ClassImplements: J[12],
	ClassMethod: J[13],
	ClassPrivateMethod: J[13],
	ClassPrivateProperty: J[14],
	ClassProperty: J[14],
	...
	ComponentTypeParameter: J[15],
	ConditionalExpression: J[16],
	ConditionalTypeAnnotation: J[17],
	ContinueStatement: J[8],
	DebuggerStatement: J[1],
	DeclareClass: [
		"id",
		"typeParameters",
		"extends",
	...
	DeclaredPredicate: J[18],
	DeclareEnum: J[19],
	DeclareExportAllDeclaration: ["source", "attributes"],
	DeclareExportDeclaration: J[20],
	DeclareFunction: ["id", "predicate"],
	DeclareHook: J[21],
	DeclareInterface: J[22],
	DeclareModule: J[19],
	DeclareModuleExports: J[23],
	DeclareNamespace: J[19],
	DeclareOpaqueType: [
		"id",
		"typeParameters",
		"supertype",
	...
	DeclareTypeAlias: J[24],
	DeclareVariable: J[21],
	Decorator: J[3],
	Directive: J[18],
	DirectiveLiteral: J[1],
	DoExpression: J[10],
	DoWhileStatement: J[25],
	EmptyStatement: J[1],
	EmptyTypeAnnotation: J[1],
	EnumBigIntBody: J[26],
	EnumBigIntMember: J[27],
	EnumBooleanBody: J[26],
	EnumBooleanMember: J[27],
	EnumDeclaration: J[19],
	EnumDefaultedMember: J[21],
	EnumNumberBody: J[26],
	EnumNumberMember: J[27],
	EnumStringBody: J[26],
	EnumStringMember: J[27],
	EnumSymbolBody: J[26],
	ExistsTypeAnnotation: J[1],
	ExperimentalRestProperty: J[6],
	ExperimentalSpreadProperty: J[6],
	...
	ExportDefaultSpecifier: J[28],
	ExportNamedDeclaration: J[20],
	ExportNamespaceSpecifier: J[28],
	ExportSpecifier: ["local", "exported"],
	ExpressionStatement: J[3],
	File: ["program"],
	ForInStatement: J[29],
	ForOfStatement: J[29],
	ForStatement: [
	...
	FunctionDeclaration: J[30],
	FunctionExpression: J[30],
	...
	FunctionTypeParam: J[15],
	GenericTypeAnnotation: J[12],
	HookDeclaration: J[31],
	HookTypeAnnotation: [
		"params",
		"returnType",
		"rest",
	...
	IfStatement: J[16],
	ImportAttribute: J[32],
	ImportDeclaration: [
		"specifiers",
		"source",
		"attributes"
	],
	ImportDefaultSpecifier: J[33],
	ImportExpression: ["source", "options"],
	ImportNamespaceSpecifier: J[33],
	ImportSpecifier: ["imported", "local"],
	IndexedAccessType: J[34],
	InferredPredicate: J[1],
	InferTypeAnnotation: J[35],
	InterfaceDeclaration: J[22],
	InterfaceExtends: J[12],
	InterfaceTypeAnnotation: ["extends", "body"],
	InterpreterDirective: J[1],
	IntersectionTypeAnnotation: J[36],
	JsExpressionRoot: J[37],
	JsonRoot: J[37],
	JSXAttribute: ["name", "value"],
	JSXClosingElement: ["name"],
	JSXClosingFragment: J[1],
	JSXElement: [
		"openingElement",
		"children",
		"closingElement"
	],
	JSXEmptyExpression: J[1],
	JSXExpressionContainer: J[3],
	JSXFragment: [
		"openingFragment",
		"children",
		"closingFragment"
	...
	JSXOpeningFragment: J[1],
	JSXSpreadAttribute: J[6],
	JSXSpreadChild: J[3],
	JSXText: J[1],
	KeyofTypeAnnotation: J[6],
	LabeledStatement: ["label", "body"],
	Literal: J[1],
	LogicalExpression: J[5],
	MatchArrayPattern: ["elements", "rest"],
	MatchAsPattern: ["pattern", "target"],
	MatchBindingPattern: J[21],
	MatchExpression: J[39],
	MatchExpressionCase: J[40],
	MatchIdentifierPattern: J[21],
	MatchLiteralPattern: J[41],
	...
	MatchRestPattern: J[6],
	MatchStatement: J[39],
	MatchStatementCase: J[40],
	MatchUnaryPattern: J[6],
	MatchWildcardPattern: J[1],
	MemberExpression: J[38],
	MetaProperty: ["meta", "property"],
	MethodDefinition: J[42],
	MixedTypeAnnotation: J[1],
	ModuleExpression: J[10],
	NeverTypeAnnotation: J[1],
	NewExpression: J[9],
	NGChainedExpression: J[43],
	NGEmptyExpression: J[1],
	NGMicrosyntax: J[10],
	NGMicrosyntaxAs: ["key", "alias"],
	NGMicrosyntaxExpression: ["expression", "alias"],
	NGMicrosyntaxKey: J[1],
	NGMicrosyntaxKeyedExpression: ["key", "expression"],
	NGMicrosyntaxLet: J[32],
	NGPipeExpression: [
		"left",
		"right",
		"arguments"
	...
	NGRoot: J[37],
	NullableTypeAnnotation: J[23],
	NullLiteral: J[1],
	NullLiteralTypeAnnotation: J[1],
	NumberLiteralTypeAnnotation: J[1],
	NumberTypeAnnotation: J[1],
	NumericLiteral: J[1],
	...
	OptionalCallExpression: J[9],
	OptionalIndexedAccessType: J[34],
	OptionalMemberExpression: J[38],
	ParenthesizedExpression: J[3],
	PipelineBareFunction: ["callee"],
	PipelinePrimaryTopicReference: J[1],
	PipelineTopicExpression: J[3],
	Placeholder: J[1],
	PrivateIdentifier: J[1],
	PrivateName: J[21],
	Program: J[7],
	Property: J[32],
	PropertyDefinition: J[14],
	QualifiedTypeIdentifier: J[44],
	QualifiedTypeofIdentifier: J[44],
	RegExpLiteral: J[1],
	RestElement: [
		"argument",
		"typeAnnotation",
	...
	ReturnStatement: J[6],
	SatisfiesExpression: J[4],
	SequenceExpression: J[43],
	SpreadElement: J[6],
	StaticBlock: J[10],
	StringLiteral: J[1],
	StringLiteralTypeAnnotation: J[1],
	StringTypeAnnotation: J[1],
	Super: J[1],
	SwitchCase: ["test", "consequent"],
	SwitchStatement: ["discriminant", "cases"],
	SymbolTypeAnnotation: J[1],
	...
	TSAbstractAccessorProperty: J[45],
	TSAbstractKeyword: J[1],
	TSAbstractMethodDefinition: J[32],
	TSAbstractPropertyDefinition: J[45],
	TSAnyKeyword: J[1],
	TSArrayType: J[2],
	TSAsExpression: J[4],
	TSAsyncKeyword: J[1],
	TSBigIntKeyword: J[1],
	TSBooleanKeyword: J[1],
	TSCallSignatureDeclaration: J[46],
	TSClassImplements: J[47],
	TSConditionalType: J[17],
	TSConstructorType: J[46],
	TSConstructSignatureDeclaration: J[46],
	TSDeclareFunction: J[31],
	TSDeclareKeyword: J[1],
	TSDeclareMethod: [
		"decorators",
		"key",
		"typeParameters",
	...
	TSEnumBody: J[26],
	TSEnumDeclaration: J[19],
	TSEnumMember: ["id", "initializer"],
	TSExportAssignment: J[3],
	TSExportKeyword: J[1],
	TSExternalModuleReference: J[3],
	TSFunctionType: J[46],
	...
	TSIndexedAccessType: J[34],
	TSIndexSignature: ["parameters", "typeAnnotation"],
	TSInferType: J[35],
	TSInstantiationExpression: J[47],
	TSInterfaceBody: J[10],
	TSInterfaceDeclaration: J[22],
	TSInterfaceHeritage: J[47],
	TSIntersectionType: J[36],
	TSIntrinsicKeyword: J[1],
	TSJSDocAllType: J[1],
	TSJSDocNonNullableType: J[23],
	TSJSDocNullableType: J[23],
	TSJSDocUnknownType: J[1],
	TSLiteralType: J[41],
	TSMappedType: [
		"key",
		"constraint",
	...
	TSModuleBlock: J[10],
	TSModuleDeclaration: J[19],
	TSNamedTupleMember: ["label", "elementType"],
	TSNamespaceExportDeclaration: J[21],
	TSNeverKeyword: J[1],
	TSNonNullExpression: J[3],
	TSNullKeyword: J[1],
	TSNumberKeyword: J[1],
	TSObjectKeyword: J[1],
	TSOptionalType: J[23],
	TSParameterProperty: ["parameter", "decorators"],
	TSParenthesizedType: J[23],
	TSPrivateKeyword: J[1],
	TSPropertySignature: ["key", "typeAnnotation"],
	TSProtectedKeyword: J[1],
	TSPublicKeyword: J[1],
	TSQualifiedName: J[5],
	TSReadonlyKeyword: J[1],
	TSRestType: J[23],
	TSSatisfiesExpression: J[4],
	TSStaticKeyword: J[1],
	TSStringKeyword: J[1],
	TSSymbolKeyword: J[1],
	...
	TSTypeParameterDeclaration: J[48],
	TSTypeParameterInstantiation: J[48],
	TSTypePredicate: J[49],
	TSTypeQuery: ["exprName", "typeArguments"],
	TSTypeReference: ["typeName", "typeArguments"],
	TSUndefinedKeyword: J[1],
	TSUnionType: J[36],
	TSUnknownKeyword: J[1],
	TSVoidKeyword: J[1],
	...
	TypeParameterDeclaration: J[48],
	TypeParameterInstantiation: J[48],
	TypePredicate: J[49],
	UnaryExpression: J[6],
	UndefinedTypeAnnotation: J[1],
	UnionTypeAnnotation: J[36],
	UnknownTypeAnnotation: J[1],
	UpdateExpression: J[6],
	V8IntrinsicIdentifier: J[1],
	VariableDeclaration: ["declarations"],
	VariableDeclarator: J[27],
	Variance: J[1],
	VoidPattern: J[1],
	VoidTypeAnnotation: J[1],
	WhileStatement: J[25],
...
function wr(e, t) {
	if (!vr(e)) return e;
	if (Array.isArray(e)) {
		for (let n = 0; n < e.length; n++) e[n] = wr(e[n], t);
		return e;
	}
	if (t.onEnter) {
		let n = t.onEnter(e) ?? e;
		if (n !== e) return wr(n, t);
		e = n;
	}
	let n = Cr(e);
	for (let r = 0; r < n.length; r++) e[n[r]] = wr(e[n[r]], t);
...
function Er(e, t) {
	...
	return e = Tr(e, {
		onEnter(t) {
			switch (t.type) {
				case "ParenthesizedExpression": {
					let { expression: e } = t, n = W(t);
					if (e.type === "TypeCastExpression") return e.range = [n, G(t)], e;
					let o = !1;
					if (!a) {
						if (!s) {
							s = [];
							for (let e of i) ur(e) && s.push(G(e));
						}
						let e = tr(0, s, (e) => e <= n);
				...
				case "TemplateElement":
					(n === "flow" || n === "hermes" || n === "espree" || n === "typescript" || a) && (t.range = [W(t) + 1, G(t) - (t.tail ? 1 : 2)]);
					break;
				case "VariableDeclaration": {
					let e = rr(0, t.declarations, -1);
					e?.init && r[G(e)] !== ";" && (t.range = [W(t), G(e)]);
					break;
				}
...
var jr = Ar, Mr = "Unexpected parseExpression() input: ";
function Nr(e) {
	...
	let s = ` (${i}:${a})`;
	return t.endsWith(s) && (t = t.slice(0, -s.length)), t.startsWith(Mr) && (t = t.slice(Mr.length)), jr(t, {
		loc: { start: {
			line: i,
			column: a + 1
		} },
...
var Pr = Nr, Fr = String.prototype.replaceAll ?? function(e, t) {
	return e.global ? this.replace(e, t) : this.split(e).join(t);
}, Ir = $n("replaceAll", function() {
	if (typeof this == "string") return Fr;
}), Lr = /\*\/$/, Rr = /^\/\*\*?/, zr = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, Br = /(^|\s+)\/\/([^\n\r]*)/g, Vr = /^(\r?\n)+/, Hr = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, Ur = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, Wr = /(\r?\n|^) *\* ?/g, Gr = [];
function Kr(e) {
	let t = e.match(zr);
...
function qr(e) {
	e = Ir(0, e.replace(Rr, "").replace(Lr, ""), Wr, "$1");
	let t = "";
	for (; t !== e;) t = e, e = Ir(0, e, Hr, "\n$1 $2\n");
	e = e.replace(Vr, "").trimEnd();
	let n = Object.create(null), r = Ir(0, e, Ur, "").replace(Vr, "").trimEnd(), i;
	for (; i = Ur.exec(e);) {
		let e = Ir(0, i[2], Br, "");
...
var Jr = ["noformat", "noprettier"], Yr = ["format", "prettier"];
function Xr(e) {
	let t = Qn(e);
	t && (e = e.slice(t.length + 1));
	let { pragmas: n, comments: r } = qr(Kr(e));
	return {
		shebang: t,
		text: e,
		pragmas: n,
...
var Y = $r, ei = "module", ti = "commonjs";
function ni(e) {
	if (typeof e == "string") {
		if (e = e.toLowerCase(), /\.(?:mjs|mts)$/iu.test(e)) return ei;
		if (/\.(?:cjs|cts)$/iu.test(e)) return ti;
	}
}
function ri(e, t) {
	let { type: n = "JsExpressionRoot", rootMarker: r, text: i } = t, { tokens: a, comments: o } = e;
	return delete e.tokens, delete e.comments, {
		tokens: a,
		comments: o,
		type: n,
		node: e,
...
var ii = ri, X = (e) => Y(di(e)), ai = {
	...
	tokens: !1,
	ranges: !1
}, oi = "v8intrinsic", si = [["pipelineOperator", {
	proposal: "hack",
	topicToken: "%"
}], ["pipelineOperator", { proposal: "fsharp" }]], Z = (e, t = ai) => ({
	...t,
	plugins: [...t.plugins, ...e]
}), ci = /@(?:no)?flow\b/u;
function li(e, t) {
	...
	let r = Yn(e, 0);
	return r !== !1 && (e = e.slice(0, r)), ci.test(e);
}
function ui(e, t, n) {
	let r = e(t, n), i = r.errors.find((e) => !fi.has(e.reasonCode));
	if (i) throw i;
	return r;
}
function di({ isExpression: e = !1, optionsCombinations: t }) {
	return (n, r = {}) => {
		let { filepath: i } = r;
		if (typeof i != "string" && (i = void 0), (r.parser === "babel" || r.parser === "__babel_estree") && li(n, i)) return r.parser = "babel-flow", vi.parse(n, r);
		let a = t, o = r.__babelSourceType ?? ni(i);
		o && o !== ei && (a = a.map((e) => ({
			...e,
			sourceType: o,
			...o === ti ? {
		...
		let s = /%[A-Z]/u.test(n);
		n.includes("|>") ? a = (s ? [...si, oi] : si).flatMap((e) => a.map((t) => Z([e], t))) : s && (a = a.map((e) => Z([oi], e)));
		let c = e ? Pn : Nn, l;
		try {
			l = Xn(a.map((e) => () => ui(c, n, e)));
		} catch ({ errors: [e] }) {
			throw Pr(e);
		}
		return e && (l = ii(l, {
...
function wi(e) {
	let t = Nn(e, Ci), { program: n } = t;
	if (n.body.length === 0 && n.directives.length === 0 && !n.interpreter) return t;
}
function Ti(e, t = {}) {
	let { allowComments: n = !0, allowEmpty: r = !1 } = t, i;
	try {
		i = Pn(e, Ci);
	} catch (t) {
	...
	if (!n && Si(i.comments)) throw Q(i.comments[0], "Comment");
	return i = ii(i, {
		type: "JsonRoot",
		text: e
	}), i.node.type === "File" ? delete i.node : $(i.node), i;
}
function Q(e, t) {
	...
	return jr(`${t} is not allowed in JSON.`, { loc: {
		start: n,
		end: r
	} });
}
function $(e) {
	switch (e.type) {
		...
		case "Identifier":
			...
			return;
		case "TemplateLiteral":
			if (Si(e.expressions)) throw Q(e.expressions[0], "'TemplateLiteral' with expression");
...
var Ei = Y({
	...
	hasPragma: () => !0,
	hasIgnorePragma: () => !1
}), Di = Y((e) => Ti(e)), Oi = Y((e) => Ti(e, { allowEmpty: !0 })), ki = Y({
	parse: (e) => Ti(e, { allowComments: !1 }),
