...
<div
	{@attach ref}
	class={cn(
		'grid min-h-16 gap-2 rounded-none border-2 border-dashed px-3 py-3 transition-colors duration-150',
		isDropTarget.current
			? 'border-primary-300 bg-primary-950/40 ring-1 ring-primary-300/50'
			: chainDragging
				? 'border-rule bg-dark-900/60'
...
>
	{#if showEmptyDropHint}
		<div
			class={cn(
				'flex items-center justify-center gap-2 rounded-none border border-dashed px-3 py-4 text-sm font-medium transition-colors',
				isDropTarget.current
					? 'border-primary-300/80 bg-primary-950/50 text-primary-100'
					: 'border-rule text-dark-300'
			)}
		>
			<Icon
	...
	{#if showActiveDropHint}
		<div
			class="flex items-center justify-center gap-2 rounded-none border border-dashed border-primary-300/80 bg-primary-950/50 px-3 py-2 text-sm font-medium text-primary-100"
		>
