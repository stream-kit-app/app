...
Documentation for Stream Kit plugins and components.
...
| [WebSocket plugin](./plugins/websocket.md) | WebSocket connections, message triggers, and JSON field conditions |
