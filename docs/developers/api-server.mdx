...
The [Stream Deck](/docs/plugins/stream-deck) integration uses this API as its only transport:
...
- [Stream Deck](/docs/plugins/stream-deck) (Elgato hardware via this API)
