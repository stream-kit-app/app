...
Speak handlers finish only after their audio has finished playing. Use an [action queue](/docs/guide/action-queues) with **blocking** enabled when later actions must wait for that speech to end.
