...
| Page | Description |
| --- | --- |
| **Overview** | Stats, watch-time status, top users, tier distribution |
| **Tiers & Ranks** | Create tiers and rank milestones (global point thresholds) |
| **Leaderboard** | Search users, adjust points manually, and remove users from rankings |
...
Add the **Rankings** widget from the dashboard to see user count, total points, and the top five leaderboard at a glance.
