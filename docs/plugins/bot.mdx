---
title: Bot
description: Chat commands, timers, auto-moderation, custom roles, and built-in system commands for Twitch and YouTube.
---
...
Browse IDs: [Bot handlers](/docs/api/handlers/bot).
