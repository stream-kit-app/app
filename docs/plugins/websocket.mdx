...
Configure connections under **Plugins → WebSocket**. Each connection has a name, URL, and optional headers. Enable connections you want active; the plugin reconnects as needed.
