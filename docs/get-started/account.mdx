...
Active plans also unlock **cloud overlays**: publish a built overlay from the overlay configure page to get a public browser-source URL on the site (`/app/overlays/{id}/`). Live events still require the desktop app online. Authoring projects themselves also sync for Pro accounts (see multi-PC guide).
